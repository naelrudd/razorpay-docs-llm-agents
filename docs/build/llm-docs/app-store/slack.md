...
- If other [standard user roles](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#standard-user-roles) need to get notifications, they can be added to the Slack channel(s).
