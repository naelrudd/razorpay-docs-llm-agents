...
### Accept Payments
     ...
     Accept in-person payments at physical locations with [Razorpay POS](https://razorpay.com/docs/build/llm-docs/pos.md).
    ...
    #### Subscriptions
        ...
        Automate recurring billing with [Razorpay Subscriptions](https://razorpay.com/docs/build/llm-docs/payments/subscriptions.md).
...
- [Quickstart Guide](https://razorpay.com/docs/build/llm-docs/payments/quickstart.md)
