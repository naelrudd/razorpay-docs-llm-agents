...
Once you complete [Payroll account setup](https://razorpay.com/docs/build/llm-docs/payroll/quickstart.md), you can execute payroll for your organisation. Payroll automates transactions and manages payroll as per settings enabled. Use the following checklist to execute payroll without any misses.
...
- If you are tracking the loss of pay (LOP) days outside of Payroll or using the [Jibble integration](https://razorpay.com/docs/build/llm-docs/payroll/integrations/jibble.md), follow the given steps:  

    
        Know how to [sync loss of pay data from Jibble](https://razorpay.com/docs/build/llm-docs/payroll/integrations/jibble.md#verify-lop-in-payroll).
...
Check how you can modify other salary components as part of [Run Payroll](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md).
...
Finalise the payroll for the month. [Transfer the funds](https://razorpay.com/docs/build/llm-docs/payroll/payroll-payouts.md) required to process payroll and then **Request Execution** with ease. You **cannot** [make changes](https://razorpay.com/docs/build/llm-docs/payroll/exceptional-cases.md) to payroll after you have executed it. 
