...
1. Enter the employee's 12-digit PRAN in the text box. We pre-fill employee's PRAN if the employee provided their PRAN during [onboarding](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#set-up-profile).
1. Click **CONTINUE**. 
...
On Payroll, your eligible employees can choose their NPS contribution percentage. However, you must enable this setting separately. When disabled, we contribute the percentage reserved for NPS as specified in the [salary structure](https://razorpay.com/docs/build/llm-docs/payroll/salary.md#setup-salary-structure). 
...
- Ensure the declaration window is open during [onboarding](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#employee-onboarding) and [salary revision](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#revise-salary) process.
...
- [Employee NPS Declaration](https://razorpay.com/docs/build/llm-docs/payroll/employees/declarations/nps.md)
