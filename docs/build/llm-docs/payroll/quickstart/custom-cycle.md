...
You can use an attendance cycle to freeze the employees' attendance for that month and finalise the payroll before [execution](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#execute-payroll).
...
Know more about [payroll execution](https://razorpay.com/docs/build/llm-docs/payroll/execute-payroll.md). 
...
1. Select the **New cycle effective month** from the drop-down menu. You can only select an [unfinalised payroll month](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#execute-payroll) for the updated payroll and attendance cycle to take effect.
...
1. Toggle the setting against **Payroll Autopilot**. This means that the Payroll automatically makes payroll payouts on the **Payroll Date**. 
    When disabled, you must manually [request execution](https://razorpay.com/docs/build/llm-docs/payroll/execute-payroll.md).
...
- [About Account Setup](https://razorpay.com/docs/build/llm-docs/payroll/quickstart.md)
- [About Execute Payroll Checklist](https://razorpay.com/docs/build/llm-docs/payroll/execute-payroll.md)
