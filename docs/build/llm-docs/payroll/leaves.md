...
Know more about calculating [salary based on Loss of Pay](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#calculations). 

## Leave Encashment 

When an employee leaves your organisation, you can pay them for the leaves they have not availed from their balance. Know more about [Leave Encashment during exit](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#full-and-final-settlement).
