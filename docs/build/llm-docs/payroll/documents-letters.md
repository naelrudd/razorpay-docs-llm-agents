...
Only administrators and user roles who have been specifically granted this permission can upload common documents. Know more about [Payment Pages](https://razorpay.com/docs/build/llm-docs/payments/payment-pages.md) user permissions in Payroll.
...
- [Admin Role - HR Operations](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md)
