...
With Tax Deductions Setup on the Payroll Dashboard, you can set up:
   ...
   Setup verification settings for your organisation. Explore the [tax verification process](https://razorpay.com/docs/build/llm-docs/payroll/tax-verifications.md).
...
### Opt for Verification
         ...
         - **Let Organisation Verify** to carry out the [verification by yourself](https://razorpay.com/docs/build/llm-docs/payroll/tax-verifications.md).
...
Employees can declare their provisional investments and upload investment proofs via the [IT Declarations](https://razorpay.com/docs/build/llm-docs/payroll/employees/declarations.md) page. We communicate the window availability to your employees via email. 

### Related Information

- [About Statutory Compliance](https://razorpay.com/docs/build/llm-docs/payroll/statutory-compliance.md)
