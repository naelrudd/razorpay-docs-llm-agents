...
Watch the video on to how to [set up employee profile](https://razorpay.com/docs/build/llm-docs/payroll/video-tutorials.md#set-up-my-profile).
...
- [Employee Onboarding](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#onboarding)
