...
Watch the video on to how to [mark attendance](https://razorpay.com/docs/build/llm-docs/payroll/video-tutorials.md#mark-and-modify-attendance) and [apply for leaves](https://razorpay.com/docs/build/llm-docs/payroll/video-tutorials.md#apply-for-leaves).

**INFO**

**Handy Tips**

- If your organisation has integrated [Payroll with Slack](https://razorpay.com/docs/build/llm-docs/payroll/integrations/slack.md), you can update your leaves and attendance from within the Slack App. Refer to the [leave commands](https://razorpay.com/docs/build/llm-docs/payroll/integrations/slack.md#how-it-works).
...
- [Employee Dashboard](https://razorpay.com/docs/build/llm-docs/payroll/employees.md)
- [Slack Integration](https://razorpay.com/docs/build/llm-docs/payroll/integrations/slack.md)
