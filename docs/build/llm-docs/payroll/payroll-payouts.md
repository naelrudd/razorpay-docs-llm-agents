...
Explore the RazorpayX - Current Account [integration with Payroll](https://razorpay.com/docs/build/llm-docs/payroll/integrations/current-account.md) to simplify money transfer and fund management.
...
### Fund Transfer Best Practices
         ...
         - You are transferring funds from a **whitelisted account**. 
            ...
            [Contact support](https://razorpay.com/docs/build/llm-docs/payroll/plans.md#contact-support) to initiate SAV for your organisation.
         - You transfer funds via IMPS. 

            IMPS is a reliable payment mode that is available 24/7 on all non-working days and bank holidays. Know more about the [default payment mode](https://razorpay.com/docs/build/llm-docs/payroll/payroll-payouts.md#modify-default-payout-mode).
...
### Fund Credit Not Updated
         ...
         Balance updates can be delayed if: 
            ...
            If you have transferred funds to Payroll and your balance does not reflect the amount, raise a [support ticket](https://razorpay.com/docs/build/llm-docs/payroll/plans.md). Include the funds transfer's receipt that shows the following details:
...
If you have any queries, raise a [support request](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-payroll).

## Make Payroll Payouts 

Payroll payouts happen after you [execute payroll](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#execute-payroll). Following are some options and best practices available to you when making payroll payouts. 
...
### Modify Default Payout Mode
         ...
         Payroll by default uses IMPS for any payout. IMPS is available 24/7 and works on all days, irrespective of whether it is a bank holiday or a weekend. 
            ...
            - If your employee has chosen NEFT transfers under their [Payments Information](https://razorpay.com/docs/build/llm-docs/payroll/employees.md) setup.
...
### Modify Payment Narration
         ...
         When initiating the payout, we pass your company's name in the narration and cannot control what is else displayed on the beneficiary's account statement.
            ...
            You can also sign up for a [Current Account](https://razorpay.com/docs/build/llm-docs/x/account-types/current-account.md) powered by RazorpayX and [integrate it with Payroll](https://razorpay.com/docs/build/llm-docs/payroll/integrations/current-account.md). When you transfer money using your Current Account, the salary and contractor payments are routed through an existing account under your company's name.
...
- There are bank server issues.
            ...
            Whenever a [payment fails](#payment-failure-reasons), Payroll automatically sends an email to all the administrators of that organisation and the affected [employee/contractor](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#differences-between-employee-and-contractor) with the required information. 
...
When you pay [contractors](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#differences-between-employee-and-contractor/) on the Payroll Dashboard, charges for the payments are not immediately deducted. You instead receive a consolidated monthly invoice for all the payments. 
...
- [Account Setup Guide](https://razorpay.com/docs/build/llm-docs/payroll/quickstart.md)
