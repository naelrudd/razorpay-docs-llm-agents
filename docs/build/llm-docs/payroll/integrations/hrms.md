...
- Map your employee types as `employees` or `contractors`. Know more about [employee types](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#employee-and-contractor) in Payroll.
...
- Sync dismissal dates from HRMS to calculate [Full and Final Settlement](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#full-and-final-settlement/) in Payroll.
...
1. Follow the on-screen instructions to authenticate the tool and map your employees on Payroll. 
    ...
    1. Map your employees as employee or contractor [employee types](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#employee-and-contractor) on Payroll. 
...
- Change employee information such as bank account data, contractor to full-time employee or vice-versa, personal details of the employee and so on using the **Modify Configuration** option.
    ...
    Suppose you must sync the bank account data from the HRMS after the integration, or a full-time employee is now a [contractor](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#differences-between-employee-and-contractor). You can change that information here. 
...
- [Contact Support](https://razorpay.com/docs/build/llm-docs/payroll/plans.md#contact-support)
