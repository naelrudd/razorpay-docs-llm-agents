...
- You must have a [RazorpayX - Current Account](https://razorpay.com/docs/build/llm-docs/x/account-types/current-account.md).
...
- There should be no balance in your Payroll account before integration. 
    - If there is any balance, add the Current Account as a [Contractor](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#differences-between-employee-and-contractor) and [transfer funds](https://razorpay.com/docs/build/llm-docs/payroll/payroll-payouts.md#transfer-funds) to this account. 
...
- If you have [approval workflows (maker-checker)](https://razorpay.com/docs/build/llm-docs/x/manage-teams/approval-workflow.md) enabled on your RazorpayX account, the same is applicable to all transactions originating from Payroll by default.
...
- [RazorpayX - Current Account](https://razorpay.com/docs/build/llm-docs/x/account-types/current-account.md)
