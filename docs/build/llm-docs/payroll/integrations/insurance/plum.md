...
- [Contractors](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#differences-between-employee-and-contractor) are not covered in the insurance plans.

## Prerequisites

1. Your organisation must be using RazorpayX Payroll for all the salary transfers and applicable [compliances](https://razorpay.com/docs/build/llm-docs/payroll/statutory-compliance.md).
...
- [Income Tax Declaration](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#income-tax-declaration) 
