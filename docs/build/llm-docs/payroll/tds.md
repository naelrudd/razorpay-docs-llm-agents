...
### 1. TRACES Registration
       ...
       [TRACES](https://www.tdscpc.gov.in/app/login.xhtml) registration is required by Payroll to download your employees' and contractors' Form 16/16A data.
         ...
         If your organisation is currently not registered on TRACES, [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-payroll) after Payroll has completed filing TDS returns for any quarter.
...
- Perquisites (if any).
- Exemptions like professional tax, HRA, flexible benefits and so on.
...
### Change Employee's Regime
       ...
       In some cases, you can allow employees to change their tax regime after the initial selection. 
         ...
         This successfully reverses the tax regime for the employee. You can select the regime or allow the employee select the regime from [Tax Deductions](https://razorpay.com/docs/build/llm-docs/payroll/employees/declarations.md) on their dashboard.
...
### Employee's Form 16
       ...
       Once the Form 16s are available to us, we upload all employees' **unsigned Form 16s** on the Payroll Dashboard in **My Pay Slips**. Know more about [Payslips and Form 16](https://razorpay.com/docs/build/llm-docs/payroll/employees/payslips-form16.md).
       ...
       - [Contact support](https://razorpay.com/docs/build/llm-docs/payroll/plans.md#contact-support) to upload the signed Form 16s on the Payroll Dashboard for your employees to access them.
...
### TDS on Razorpay Charges
       ...
       To check this:
         ...
         View your current settings. 
               ...
               You must pay the TDS separately and share the TDS certificate (Form 16A) with the [support team](https://razorpay.com/docs/build/llm-docs/payroll/plans.md#contact-support). Payroll verifies this TDS amount and credits it to your Payroll account.
...
### TDS on One-time Payments
       ...
       Know more about [TDS on One-time payments](https://razorpay.com/docs/build/llm-docs/payroll/one-time-payments.md#tds-on-one-time-payments). 
...
### TDS on Custom Salary Structure Components
       ...
       Know more about [Custom Salary Structure](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#setup-salary-structures). 
      

   
### TDS on Bonus

       When you pay a bonus (as a one-time payment or as a Payroll cycle [addition](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#additions-and-deductions)), specifically in the middle of the financial year, the employee's TDS liability increases. 
...
New TDS/TCS section codes are now in effect. Refer to the [new TDS/TCS section codes](https://razorpay.com/docs/build/llm-docs/payroll/tax-verifications/tax-codes.md) for the complete reference.
...
- [Salary Exceptional Cases](https://razorpay.com/docs/build/llm-docs/payroll/exceptional-cases.md)
