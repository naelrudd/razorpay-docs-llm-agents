...
### What is the difference between Gross Pay and Net Pay?
    ...
    1. Enter the employee's personal email address for further communication. 
        ...
        If Payroll had been handling the employee's [Form 16s](https://razorpay.com/docs/build/llm-docs/payroll/salary.md#employee-s-form-16), the employee receives it on their personal email address at the end of the financial year.
    1. Click **Add to Payment**. 

You have successfully modified the full and final settlement for the employee. The employee receives the settlement payment after you [execute payroll](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#execute-payroll) for the month.
...
- [Dismiss Employees on the Payroll Dashboard](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#terminate-and-run-last-payroll)
