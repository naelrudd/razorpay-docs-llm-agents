...
On Payroll, you can automate registering your employees for compliances and payments (except  [Provident Fund (PF)](https://razorpay.com/docs/build/llm-docs/payroll/faqs.md#pf-payments)). We do not handle registrations for organisations. Talk to [these CA partners](#initiate-initial-registration-for-organisations) to start the initial registration.
...
### Compliance Payments Features that Payroll Handles
         ...
         Payroll helps you automate all the operational parts of compliances. With Payroll, you get access to:
            - [PF UAN registration](https://razorpay.com/docs/build/llm-docs/payroll/provident-fund.md), register management, monthly payments and filings.
            - [ESI IP registration](https://razorpay.com/docs/build/llm-docs/payroll/esi.md), register management, monthly payments and filings.
            - [TDS payment](https://razorpay.com/docs/build/llm-docs/payroll/tds.md) and Quarterly filings (24Q).
            - One-Time [Tax Documentation Verification](https://razorpay.com/docs/build/llm-docs/payroll/tax-deductions-setup.md) in January along with TDS Payments and Quarterly Filings (24Q).
            - [Form 16](https://razorpay.com/docs/build/llm-docs/payroll/salary.md#employee-s-form-16) generation at the end of the year.
            - [26Q filings](https://razorpay.com/docs/build/llm-docs/payroll/tds.md#file-tds-return), if enabled, and all contractors payments made via the platform.
...
### Initiate Initial Registration for Organisations
         ...
         However, few CA partners who use Payroll to manage their clients on our platform can help you register your organisation for compliances. Their contact details are provided below:
            ...
            You can add your CA partner as a [Contractor](https://razorpay.com/docs/build/llm-docs/payroll/quickstart.md#add-all-employees) who has [special access](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#special-access-and-permissions) to your Payroll account. 

            Your partners then receive a [welcome email](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#welcome-mail-from-xpayroll) and will be able to login and access relevant sections of the platform as you choose.
        

## Prerequisites

To ensure timely compliance payments, ensure you update all the required credentials under
**Company Details** ➔ **External Credentials** [during account set up](https://razorpay.com/docs/build/llm-docs/payroll/quickstart.md). Ensure you have updated your credentials post TIN implementation.
...
### Tax Deducted at Source (TDS)
         ...
         Tax Deducted at Source, or simply TDS, is deducted from salary and one-time payments as applicable. Know more about [filing TDS](https://razorpay.com/docs/build/llm-docs/payroll/tds.md) with RazorpayX Payroll.
        

    
### Provident Fund (PF)

         Payroll handles all the monthly payments, filings and employee registration after the initial registration is complete. However, it does not offer initial registration for [Provident Fund](https://razorpay.com/docs/build/llm-docs/payroll/provident-fund.md).
        

    
### Employees State Insurance (ESI)

         Employees State Insurance (ESI) is a government-mandated health insurance for employees. We handle the register management, monthly payments and filings. Know more about [ESI](https://razorpay.com/docs/build/llm-docs/payroll/esi.md). 
...
### Professional Tax (PT)
         ...
         Know how to set up and handle [Professional Tax in Payroll](https://razorpay.com/docs/build/llm-docs/payroll/professional-tax.md). 
...
### Labour Welfare Fund (LWF)
         ...
         On the Payroll Dashboard, you can set up LWF at an organisation or employee level.
                ...
                Organisation Level Configuration
                    ...
                    This successfully makes employer's LWF contribution a part of the employee's CTC. Ensure you set up [employee's salary structure](https://razorpay.com/docs/build/llm-docs/payroll/salary.md#setup-salary-structure) accordingly. 
...
** **For PT Payments**: 
- Automated Professional Tax (PT) payments for employees in Karnataka are [temporarily unavailable](https://razorpay.com/docs/build/llm-docs/payroll/faqs.md#professional-tax). 
...
- [Enable Compliance during Account Setup](https://razorpay.com/docs/build/llm-docs/payroll/administrator.md#welcome-mail-from-xpayroll)
- [Provident Fund](https://razorpay.com/docs/build/llm-docs/payroll/provident-fund.md)
- [TDS](https://razorpay.com/docs/build/llm-docs/payroll/tds.md)
