...
### What is the difference between Advance Salary and Employee Loans?
         ...
         In an [Advance Salary](https://razorpay.com/docs/build/llm-docs/payroll/advance-salary.md), the organisation pays a portion of the employee's salary as an advance. The advance paid is recovered in instalments from the employee and is usually interest-free.
...
1. Click **DISBURSE LOAN ()**. This creates the loan payout to your employees. 
    ...
    [Add funds to your Payroll account](https://razorpay.com/docs/build/llm-docs/payroll/payroll-payouts.md#transfer-funds) in case the **DISBURSE LOAN ()** option is not available.
...
In the [employees' profile](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#set-up-profile) view, you can either set a limit on the total perquisite amount allowed (only in [custom salary structure](https://razorpay.com/docs/build/llm-docs/payroll/salary.md#setup-salary-structure)) or let Payroll calculate the amount allowed automatically. This is beneficial in cases of employee's [salary revision](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#revise-salary).
...
- Employees can view their loan infomation from their [profile](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#set-up-profile). 

### Related Information

- [About Salary](https://razorpay.com/docs/build/llm-docs/payroll/salary.md)
- [Run Payroll](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md)
