...
An employee can [apply for reimbursement](https://razorpay.com/docs/build/llm-docs/payroll/employees/reimbursements.md) from their Dashboard whenever they pay for organisational expenses from their own pockets. 
...
- [Instant Reimbursement](https://razorpay.com/docs/build/llm-docs/payroll/instant-reimbursement.md)
- [Reimbursements for Employees](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#reimbursements)
