...
People in an organisation, primarily the employees and the contractors, are the company's most valuable asset. It is important to honour their needs and requirements.
...
When you someone to your organisation's payroll as an employee or a contractor, Payroll sends them a [welcome email](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#employee-onboarding). This allows the employees to access the Employee Dashboard on Payroll. 

### Two-Factor Authentication

On the Payroll Dashboard, 2FA is enabled by default for all [user roles](https://razorpay.com/docs/build/llm-docs/payroll/user-roles-workflows.md) except employees. You can enable two-factor authentication (2FA) for your employees and enhance access security. 
...
### Mail not Received
         ...
         If your employees report [not receiving any email](https://razorpay.com/docs/build/llm-docs/payroll/employees.md#unable-to-find-email) from Payroll, the following could be the reasons: 
...
### OTP Not Received
         ...
         This resends the onboarding email to the employee post which they can log in to the Payroll Dashboard. [Contact Support](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-payroll) if you face further issues. 
...
- [Employees](https://razorpay.com/docs/build/llm-docs/payroll/employees.md)
- [Leaves](https://razorpay.com/docs/build/llm-docs/payroll/leaves.md)
- [Attendance](https://razorpay.com/docs/build/llm-docs/payroll/attendance.md)
- [Payroll Payouts](https://razorpay.com/docs/build/llm-docs/payroll/payroll-payouts.md)
