...
- [Hold Salary and Pay Compliance](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll/fnf.md). 

Know more about [employee dismissal](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#terminate-and-run-last-payroll).
...
### How to fill the template correctly?
                 ...
                 - Ensure the employees for whom you are initiating FnF in bulk are not the orgnaisation's [administrators](https://razorpay.com/docs/build/llm-docs/payroll/user-roles-workflows.md#view-collaborators).
                 - You can start [holding salary](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll/fnf.md) from a month where the payroll is not yet finalised. 
...
### 1. I want to hold the salary of a single employee. Is it possible?
            ...
            Yes, you can withhold the salary of an individual employee. Refer to [Hold Salary, Pay Compliance](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll/fnf.md).
...
- [About Employee Dismissal](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#terminate-and-run-last-payroll)
- [About Salary Additions/Deductions](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#attendance-based-salary-calcuation)
