...
### Other Payments
            ...
            Facilities and Features | Prime | Elite | Enterprise
            ---
            Expense management/[Reimbursements](https://razorpay.com/docs/build/llm-docs/payroll/reimbursements.md) | ✓ | ✓ | ✓  
            ---
            Contractor payments | ✓** | ✓** | ✓
...
### Compliance Payments, Calculation and Filing
            ...
            Facilities and Features | Prime | Elite | Enterprise
            ---
            [Compliance Calculations](https://razorpay.com/docs/build/llm-docs/payroll/statutory-compliance.md) (PT, TDS) | ✓ | ✓ | ✓ 
            ---
...
### Advance Payroll
            ...
            ---
            [Custom Roles and Permissions](https://razorpay.com/docs/build/llm-docs/payroll/user-roles-workflows.md) | x | ✓ | ✓
            ---
            [Custom Salary Structure](https://razorpay.com/docs/build/llm-docs/payroll/salary.md#setup-salary-structure/) | ✓ | ✓ | ✓
            ---
            NPS | ✓ | ✓ | ✓ 
            ---
            Employee PF and VPF | ✓ | ✓ | ✓ 
            ...
            Resettlement | ✓ | ✓ | ✓
            ---
            [Salary Advance](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#advance-salary) | ✓ | ✓ | ✓
            ---
            Loan Management | ✓ | ✓ | ✓
            ---
            [Flexible Benefits](https://razorpay.com/docs/build/llm-docs/payroll/salary.md#avail-flexible-benefits) | ✓ | ✓ | ✓
            ---
            Approval Workflows | x | ✓ | ✓
            ---
            Bonus Management | ✓ | ✓ | ✓
            ---
            [Investment Proof Verification](https://razorpay.com/docs/build/llm-docs/payroll/salary.md#set-up-flexi-benefits) | ✓ | ✓ | ✓
...
### Employee Delight Features
            ...
            ---
            Payslips via [WhatsApp](https://razorpay.com/docs/build/llm-docs/payroll/integrations/whatsapp.md) | ✓ | ✓ | ✓
            ---
            Payslips via and [Slack](https://razorpay.com/docs/build/llm-docs/payroll/integrations/slack.md) | ✓ | ✓ | ✓
            ---
            ...
            Salary Account | ✓ | ✓ | ✓
            ---
            [Employee ITR Filing](https://razorpay.com/docs/build/llm-docs/payroll/employees/declarations.md#make-declarations) | ✓ | ✓ | ✓ 
            ---
            [Letter Generation](https://razorpay.com/docs/build/llm-docs/payroll/documents-letters.md) | ✓ | ✓ | ✓
            ---
...
- [RazorpayX Payroll](https://razorpay.com/docs/build/llm-docs/payroll.md) 
