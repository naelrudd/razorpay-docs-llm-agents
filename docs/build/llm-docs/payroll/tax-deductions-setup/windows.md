...
After you [enable the declaration settings](https://razorpay.com/docs/build/llm-docs/payroll/tax-deductions-setup.md#enable-set-up), you can choose the declaration window period for the year your employees can declare their investments. This usually happens at the beginning of the year. 
...
- [About Tax Deductions Setup](https://razorpay.com/docs/build/llm-docs/payroll/tax-deductions-setup.md)
- [Verify Tax Proofs](https://razorpay.com/docs/build/llm-docs/payroll/tax-verifications.md)
