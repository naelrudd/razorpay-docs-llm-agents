...
For detailed guidance on manual approvals, refer to [Reimbursements.](https://razorpay.com/docs/build/llm-docs/payroll/reimbursements.md#approve-instant-reimbursements)
