...
1. Set up [user roles](https://razorpay.com/docs/build/llm-docs/payroll/user-roles-workflows.md) in Payroll. 
1. Create and save approval workflows and assign one or two levels of approvers on the Dashboard.
1. Your team/[collaborators](https://razorpay.com/docs/build/llm-docs/payroll/user-roles-workflows.md#view-collaborators)/user roles make a request and send it for the approvers' review. 
...
- [Edit Payroll](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#additions-and-deductions)
- [Finalise Payroll](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#execute-payroll)
- [Salary Revision](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#revise-salary)

Know more about the [Approver Checklist](https://razorpay.com/docs/build/llm-docs/payroll/approval-workflow/checklist.md). 

**WARN**

**Watch Out!**

You must set up [user roles](https://razorpay.com/docs/build/llm-docs/payroll/user-roles-workflows.md) before creating approval workflows. Go to **Settings** → **User Roles & Workflows** → **User Roles** → **EDIT** on the [Payroll Dashboard](https://payroll.razorpay.com/dashboard).
...
1. On the **Workflows** page:
    1. Enter the names of all the users you want to assign as approvers in the text box. For example, two finance role users, Gauri Kumari and Gaurav Kumar.
        ...
        Ensure the users have the appropriate permissions to approve/reject as defined in the [user roles](https://razorpay.com/docs/build/llm-docs/payroll/user-roles-workflows.md). 
...
When a maker performs any action requiring approval on the Payroll Dashboard, the assigned approvers receive the notification via email and the Dashboard. Approvers can then view the request on the [Approvals Dashboard](https://razorpay.com/docs/build/llm-docs/payroll/approval-workflow/approvers.md).

## Related Information 

- [Approvals Checklist](https://razorpay.com/docs/build/llm-docs/payroll/approval-workflow/checklist.md)
- [Approvals Dashboard](https://razorpay.com/docs/build/llm-docs/payroll/approval-workflow/approvers.md)
- [User Roles and Workflows](https://razorpay.com/docs/build/llm-docs/payroll/user-roles-workflows.md)
