...
Due to the introduction of [2FA on the PT portal](https://razorpay.com/docs/build/llm-docs/payroll/faqs.md#professional-tax) by Karnataka government, Payroll enables you to automate PT payments (for Karnataka employees) via the Dashboard. Previously, we had paused PT payments via the Dashboard.
...
### Initiate PT Payments
        ...
        1. [Finalise Payroll](https://razorpay.com/docs/build/llm-docs/payroll/run-payroll.md#execute-payroll) for the month and execute it.
