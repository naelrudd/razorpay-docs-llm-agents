...
- The Dashboard has [test and live modes](https://razorpay.com/docs/build/llm-docs/payments/dashboard/test-live-modes.md). Use the test mode for a sandbox experience. You can switch to live mode when you are ready to accept payments. You will have to create a new Payment Page in live mode.
- Understand the [Payment Flow](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/how-it-works.md).
...
2. Fill in the page details:
    ...
    2. You can use the [rich-text features](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/add-images-videos.md) to add images and videos.
...
- You can customise this section by adding videos, images and more, using our [rich-text features](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/add-images-videos.md).
...
You can ensure that your customers receive payment receipts via email once they complete the payment. Know how you can [send and download automated or manual payment receipts](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/receipt.md).

If you are an NGO, [know how you can send and download payment receipts with 80-G information](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/80g-receipt.md).
...
You can set up webhooks to receive notifications on payments using the page. Know more about how to [set up webhooks](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/subscribe-to-webhooks.md).
...
You can view the payments as and when they are made in the [Transactions Details View](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/view-reports.md) of the page.
...
- [How Payment Pages Work](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/how-it-works.md)
