...
8. Continue with the creation of your Payment Page. Know more about how to [Create a Payment Page](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/create.md#step-2-add-page-details/).
...
4. The page appears in edit mode. You can now edit any of the fields from [step 4](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/plugins-add-ons/magic-checkout.md#integration-steps:~:text=Click%20Magic%20Checkout%20Settings.) onwards.
...
After you integrate Payment Pages with Magic Checkout, you can also integrate with [Shiprocket](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/plugins-add-ons/shiprocket.md) if required.
