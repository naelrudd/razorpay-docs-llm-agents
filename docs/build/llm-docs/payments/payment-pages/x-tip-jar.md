...
- [Set up](https://razorpay.com/docs/build/llm-docs/payments/set-up.md) your Razorpay account and complete the KYC process.
- Create a [Payment Page](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/create.md) and copy the page URL. If you already have a Payment Page, follow the steps given below.
...
In case of any issues, reach out to the please raise a request with the [Razorpay Support team](https://razorpay.com/support/#request).
