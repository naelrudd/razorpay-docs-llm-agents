...
### Prerequisites
     ...
     - [Generate API Keys from the Dashboard](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) if not done already.
...
### 1.3 Fetch Payment Methods
     ...
     Know more about the various [payment methods](https://razorpay.com/docs/build/llm-docs/payments/payment-methods.md).
