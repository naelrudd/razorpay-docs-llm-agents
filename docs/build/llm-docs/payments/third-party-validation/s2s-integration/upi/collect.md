...
1. You should validate the VPA before initiating the payment request. Know more about[VPA Validation](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom/features/validate-vpa.md).
...
3. You should use the [Saved VPA](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/saved-vpa.md) feature provided by Razorpay to provide a better customer experience and have a better conversion.
...
`notes` _optional_
: `json object` Key-value pairs that can hold additional information about the payment. Refer to the [Notes](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes) section of the API Reference Guide.
