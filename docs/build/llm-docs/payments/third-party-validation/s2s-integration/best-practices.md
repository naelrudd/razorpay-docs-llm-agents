...
1. We recommended using [S2S JSON API](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/json/v2.md) for S2S integration.
...
4. You should integrate [webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md) to get a callback via a server to server call.
5. Integrate the [Payments Rainy Day kit](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/rainy-day.md) to tackle payment exceptions such as late authorized payments, payment downtimes and errors.
