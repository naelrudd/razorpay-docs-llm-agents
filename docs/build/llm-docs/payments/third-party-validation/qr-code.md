...
- Ensure the [Third-Party Validation](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation.md) feature is activated on your account.

## Sample Code

After creating an order using the [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders/create.md), use the following API call to generate a UPI intent deep link and convert the returned link into a QR code:
...
: `string` Order ID generated via [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders/create.md).
...
5. [Poll Payment APIs](https://razorpay.com/docs/build/llm-docs/api/payments/fetch-with-id.md) to check the payment status.
