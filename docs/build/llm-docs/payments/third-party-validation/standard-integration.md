...
### Prerequisites
         ...
         1. Set up your [Razorpay account](https://razorpay.com/docs/build/llm-docs/payments/set-up.md), if you have not done already.
         2. Contact your dedicated support POC to enable the TPV feature for your account.
         3. [Generate API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) required to authenticate API requests sent to Razorpay servers.
         4. Check the [best practices](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation/best-practices.md).
...
-  On payment failure, the customer is requested to retry payment at Checkout.
         ...
         Know more about the[Checkout Form Fields](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/integration-steps.md#checkout-options).
...
### 1.4 Handle Payment Success and Failure
         ...
         If you used **Sample Code with Handler Function**:
                 ...
                 Know more about[the error parameters.](https://razorpay.com/docs/build/llm-docs/errors.md#response-parameters)
...
Authorised payments can be automatically captured. You can auto-capture all payments [using global settings](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md#auto-capture-all-payments) on the Dashboard.
         
**WARN**

**Watch Out!**

Payment capture settings work only if you have integrated with Orders API on your server side. Know more about the [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md#create-an-order).

         - **Manually capture payments**
         
Each authorised payment can also be captured individually. You can manually capture payments using:
             - [Payment Capture API](https://razorpay.com/docs/build/llm-docs/api/payments.md#capture-a-payment)
             - [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/payments/dashboard.md#manually-capture-payments)

         Know more about [Capture Settings for payments](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md).
