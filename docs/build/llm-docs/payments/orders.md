...
You can [create an order using this API](https://razorpay.com/docs/build/llm-docs/api/orders.md#create-an-order).

## Dashboard Actions

Perform the following actions using the Dashboard:
- [View orders](https://razorpay.com/docs/build/llm-docs/payments/orders/dashboard.md#view-order-details)
- [Subscribe to Webhook Events related to orders](https://razorpay.com/docs/build/llm-docs/payments/orders/dashboard.md#subscribe-to-webhook-events)
- [View reports related to orders](https://razorpay.com/docs/build/llm-docs/payments/orders/dashboard.md#reports)

### Related Information

[Orders APIs](https://razorpay.com/docs/build/llm-docs/payments/orders/apis.md)
