...
You can create roles/teams for different levels of actions on invoices (create, view, edit and so on). Know more about [roles and actions](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md).

You can perform all the actions on invoices from the Dashboard - create, issue, cancel, duplicate, search, update or delete. You can also subscribe to Webhook events for immediate notifications. You can perform most of these actions using [APIs](https://razorpay.com/docs/build/llm-docs/payments/invoices/apis.md).
...
You can create non-GST invoices in any of the [supported international currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies) using the Dashboard or APIs.
...
### What Next
Understand [how you can use Razorpay Invoices](https://razorpay.com/docs/build/llm-docs/payments/invoices/how-it-works.md) and the various [Invoice states](https://razorpay.com/docs/build/llm-docs/payments/invoices/states.md).
