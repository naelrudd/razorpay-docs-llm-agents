...
You can configure the shipping method rate only on your Shopify store. Know more about how to create [shipping options on Shopify](https://razorpay.com/docs/build/llm-docs/payments/cod-magic-checkout/shopify/shipping-options.md).
