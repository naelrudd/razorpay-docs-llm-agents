...
[Choose Razorpay products](https://razorpay.com/docs/build/llm-docs/payments.md) based on your business requirements.

    
### Online Payments vs. Offline Payments

         Choose between digital payment processing for ecommerce and websites using [Payment Gateway](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md), [Magic Checkout](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout.md) and [Payment Links](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md) or physical payment solutions for retail stores and face-to-face transactions with [Razorpay POS](https://razorpay.com/docs/build/llm-docs/pos.md). Know more about [online and offline payment options](https://razorpay.com/docs/build/llm-docs/payments.md#accept-payments).
        

    
### One-time Payments vs. Recurring Payments

         Select single transaction processing for individual purchases using [Payment Gateway](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md), [Payment Links](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md) and [Payment Pages](https://razorpay.com/docs/build/llm-docs/payments/payment-pages.md) or automated recurring billing for subscriptions and regular services with [Subscriptions](https://razorpay.com/docs/build/llm-docs/payments/subscriptions.md). Know more about [one-time and recurring payment solutions](https://razorpay.com/docs/build/llm-docs/payments.md#accept-payments).
        

    
### No-code Products vs. Products with Coding Requirements

         Pick ready-to-use payment solutions with simple setup like [Payment Links](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md), [Payment Pages](https://razorpay.com/docs/build/llm-docs/payments/payment-pages.md), [Invoices](https://razorpay.com/docs/build/llm-docs/payments/invoices.md) or refer to our [Payment Gateway SDKs](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins) for advanced integration needs. Explore [no-code and developer-friendly options](https://razorpay.com/docs/build/llm-docs/payments.md#accept-payments).
        

    
### Solutions by Industry

         Find tailored payment solutions designed for your industry: [Payment Gateway](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md) for ecommerce, [Subscriptions](https://razorpay.com/docs/build/llm-docs/payments/subscriptions.md) for SaaS, [Route](https://razorpay.com/docs/build/llm-docs/payments/route.md) for marketplaces or [Razorpay POS](https://razorpay.com/docs/build/llm-docs/pos.md) for traditional retail businesses. View [industry-specific payment solutions](https://razorpay.com/docs/build/llm-docs/payments.md#solutions-by-industry).
        

    
### Solutions by Platform

         Integrate payments seamlessly with popular ecommerce platforms like Shopify, WooCommerce, Magento using [Payment Gateway ecommerce plugins](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins) or build custom solutions using our [Checkout SDKs](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins) for Go, PHP, Python, Node.js and [mobile platforms](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins) (Android, iOS, React Native, Flutter, Cordova, Capacitor). Browse [platform-specific integration guides](https://razorpay.com/docs/build/llm-docs/payments.md#solutions-by-platform).
...
### Generate API Keys
            ...
            **Important:**
            ...
            [API Keys Documentation →](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md)
...
### Add Team Members
            ...
            [Team Management Guide →](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md)
...
### Configure Webhooks
            ...
            [Webhooks Documentation →](https://razorpay.com/docs/build/llm-docs/webhooks.md)
...
The minimum value is 12 minutes.- The maximum value (default) is 3 days.
            ...
            [Payment Capture Guide →](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md)
...
1. **Complete KYC**: [Submit KYC documents](https://razorpay.com/docs/build/llm-docs/payments/set-up.md#2-submit-kyc-details) for live mode activation.
