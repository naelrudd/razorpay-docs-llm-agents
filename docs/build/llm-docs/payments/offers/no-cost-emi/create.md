...
3. The **Create an Offer** wizard appears with the following four sections. Enter details in all these sections to create the offer.
    ...
    - [**Additional Offer Type**](#additional-offer-type)
...
Know more about [integrating No Cost EMI Offers with Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/offers/no-cost-emi/standard-integration.md).
