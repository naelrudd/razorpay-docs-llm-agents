...
Know how to [integrate Offers with Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/offers/standard-integration.md).
...
After you create an offer, it needs to be integrated with Checkout for the customers to view and avail the offers while making payments. Know more about [integrating offers with Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/offers/standard-integration.md).

### Related Information

- [Tutorial - How to Create Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/tutorial.md)
- [Integrate offers with Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/offers/standard-integration.md)
