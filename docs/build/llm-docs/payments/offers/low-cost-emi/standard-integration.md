...
After creating [Low Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi/create.md) from the Dashboard, you have to integrate them with Razorpay Standard Checkout so that your customers can avail them while making payments.
...
---
**Amount Match** | Order amount should be more than or equal to the [Minimum Order Amount](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi/create.md) set in an offer.
--- 
...
This is the easiest way to display Low Cost EMI offers at the Checkout. While [creating the Low Cost EMI offer](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi/create.md) from the Dashboard, enable the **Show Offer on Checkout** option.
...
You can [create Low Cost EMI offers](https://razorpay.com/docs/build/llm-docs/payments/offers/create.md#create-offers) from the Dashboard.
...
- [Low Cost EMI FAQs](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi/faqs.md)
- [Disable Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi/create.md#disabling-low-cost-emi-offers)
