...
You can create a Low Cost EMI offer from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/offers/create.md).
...
This is mandatory only in cases where you want to associate an offer or offers with the Order or you had not selected the [Show Offer on Checkout](https://razorpay.com/docs/build/llm-docs/payments/offers/create.md#offer-validity) while creating the offer from the Dashboard.
...
### Related Information
- [About Low Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi.md)
- [Create Low Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi/create.md)
- [Tutorial - How to Create Low Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi/tutorial.md)
