...
[Create an offer](https://razorpay.com/docs/build/llm-docs/payments/offers/create.md) from the Dashboard.
            ...
            : `object` Criteria that qualify transactions for the offer.
                ...
                : `object` Filters on payment methods and instruments. For example, `issuer`, `apps` or `vpa`.
                    ...
                    : `object` Details of wallet payment method. 
                        ...
                        `providers`
                        : `string` List of supported wallet providers. For example, [Wallet providers](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/wallets.md#supported-wallets).
