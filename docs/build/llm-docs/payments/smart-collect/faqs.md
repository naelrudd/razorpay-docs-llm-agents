...
### 3. How do I know the allowed payers list?
       ...
       You can fetch the `allowed_payers` list using [Webhook](https://razorpay.com/docs/build/llm-docs/webhooks/smart-collect.md) or API response.
...
### 4. With which banks can I open a Current/Escrow Account?
         ...
         You can open a [Current account](https://razorpay.com/docs/build/llm-docs/x/account-types/current-account.md)/[Escrow account](https://razorpay.com/docs/build/llm-docs/x/account-types/escrow.md) with Yes Bank or Axis Bank. 
        

    
### 5. How do I make payouts from the Escrow/Current account?

         You can make payouts using the [Payouts APIs](https://razorpay.com/docs/build/llm-docs/x/payouts/api.md).
...
### 8. How is the fee for Smart Collect 2.0 collected?
         ...
         We collect the Smart Collect 2.0 usage fee from your [Fee Credits](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/credits.md#fee-credits). If your Fee Credits are low, we charge it from your [settlement](https://razorpay.com/docs/build/llm-docs/payments/settlements.md#settlement-cycle).
