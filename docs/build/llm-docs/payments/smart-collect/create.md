...
### To create Smart Collect Customer Identifiers with TPV:
        ...
        3. Complete these steps to add account details for the **Third Party Validation**:
            ...
            1. Select the **Bank Transfers (NEFT, RTGS, IMPS)** checkbox to create Customer Identifier details with TPV for bank transfers. Know more about [Third Party Validation](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/third-party-validation.md).
...
You cannot modify customers for Customer Identifiers after you create and save them. Ensure you tag the Customers to Customer Identifiers when you create them.
                    ...
                    Use any of the following APIs to create Customer Identifiers as necessary: 
                        ...
                        - [Create Customer Identifier With Bank Account Receiver](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect/create-cust-id-bank-account.md)
                        - [Create a Customer Identifier With VPA Receiver](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect-2/create-cust-id-vpa.md)
                        - [Create a Customer Identifier With VPA and Bank Account Receivers](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect-2/create-cust-id-bank-account-vpa.md)
...
### To create Smart Collect 2.0 Customer Identifiers with TPV:
                    ...
                    1. Follow the steps to [create Smart Collect 2.0 Customer Identifiers](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/create.md#to-create-smart-collect-20-customer-identifiers).
                    ...
                    This successfully creates a [Customer Identifiers with TPV](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/create-tpv.md).

                
                
                    Use any of the following APIs to create Customer Identifiers as necessary:

                    - [Create Customer Identifier](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect-tpv/create.md)
                    - [Add an Allowed Payer Account](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect-tpv/add-allowed-payer.md)
                    - [Add VPA Receiver to an Existing Customer Identifier](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect-2/add-receiver-vpa.md)
                    - [Add Bank Account Receiver to an Existing Customer Identifier](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect-2/add-receiver-bank-transfer.md)
...
- After you create a Customer Identifier, it moves to `active` status. Know more about the [states of Customer Identifiers](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/states.md).
- You can disable/[close a Customer Identifier using APIs](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect/close.md) if you no longer need it to accept payments. 
...
### Related Information
- [Close Customer Identifiers](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/close.md)
