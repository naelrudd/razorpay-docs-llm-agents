...
You can initiate refunds from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/refund.md) or using [APIs](https://razorpay.com/docs/build/llm-docs/api/refunds.md).
