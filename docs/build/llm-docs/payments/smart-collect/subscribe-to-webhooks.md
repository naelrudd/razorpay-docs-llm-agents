...
- Ensure that you have subscribed to [Smart Collect Events](https://razorpay.com/docs/build/llm-docs/webhooks/smart-collect.md#smart-collect).
...
- To uniquely identify the payment, store the `bank_reference` (unique reference number on the customer's bank statement) received in [webhooks](https://razorpay.com/docs/build/llm-docs/webhooks/smart-collect.md#smart-collect) or the [Fetch API response](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect.md#fetch-a-customer-identifier-by-id).
...
Know more about [Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md) and check the [sample payloads](https://razorpay.com/docs/build/llm-docs/webhooks/smart-collect.md).

### Related Information
- [Razorpay Smart Collect](https://razorpay.com/docs/build/llm-docs/payments/smart-collect.md)
...
- [Smart Collect Dashboard](https://razorpay.com/docs/build/llm-docs/payments/smart-collect.md)
...
- [Refund Failures](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/refund-failures.md)
