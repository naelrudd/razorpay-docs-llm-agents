...
You can initiate refunds from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/va-vpa-qr/dashboard/refund.md) or using [APIs](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/va-vpa-qr/api/refunds.md).
