...
The request format for virtual account creation recently underwent a change, and the updated format can be found [here](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/va-vpa-qr/api.md). The request format given below will eventually be deprecated.
...
With the exception of the `Create` API, the request format for all other API endpoints remains the same, and can be checked [here](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/va-vpa-qr/api.md).
