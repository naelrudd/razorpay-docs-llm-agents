...
Payments made using Smart Collect will also trigger webhooks much like regular payments. To use webhooks, refer our [Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md) documentation.
