...
Ensure you have read the [product document](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/va-vpa-qr.md) before you proceed with the API integration.
...
- [Create a customer](https://razorpay.com/docs/build/llm-docs/api/customers.md) (optional)
- [Create a Customer Identifier](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/va-vpa-qr/api/create.md)
- Share Customer Identifier details with customer
- [Setup webhooks to receive payment notifications](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/va-vpa-qr/notification.md) (optional)
...
`notes`
: `json object` Any custom notes you might want to add to the virtual account can be entered here. Refer [Notes section of the API Reference Guide](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes) to learn more.

`customer_id`
: `string` Unique identifier of the customer the virtual account is linked with. Refer the [Customer API](https://razorpay.com/docs/build/llm-docs/api/customers.md) section to learn more.
...
: `json object` Configuration of desired receivers for the virtual account.
 ...
 - `qr_code`
  ...
  `notes`
  : `json object` Any custom notes you might want to add to the virtual bank account or virtual UPI ID can be entered here. Refer [Notes section of the API Reference Guide](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes) to learn more. This parameter appears in the response only when `bank_account` is passed as the receiver `type`.
