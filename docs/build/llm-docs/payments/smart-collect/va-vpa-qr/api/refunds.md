...
`notes` _optional_
: `json object` Array of notes fields. You can enter custom data in key-value pairs. Refer the [Notes section of the API Reference](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes) documentation to learn more.
...
`currency`
: `string` The currency in which the payment is made. We support [international currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies).
...
Refer [Refunds API](https://razorpay.com/docs/build/llm-docs/api/refunds.md) to perform other refund-related operations:
