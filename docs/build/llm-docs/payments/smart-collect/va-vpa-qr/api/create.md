...
`notes` _optional_
: `json object` Any custom notes you might want to add to the virtual account can be entered here. Refer to the [Notes section of the API Reference Guide](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes) to learn more.
