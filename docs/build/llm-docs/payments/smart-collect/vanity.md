...
To enable Vanity Accounts for your account, contact our [support](https://razorpay.com/support/), with the desired merchant [handle](https://razorpay.com/docs/build/llm-docs/payments/smart-collect/vanity.md#handle).
