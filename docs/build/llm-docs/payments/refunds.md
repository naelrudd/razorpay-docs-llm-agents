...
- [Normal Refund](https://razorpay.com/docs/build/llm-docs/payments/refunds/normal.md)
...
- [Issue Refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds/issue.md)
- [View Settlement Details of a Refund](https://razorpay.com/docs/build/llm-docs/payments/refunds/view.md#view-settlement-details-of-a-refund)
- [Subscribe to Webhook Events](https://razorpay.com/docs/build/llm-docs/payments/refunds/subscribe-to-webhooks.md)
...
- [EMI and Pay Later Refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds/emi-pay-later.md)
...
- [Refund Communication](https://razorpay.com/docs/build/llm-docs/payments/refunds/communication.md)
