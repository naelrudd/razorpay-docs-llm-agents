...
### Owner
         ...
         **Actions Allowed**
         ...
         - Contest all disputes and submit evidence
         ...
         - Create and manage Invoices, Plans and Subscription Links, Customer Identifiers, Customers, Payment Pages and Payment Links.

         - Edit Razorpay Linked Account details
...
### Admin
         ...
         **Actions Allowed**
          ...
          - Create and manage Invoices, Plans and Subscription Links, Customers, Customer Identifiers, Payment Pages and Payment Links.
...
### Manager
     ...
     **Actions Not Allowed**
      ...
      - Resend Subscription Registration link
...
### Operations
     ...
     **Actions Allowed**
       ...
       - Create Invoices, Payment Buttons, Customer Identifiers, Payment Links and Payment Pages.
...
### ePos
      ...
      **Actions Allowed**
      ...
      - Create, view and edit Payment Button

      - Create, view and edit Payment Handle
     ...
     **Actions Not Allowed**
        ...
        - View Invoices, Payment Pages, Payment Links created by other users
...
- Use the [Dispute Manager](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#dispute-manager) role for team members who only need to handle chargebacks without access to refunds or bank details.
- Use the [Pseudo Owner](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#pseudo-owner) role sparingly for trusted individuals who need to manage the account when the Owner is unavailable.
- Use the [View-Only](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#view-only-auditor) role for auditors and stakeholders who need visibility without operational access.
...
### Invite a New User
         ...
         You can invite a user who is not registered with Razorpay to join your team. Such users are sent an invitation link via email.
