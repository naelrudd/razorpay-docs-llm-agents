...
- [Configure Payment Capture Settings](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md)
...
- [Manage Local Saved Tokens](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/features/saved-cards.md).
...
### To manage fee bearer model:
       ...
       Know more about the [Convenience Fee Model](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/configuration/convenience-fees.md).
      

## Enable International Payments

By default, you can accept payments in various [international currencies supported by Razorpay](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies).
...
Settlement emails will be sent to the email addresses provided on the Dashboard. Know more about [Settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements.md).
...
This feature is available only to the owner user role. Know about the various [user roles](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md).
