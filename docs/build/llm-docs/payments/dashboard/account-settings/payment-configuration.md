...
- You can hide, show, create custom blocks and rearrange payment methods and instruments as required, but you cannot enable or disable them from this setting. Know more about how to [enable/disable payment methods](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/payment-methods.md#enable-payment-methods).
