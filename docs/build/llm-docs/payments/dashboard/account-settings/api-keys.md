...
- If you have not shared your website yet, please [follow the steps to add your website details](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/business-website-details.md). We will verify your website within 3 working days. Once the verification is complete, you can generate API keys in **Live Mode**.
...
### 7. Who has access to the API Keys?
         ...
         Only users with the **Owner** or **Admin** role have access to the API keys. Know more about [standard user roles & permissions](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#standard-user-roles).
...
### 3. I am unable to access case_key while integrating with Shopify. How can I access the `case_key`?
...
- [API Keys FAQ](https://razorpay.com/docs/build/llm-docs/payments/dashboard/faqs.md#2-i-cannot-generate-live-mode-api-keys)
