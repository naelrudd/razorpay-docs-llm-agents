...
- You can also accept [international payments](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#get-started).
...
The **Additional details required** tab must be updated to request any payment method.
         ...
         4. Fill in the business website/app details and click **Proceed to update website/app**. Know more about [how to add website details](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/business-website-details.md).
         5. Fill in the GSTIN details and click **Submit**. Know more about [how to add GSTIN details](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/gst-details.md).
...
Raise a request with our [Support team](https://razorpay.com/support/) to disable any Payment Method.
