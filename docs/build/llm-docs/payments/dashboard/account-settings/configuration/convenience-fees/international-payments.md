...
Refer to the [list of currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies) that support the Convenience Fee model.
...
- [Convenience Fee Model](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/configuration/convenience-fees.md)
