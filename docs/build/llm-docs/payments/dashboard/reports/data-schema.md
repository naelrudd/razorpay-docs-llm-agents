...
---
Adjustment ID | String | Unique identifier for the adjustment. | No
---
Payment ID | String | Unique identifier for the payment on which dispute was raised. | No
---
Order ID | String | The ID of the order associated with this payment. | No
---
Amount | Integer | The total amount of the payment. | No
---
Currency | String | The currency in which the payment was made. | No
---
Amount Deducted | Integer | Total amount deducted. | No
---
Amount Reversed | Integer | Total amount reversed after the dispute was raised. | No
---
Reason Code | String | A detailed description of the reason for the dispute. | No
---
Dispute Created At | Date/Time | Timestamp when the dispute record was created. | No
---
Resolved At | Date/Time | Timestamp when the dispute record was resolved. | Yes
...
Column Name | Type | Description | Is Nullable?
---
Merchant ID | String | Unique identifier of the merchant | No
---
Settlements ID | String | Unique identifier of the settlement associated with the transaction | No
---
Transaction ID | String | Unique identifier of the transaction | No
---
Type | String | The type of transaction carried out. For example, `payment`, `refund`. | No
---
Order ID | String | Unique identifier for the order. | No
---
Transaction Date | Date/Time | Timestamp when the transaction record was made. | No
---
Transaction Currency | String | The currency in which the transaction was made. | No
---
Gross Transaction Amount | Integer | The total amount of the transaction inclusive of the tax component. | No
---
MDR | Integer | Fee charged by Razorpay for each debit or credit transaction made. | No
---
Tax | Integer | The tax amount applied to the transaction. | No
---
Net Transaction Amount | Integer | The actual amount transacted, excluding taxes and fees. | No
---
Net Debit | Integer | The amount debited from the account as part of the transaction. | No
---
Net Credit | Integer | The amount credited to the account as part of the transaction. | No
---
MTS Reference Number | String | Unique identifier generated by the payment gateway or processing system. | No
---
Offshore Remittance Date | Date/Time | Timestamp when the amount was credited to the receiver's account. | No
---
Total Offshore | Integer | Total amount of transaction made for a particular MTS Reference Number (in the foreign currency). | No
---
Remittance Currency | String | Currency used for the offshore transaction. For example, `USD`. | No
---
Total Amount | Integer | Total amount of transaction made for a particular MTS Reference Number (in the local currency). | No
---
Domestic Currency | String | Domestic currency used for the transaction. For example, `INR`. | No
---
Notes | String | Additional notes or comments related to the offshore remittance. | Yes
