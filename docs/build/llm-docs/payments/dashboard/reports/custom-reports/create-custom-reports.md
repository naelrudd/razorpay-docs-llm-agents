...
To find details about the available list of fields, columns and fields go through the [**Custom Reports Data Schema documentation**](https://razorpay.com/docs/build/llm-docs/payments/dashboard/reports/data-schema.md).
