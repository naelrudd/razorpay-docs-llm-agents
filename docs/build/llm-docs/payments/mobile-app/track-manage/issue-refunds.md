...
- This feature is available only on Netbanking, UPI and select debit and credit cards. [Check the complete list of payment methods.](https://razorpay.com/docs/build/llm-docs/payments/refunds/instant.md#payment-methods)
