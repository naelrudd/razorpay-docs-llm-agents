...
1. We create the Razorpay.me URL for you instantly after account activation. For example, if your business name is Acme Co, your URL will be `razorpay.me/acmeco`. Know how to [edit your Razorpay.me URL.](https://razorpay.com/docs/build/llm-docs/payments/mobile-app/accept-payments/razorpay-me/manage.md)
...
5. You can [check the payment status on the Razorpay  Mobile App.](https://razorpay.com/docs/build/llm-docs/payments/mobile-app/track-manage.md)

### Related Information

- [Manage Razorpay.me URL](https://razorpay.com/docs/build/llm-docs/payments/mobile-app/accept-payments/razorpay-me/manage.md)
- [FAQs](https://razorpay.com/docs/build/llm-docs/payments/mobile-app/faqs.md#razorpay-me)
