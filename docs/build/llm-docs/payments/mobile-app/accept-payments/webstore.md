...
6. You can also configure Facebook Pixel and Google Analytics for your Webstore for metrics. Know more about how to add [Facebook Pixel and Google Analytics](https://razorpay.com/docs/build/llm-docs/payments/payment-pages/plugins-add-ons.md) to your Webstore.
7. Click **Save**.
...
- [Webstore](https://razorpay.com/docs/build/llm-docs/payments/webstore.md)
