...
### 1.4 Initialise Razorpay iOS Standard SDK
     ...
     - API keys. You can generate this from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md#generate-api-keys).
...
Know more about [UPI Intent and its benefits](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/upi-intent.md).
...
[iOS Standard Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard.md)
