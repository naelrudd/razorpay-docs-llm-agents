...
- This feature is available only if you use [Shopify](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/shopify.md) or [WooCommerce](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/woocommerce.md) (v4.3.5 and above) plugin.
...
The **Enable conversion for** field will appear if you enable the [Manually review COD orders](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/order-settings/review-cod-orders.md) feature. The COD conversion will be based on the type of RTO risk.
...
If you are a WooCommerce user and have not opted for the [Manually review COD orders](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/order-settings/review-cod-orders.md) feature, you must provide your **WooCommerce API credentials** to enable us to send the conversion links to your customers.
