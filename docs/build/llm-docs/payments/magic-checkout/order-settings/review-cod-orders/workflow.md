...
You can access the **COD Orders Review Workflow** feature only if you opt for [manual review of COD orders](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/order-settings/review-cod-orders.md).
...
This feature is available for your Custom ecommerce platform, [WooCommerce website](https://razorpay.com/docs/build/llm-docs/payments/payment-pages.md) and [Shopify store](https://razorpay.com/docs/build/llm-docs/payments/payment-pages.md).
