...
This page is a technical reference for all Magic Checkout analytics events. For setup instructions, see the [Magic Checkout Analytics Integration](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/web/analytics-integration.md) guide.
