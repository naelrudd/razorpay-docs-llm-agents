...
### Logged In
         ...
         Customers who already are logged in have 2 ways to proceed with checkout:
                ...
                This results in a faster, more efficient checkout experience that boosts conversion rates and enhances satisfaction for both customers and businesses. Know more about [Quickbuy](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/features/quickbuy.md).
