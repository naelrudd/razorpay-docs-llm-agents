...
- Generate [API Keys](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings.md#api-keys) from the Dashboard. To go live with the integration and start accepting real payments, generate Live Mode API Keys and replace them in the integration.
...
### 1.4 Initialise Razorpay Android Standard SDK
     ...
     Use the `setKeyId()` method of the Checkout class to dynamically add your API key id. You can generate your API keys from the [Razorpay Dashboard](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md#generate-api-keys).
...
: `string` The currency in which the transaction should be made. See the [list of supported currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies). Default is `INR`. Length must be of 3 characters.
...
### 1.8 Initiate Payment and Display Checkout Form
     ...
     Create an instance of the `Checkout` and pass the payment details and options as a `JSONObject`. Ensure that you add the `order_id` generated in [Step 5](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/android-integration.md#15-create-an-order).
...
If no API call is made within 45 seconds, our background job will assume there is a network drop off and will proceed to place the order on Shopify automatically.
        ...
        Fetch an Order
         ...
         Know more about the [Orders API.](https://razorpay.com/docs/build/llm-docs/api/orders.md)
...
### Fetch a Payment
         ...
         Know more about the [Payments API](https://razorpay.com/docs/build/llm-docs/api/payments.md).
...
### Supported Payment Methods
        ...
        ---
        [Cash on Delivery](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cod.md)  | `cod` | Requires [Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cod.md#prerequisites).
        ---
        ...
        Check the following lists: 
            - [Supported UPI Flows](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi.md).
...
You can use **Test Mode** to test UPI payments, and **Live Mode** for UPI Intent and QR payments.
        ...
        Check the following lists: 
            ...
            - [Test Error Scenarios](https://razorpay.com/docs/build/llm-docs/payments/payments/test-card-details.md#error-scenario-test-cards).
...
[Android Standard Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard.md)
