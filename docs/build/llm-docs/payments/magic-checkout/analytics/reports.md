...
You can also schedule reports to receive them automatically at regular intervals. This ensures you get timely data for consistent decision-making without manual downloads. Know more about how to [schedule reports](https://razorpay.com/docs/build/llm-docs/payments/dashboard/reports.md#schedule-reports).
...
### Order Reports
         ...
         ---
         `order_status` | Status of the order. Know more about [Order Status](https://razorpay.com/docs/build/llm-docs/payments/orders.md#order-states).
         ---
         `payment_method` | Code of the payment method used. Know more about [Razorpay Payment Methods](https://razorpay.com/docs/build/llm-docs/payments/payment-methods.md).
         ---
         `payment_amount` | Amount paid through the payment method in smallest currency unit.
         ---
         `payment_status` | Status of payment. Know more about [Payment Status](https://razorpay.com/docs/build/llm-docs/payments/payments.md#payment-life-cycle).
         ---
