...
The following widgets are available in the **RTO Insights** tab of the [RTO Analytics Dashboard](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/analytics/rto.md). Check which widgets are applicable when you opt either for: 
- COD Intelligence.
