...
- Log in to the Dashboard and [generate the API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) in Live mode.
...
### Related Information
- [Money Back Promise](https://razorpay.com/docs/build/llm-docs/payments/widgets/buyer-protection/money-back-promise.md)
- [FAQs](https://razorpay.com/docs/build/llm-docs/payments/widgets/buyer-protection/faqs.md)
