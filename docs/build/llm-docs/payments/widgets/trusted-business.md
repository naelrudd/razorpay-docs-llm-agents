...
- Generate the API Keys on the Dashboard. You can use the  [Test Mode keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) to test the integration and preview the Widget. Later, switch to **Live Mode** on the Dashboard, generate the [Live API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) and replace it with the test keys.
- Check if you are [eligible](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/features/trusted-business.md#eligibility-requirements) for Razorpay Trusted Business on the Dashboard. 
...
- Currently, the RTB widget is supported on Web and [shopify](https://razorpay.com/docs/build/llm-docs/payments/widgets/trusted-business/rtb-widget-shopify.md).
...
After you preview and test the widget on your Dashboard, switch to the live mode to generate live API keys. Replace the test keys with these live keys to take the integration live. Know more about [live API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys).
