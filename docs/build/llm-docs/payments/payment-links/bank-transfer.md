...
1. Create a Payment Link and send them to your customers using 
    [API,](https://razorpay.com/docs/build/llm-docs/api/payments/payment-links.md)[Dashboard](https://razorpay.com/docs/build/llm-docs/payments/payment-links/create.md) or [Bulk Upload feature](https://razorpay.com/docs/build/llm-docs/payments/payment-links/batch.md).
1. Each Payment Link will have a designated Customer Identifier. This Customer Identifier has an account number and IFSC associated with it. Know more about [Customer Identifiers](https://razorpay.com/docs/build/llm-docs/payments/smart-collect.md).
...
- [Bank Transfer FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-links/faqs.md#bank-transfer)

- [Bank Transfer as a Payment Method](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bank-transfer.md)

- [About Customer Identifiers](https://razorpay.com/docs/build/llm-docs/payments/smart-collect.md)
