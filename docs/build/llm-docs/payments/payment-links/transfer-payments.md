...
Check the [transfer payments received using Payment Links API](https://razorpay.com/docs/build/llm-docs/api/payments/payment-links/transfer-payments.md).
...
Use the [API](https://razorpay.com/docs/build/llm-docs/api/payments/payment-links/transfer-payments.md) to transfer payments received using Payment Links.
