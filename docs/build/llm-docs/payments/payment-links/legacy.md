...
- [Partial Payments](https://razorpay.com/docs/build/llm-docs/payments/payment-links/partial-payments.md)
- [International Currency Support](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md)
- [Bulk Upload](https://razorpay.com/docs/build/llm-docs/payments/payment-links/batch.md)
- [Reminders](https://razorpay.com/docs/build/llm-docs/payments/payment-links/reminders.md)
- [Customization](https://razorpay.com/docs/build/llm-docs/payments/payment-links/customise.md)
- [Offers](https://razorpay.com/docs/build/llm-docs/payments/payment-links/offers.md)
- [Bank Transfers](https://razorpay.com/docs/build/llm-docs/payments/payment-links/bank-transfer.md)
...
You can perform Payment Links operations via [APIs](https://razorpay.com/docs/build/llm-docs/api/payments/payment-links.md) or the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/payment-links/create.md).

## Webhooks

The table below lists the various webhooks available for legacy version of the app. Sample payloads are available [here](https://razorpay.com/docs/build/llm-docs/webhooks/invoices.md).
