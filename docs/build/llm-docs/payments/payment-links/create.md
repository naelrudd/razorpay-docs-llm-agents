...
### To create a Standard Payment Link:
         ...
         4. Enter the required details in the Standard Payment Link pop-up page.
            ...
            - **Amount** (Mandatory): Select the currency and amount for the Payment Link. For example, select `₹` and enter`1000` for ₹1,000. You can also accept payments in [international currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies).
...
- [Create a Standard Payment Link API](https://razorpay.com/docs/build/llm-docs/api/payments/payment-links/create-standard.md)
- [Create a UPI Payment Link API](https://razorpay.com/docs/build/llm-docs/api/payments/payment-links/create-upi.md)
