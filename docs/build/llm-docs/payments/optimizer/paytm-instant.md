...
If you want to offer all payment methods and support refunds from the Dashboard, please use the [S2S integration mode](https://razorpay.com/docs/build/llm-docs/payments/optimizer/paytm-s2s.md).
...
You might be generating a unique Order id or Receipt for every order which can be passed to Paytm via [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md#orders-api). 
