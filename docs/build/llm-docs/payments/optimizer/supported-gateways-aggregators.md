...
### EMI
        ...
        ---
        [PayU](https://razorpay.com/docs/build/llm-docs/payments/optimizer/supported-gateways-aggregators.md#payu-emi) | Live
        ---
        [Billdesk](https://razorpay.com/docs/build/llm-docs/payments/optimizer/supported-gateways-aggregators.md#billdesk-and-ingenico-emi) | Live
        ---
        [Ingenico](https://razorpay.com/docs/build/llm-docs/payments/optimizer/supported-gateways-aggregators.md#billdesk-and-ingenico-emi) | Live
...
### Billdesk and Ingenico EMI
                ...
                Follow the steps given below to enable Billdesk and Ingenico EMI on Optimizer:
                 1. Add EMI as a payment method on the Dashboard. Know more about [how to request for a payment method](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/payment-methods.md#request-for-payment-methods).
                 2. Enable [Optimizer](https://razorpay.com/docs/build/llm-docs/payments/optimizer/get-started.md) for your account.
                 3. [Add Billdesk or Ingenico as a payment method](https://razorpay.com/docs/build/llm-docs/payments/optimizer/billdesk.md).
                 4. Route transactions via Billdesk or Ingenico. Know [how to route transactions](https://razorpay.com/docs/build/llm-docs/payments/optimizer/create-custom-rule.md#steps).
...
### Cardless EMI
    ...
    List of supported cardless EMIs on Optimizer is given below:
        ...
        S No. | Provider
        ---
        1 | [ShopSe](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/cardless-emi/shopse.md)
        ---
        2 | [Snapmint](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/cardless-emi/snapmint.md)
...
### Meal Cards
    ...
    List of supported meal cards on Optimizer is given below:
        ...
        S No. | Provider
        ---
        1 | [Sodexo](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/sodexo.md)
...
### Pay Later
    ...
    List of supported aggregators for Pay Later on Optimizer is given below:
        ...
        S No. | Provider
        ---
        1 | [Simpl](https://razorpay.com/docs/build/llm-docs/payments/optimizer/simpl.md)
...
### Razorpay
         ...
         List of supported wallets for Razorpay is given below:
            ...
            ---
            8 | [PhonePe Switch](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom/phonepe-switch.md) | **For businesses that are registered with PhonePe Switch Only**. 
            ---
            9 | [PayPal](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/wallets/paypal.md) | **International Payments Only**.
 [Contact Support](https://razorpay.com/support). 
            ---
            10 | [Amazon Pay](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/wallets/amazon-pay.md)| [Contact Support](https://razorpay.com/support).
...
- [Single Reconciliation View](https://razorpay.com/docs/build/llm-docs/payments/optimizer/reconciliation.md)
