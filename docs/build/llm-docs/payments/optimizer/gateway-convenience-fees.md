...
All Optimizer gateways support the Customer Fee Bearer feature. Know more about the [gateways supported by Optimizer](https://razorpay.com/docs/build/llm-docs/payments/optimizer/supported-gateways-aggregators.md).
...
- [Collect Standard Convenience Fee](https://razorpay.com/docs/build/llm-docs/payments/optimizer/convenience-fees.md)
