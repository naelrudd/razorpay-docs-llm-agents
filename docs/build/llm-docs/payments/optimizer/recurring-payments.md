...
---
PayU | - [Emandate (Live)](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/emandate/integrate.md)
- [Cards (Live)](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/cards/integrate.md)
- [UPI Autopay (Live)](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/upi/create-authorization-transaction.md)

---
Razorpay | - [Emandate (Live)](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/emandate/integrate.md)
- [Cards (Live)](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/cards/integrate.md)
- [UPI Autopay (Live)](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/upi/create-authorization-transaction.md)
...
2. You should have an [active Razorpay account](https://razorpay.com/docs/build/llm-docs/payments/set-up.md) with [Optimizer](https://razorpay.com/docs/build/llm-docs/payments/optimizer.md) enabled.
...
### Step1: Add PayU as a Payment Provider
         ...
         Know how to [add PayU as a payment provider](https://razorpay.com/docs/build/llm-docs/payments/optimizer/payu.md#add-payu-as-a-payment-provider).
