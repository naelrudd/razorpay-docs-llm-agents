...
1. You need to have an [active Razorpay account](https://razorpay.com/docs/build/llm-docs/payments/set-up.md) with [Optimizer](https://razorpay.com/docs/build/llm-docs/payments/optimizer.md) enabled.
2. [Generate API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) required to authenticate API requests sent to Razorpay servers.
3. Follow [the integration steps](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation.md#integration-flow) to let Razorpay map the customers' bank accounts to ensure the payment is processed only from their registered bank accounts.
...
- [Third Party Validation on Razorpay Standard Integration](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation.md)
- [Best Practices](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation/best-practices.md)
