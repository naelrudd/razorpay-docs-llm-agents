...
Cashfree supports [Third-Party Validation (TPV)](https://razorpay.com/docs/build/llm-docs/payments/optimizer/third-party-validation.md#supported-bank-gateways-payment-gateways-and-payment-methods).
...
You might be generating a unique Order ID or Receipt for every order which can be passed to Cashfree via [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md#orders-api). 
