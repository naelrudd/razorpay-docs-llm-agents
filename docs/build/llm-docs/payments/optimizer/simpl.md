...
### Configure PayLater (Simpl) as a payment method
         ...
         3. Look for **Simpl** and click **Request**. Know more about [how to request for a payment method](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/payment-methods.md#request-for-payment-methods).
