...
You might be generating a unique Order ID or Receipt for every order which can be passed to PineLabs via [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md#orders-api).
