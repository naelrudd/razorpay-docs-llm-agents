...
### Route EMI Transactions
            ...
            5. Click **Add Another Condition** and enter the following rule:
                ...
                - **Select Connection**: Select **Equal to**.
                - **Select Comparing Value**: Select **the EMI Duration** as per your requirement, and click **Next**. Know more about [EMI durations](https://razorpay.com/docs/build/llm-docs/payments/optimizer/supported-gateways-aggregators.md#emi) for PayU EMI.
...
Given below is the list of card networks and payment gateways that support the CVV-less feature on Optimizer.
        ...
        8 | Emandate | Live
        ---
        9 | [Sodexo](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/sodexo.md) | Live
        ...
        S No. | Payment Methods | Availability
        ---
        1 | [Emandate](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/emandate/integrate.md) | Live
        ---
        2 | [Cards](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/cards/integrate.md) | Live
        ---
        3 | UPI Autopay | Live
...
PayU supports [Third-Party Validation (TPV)](https://razorpay.com/docs/build/llm-docs/payments/optimizer/third-party-validation.md#supported-bank-gateways-payment-gateways-and-payment-methods).
...
You might be generating a unique Order ID or Receipt for every order which can be passed to PayU via [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md#orders-api). Follow the steps given below for your order id to be visible on the PayU Dashboard:
