...
- The Dashboard has [test and live modes](https://razorpay.com/docs/build/llm-docs/payments/dashboard/test-live-modes.md). Use the test mode for a sandbox experience. You can switch to live mode when you are ready to accept payments. You will have to create a new Webstore in live mode.
...
5. You can also configure Facebook Pixel and Google Analytics for your Webstore for metrics. Know more about how to add [Facebook Pixel and Google Analytics](https://razorpay.com/docs/build/llm-docs/payments/webstore/plugins-add-ons.md) to your Webstore.
6. Click **Save**.
