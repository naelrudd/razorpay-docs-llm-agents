...
- [Subscribe to Webhook Events](https://razorpay.com/docs/build/llm-docs/payments/disputes/subscribe-to-webhooks.md)
...
- View all the disputes raised by your customer using [Fetch All Disputes API](https://razorpay.com/docs/build/llm-docs/api/disputes/fetch-all.md)
- View the details of a dispute by providing the dispute id using [Fetch a Dispute API](https://razorpay.com/docs/build/llm-docs/api/disputes/fetch.md)
...
Accept a dispute using the [Accept a Dispute API](https://razorpay.com/docs/build/llm-docs/api/disputes/accept.md).
...
- Contest a dispute using [Contest a Dispute API](https://razorpay.com/docs/build/llm-docs/api/disputes/contest.md)
- Upload supporting documents using [Documents API](https://razorpay.com/docs/build/llm-docs/api/documents.md)
...
- [About Disputes](https://razorpay.com/docs/build/llm-docs/payments/disputes.md)
