...
Know more about [Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md) and check the [sample payloads.](https://razorpay.com/docs/build/llm-docs/webhooks/disputes.md)

### Related Information
- [About Disputes](https://razorpay.com/docs/build/llm-docs/payments/disputes.md)
- [Disputes APIs](https://razorpay.com/docs/build/llm-docs/payments/disputes/apis.md)
