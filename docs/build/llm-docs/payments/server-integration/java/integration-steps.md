...
You can capture payments automatically with one-time [Payment Capture setting configuration](https://razorpay.com/docs/build/llm-docs/payments/server-integration/java/integration-steps.md#3-go-live-checklist) on the Dashboard.
...
Test your integration using these [test cards](https://razorpay.com/docs/build/llm-docs/payments/server-integration/java/integration-steps.md#2-test-integration).
...
Razorpay offers a range of [payment products](https://razorpay.com/docs/build/llm-docs/payments.md) to meet your business requirements. Visit our  [GitHub repository](https://github.com/razorpay/razorpay-java) for sample codes.
