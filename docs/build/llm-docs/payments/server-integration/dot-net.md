...
You must use .NET v4.5 or higher with TLS version 1.2. Using it with a lower .NET version will lead to [errors](https://razorpay.com/docs/build/llm-docs/payments/server-integration/dot-net/troubleshooting-faqs.md). Know more about the [latest .NET versions](https://versionsof.net/framework/).
