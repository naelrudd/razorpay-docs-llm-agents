...
You can capture payments automatically with one-time [Payment Capture setting configuration](https://razorpay.com/docs/build/llm-docs/payments/server-integration/php/integration-steps.md#3-go-live-checklist) on the Dashboard.
...
1. Edit the `[KEY_ID]` inside the html file. Use the test keys while testing your application.  Know how to [Generate API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).  
2. Edit the `[KEY_ID]` and `[KEY_SECRET]` in **config.php**. 

- Test your integration using these [test cards](https://razorpay.com/docs/build/llm-docs/payments/server-integration/php/integration-steps.md#2-test-integration).
...
Razorpay offers a range of [payment products](https://razorpay.com/docs/build/llm-docs/payments.md) to meet your business requirements. Visit our [GitHub repository](https://github.com/razorpay/razorpay-php) for sample codes.
...
[Troubleshooting and FAQs](https://razorpay.com/docs/build/llm-docs/payments/server-integration/php/troubleshooting-faqs.md)
