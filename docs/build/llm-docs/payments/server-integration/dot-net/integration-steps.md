...
You can capture payments automatically with one-time [Payment Capture setting configuration](https://razorpay.com/docs/build/llm-docs/payments/server-integration/dot-net/integration-steps.md#3-go-live-checklist) on the Dashboard.
...
1. Edit the [KEY_ID] inside **Payment.aspx**. Use the test keys while testing your application.  Know how to [Generate API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).  
...
```
- Test your integration using these [test cards](https://razorpay.com/docs/build/llm-docs/payments/server-integration/dot-net/integration-steps.md#2-test-integration).
...
[Troubleshooting and FAQs](https://razorpay.com/docs/build/llm-docs/payments/server-integration/dot-net/troubleshooting-faqs.md)
