...
You can capture payments automatically with one-time [Payment Capture setting configuration](https://razorpay.com/docs/build/llm-docs/payments/server-integration/go/integration-steps.md#3-go-live-checklist) on the Dashboard.
...
Test your integration using these [test cards](https://razorpay.com/docs/build/llm-docs/payments/server-integration/go/integration-steps.md#2-test-integration).
