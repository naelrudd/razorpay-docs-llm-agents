...
### Razorpay supports the following business types:
         ...
         ---
         Trust | A trust is a [fiduciary relationship](https://razorpay.com/docs/build/llm-docs/payments/glossary.md#fiduciary-relationship) in which a [trustor](https://razorpay.com/docs/build/llm-docs/payments/glossary.md#trustor) gives the [trustee](https://razorpay.com/docs/build/llm-docs/payments/glossary.md#trustee) the right to hold title to property or assets for the benefit of a third party, the [beneficiary](https://razorpay.com/docs/build/llm-docs/payments/glossary.md#beneficiary). Trusts are established to provide legal protection for the trustor’s assets. | A beneficiary may transfer property to a trustee and grant them the right to manage it.
         ---
...
The PAN Card details and [authorised signatory](https://razorpay.com/docs/build/llm-docs/payments/glossary.md#authorised-signatory) address proof, that is, Aadhar Card and Passport should be of the same person.
...
- Government-approved [authorised signatory](https://razorpay.com/docs/build/llm-docs/payments/glossary.md#authorised-signatory) address proof (like Aadhar Card/Voter id/Passport) 
...
- `Mandatory` IFSC Code
 If bank verification fails, a video of a cancelled cheque must be provided.
         ---
         Proof of Identity of Business Owners and Authorised Signatory | - Government-approved [authorised signatory](https://razorpay.com/docs/build/llm-docs/payments/glossary.md#authorised-signatory) identity proof (like Aadhar Card/Voter id/Passport)
...
- [Submit KYC details](https://razorpay.com/docs/build/llm-docs/payments/set-up.md#2-submit-kyc-details)
