...
- `false` (default): QR Code will accept any amount.
        ...
        **API Reference Links**
        - BharatQR: [Create a virtual account](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bharatqr/api.md#create)
        - QR Code: [Create a QR Code](https://razorpay.com/docs/build/llm-docs/api/qr-codes.md#create-a-qr-code)
        ...
        **API Reference Links**
        - BharatQR: [Close a virtual account](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bharatqr/api.md#close)
        - QR Code: [Close a QR Code](https://razorpay.com/docs/build/llm-docs/api/qr-codes/close.md)
        ...
        **API Reference Links**
        - BharatQR: [Fetch all virtual accounts](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bharatqr/api.md#fetch-all-payments)
        - QR Code: [Fetch all QR Codes](https://razorpay.com/docs/build/llm-docs/api/qr-codes/fetch-all.md)
        ...
        **API Reference Links**
        - BharatQR: [Fetch a virtual account](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bharatqr/api.md#fetch-a-payment)
        - QR Code: [Fetch a QR Code](https://razorpay.com/docs/build/llm-docs/api/qr-codes/fetch-with-id.md)
        ...
        **API Reference Links**
        - BharatQR: [Fetch payments by id](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bharatqr/api.md#fetch-a-payment)
        - QR Code: [Fetch payments made to a QR Code](https://razorpay.com/docs/build/llm-docs/api/qr-codes/fetch-payments.md)
...
---
QR Code created | [virtual_account.created](https://razorpay.com/docs/build/llm-docs/webhooks/smart-collect.md#virtual-account-created) | [qr_code.created](https://razorpay.com/docs/build/llm-docs/payments/qr-codes/subscribe-to-webhooks.md#qr-code-created)
---
QR Code credited | [virtual_account.credited](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bharatqr/notification.md#webhooks) | [qr_code.credited](https://razorpay.com/docs/build/llm-docs/payments/qr-codes/subscribe-to-webhooks.md#qr-code-credited)
---
QR Code closed | [virtual_account.closed](https://razorpay.com/docs/build/llm-docs/webhooks/smart-collect.md#virtual-account-closed) | [qr_code.closed](https://razorpay.com/docs/build/llm-docs/payments/qr-codes/subscribe-to-webhooks.md#qr-code-closed)
