...
You can search for QR Codes on the Dashboard by specifying various filters. Know more about [QR Code States](https://razorpay.com/docs/build/llm-docs/payments/qr-codes.md#qr-code-states/).
...
---
Payment Status | The status of the payment. Know more about [payment states](https://razorpay.com/docs/build/llm-docs/payments/payments.md).
---
...
- [Cancel a QR Code](https://razorpay.com/docs/build/llm-docs/payments/qr-codes/close.md)
