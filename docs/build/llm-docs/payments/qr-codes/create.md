...
Know more about [customers](https://razorpay.com/docs/build/llm-docs/payments/customers.md).

### Add a Custom Brand Name to Your QR Codes

You can increase your brand outreach using QR Codes by customising your brand name. Customers who scan the QR Code will see your custom Business Name after they make the payment. Know more about how you can add a [brand name and logo](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/checkout-styling.md#brand-name-and-logo) from the Dashboard.
...
3. The payment details appear in the right pane. You can perform the following operations from this tab:
    1. **Create Transfer**: Transfer the payment to a linked account. Know more about [Route](https://razorpay.com/docs/build/llm-docs/payments/route.md).
    2. **Create Refund**: Refund the payment to the customer. Know more about [Refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds.md).
     

## What Next
Once you have created the QR Code, you can share the short URL with the customer. You can also print or download it and send the image. You can also choose to [close the QR Code](https://razorpay.com/docs/build/llm-docs/payments/qr-codes/close.md).
...
### Related information
- [QR Code](https://razorpay.com/docs/build/llm-docs/payments/qr-codes.md)
