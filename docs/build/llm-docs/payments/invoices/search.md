...
You can search for invoices (except those marked **Deleted**) on the Dashboard by specifying various filters. Know more about [invoice states](https://razorpay.com/docs/build/llm-docs/payments/invoices/states.md).
