...
1. Click on **Invoices**.
1. Search for the invoice for which you want to create a duplicate copy using the [search criteria](https://razorpay.com/docs/build/llm-docs/payments/invoices/search.md).
