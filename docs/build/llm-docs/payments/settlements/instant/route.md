...
### Use Cases and Examples
         ...
         Suppose you are Acme Corp, a Loan Service Provider (LSP) who sources customers via your product for multiple NBFCs. 
            ...
            With instant settlements, you can [create a Linked Account](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md#add-and-manage-linked-accounts) on Route, initiate a transfer and settle the payments to them instantly.
...
- You have an [existing/created Linked Account](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md#add-and-manage-linked-accounts) on Route.
...
- The [transfer](https://razorpay.com/docs/build/llm-docs/payments/route/faqs.md#1-how-can-i-transfer-money-to-customers) amount exceeds 5 lakhs.
...
- [Orders](https://razorpay.com/docs/build/llm-docs/payments/route/transfer-funds-to-linked-accounts.md#transfer-via-orders).
- [Payments](https://razorpay.com/docs/build/llm-docs/payments/route/transfer-funds-to-linked-accounts.md#transfers-via-payments).
- [Create Transfers from Orders API](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-transfers-orders.md).
- [Create Transfers from Payments API](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-transfers-payments.md).
