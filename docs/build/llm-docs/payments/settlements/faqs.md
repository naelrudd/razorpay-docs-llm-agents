...
### 1. What are settlements?
         ...
         Settlement is the process in which the money received from your customers is settled to your bank account. Settlements for all payments will be done in INR (Indian Rupees), irrespective of the currency in which the payment was made by the customer. Settlement cycle is subject to bank approval and can vary based on your business vertical, risk factor, and so on. Each settlement generated has a unique settlement id attached to it along with the amount settled. Know more about [Settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements.md).
        

    
### 2. What is the settlement cycle you offer?

         Our standard settlement cycle is T+2 working days, T being the date of transaction capture. This means that the captured payments are settled within 2 working days from the date of capture. This applies to domestic payments. International payments follow a longer settlement cycle of T+7 working days. For details, see FAQ 9.
         
**INFO**

**Handy Tips**

Working days do not include second and fourth Saturdays, Sundays and bank holidays. For details on how holidays affect your settlement date, see FAQ 7.
...
### 5. How to reconcile settlements along with the transactions made?
         ...
         You can [download a daily or a monthly report](https://razorpay.com/docs/build/llm-docs/payments/dashboard/reports.md#generate-reports) for the **Settlement Reconciliation Report** from the **Reports** section on the Dashboard. The report contains transactions and the corresponding settlement ids.
...
### 6. Why are my settlements blocked?
         ...
         Razorpay sends emails regarding blocked or failed settlements to your registered email address. Please revert to the email with the necessary details. If you have not received any email from Razorpay, please contact our [Support Team](https://razorpay.com/support/#request) for assistance. If your settlements are paused due to a bank holiday or weekend, see FAQ 7.
        

    
### 7. Are settlements processed on weekends and bank holidays?

         No. Settlements to your bank account are processed only on **bank working days**. They are not processed on Sundays, the second and fourth Saturdays, and public or bank holidays, and are credited on the next working day.

         **Why does this happen even when UPI, IMPS, NEFT and RTGS operate 24x7?**

         Although consumer payment rails operate round-the-clock, settlements to businesses depend on the **inter-bank settlement and fund-flow process** between the issuing banks, Razorpay's nodal/escrow account, and your bank. This process follows the banking calendar and RBI fund-flow norms, which do not operate on bank holidays. As a result, the standard settlement cycle is paused on those days.

         If your business requires funds on a holiday or weekend, you can use [Instant Settlements or Smart Settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements/instant.md) to settle your available balance 24x7, including holidays, for a small fee.
        

    
### 8. My settlement is delayed over a long weekend or consecutive holidays — is this normal?

         Yes. The T+2 cycle counts only working days. When holidays fall back-to-back (for example, a Saturday–Sunday–public-holiday stretch), the credit date moves to the next available working day, which can compound into a multi-day delay. You can check the expected credit date against the settlement schedule on your Dashboard, or settle immediately via [Instant Settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements/instant.md).
        

    
### 9. How is the settlement cycle different for international payments?

         International payments follow a longer settlement cycle than domestic payments. While domestic payments are settled on a **T+2 working day** cycle, the standard cycle for international payments is **T+7 working days**, where **T** is the date the payment is captured. The exact cycle is subject to applicable laws and is shown on your Razorpay Dashboard.

         As with domestic settlements, international settlements are processed only on bank working days. If the settlement date falls on a weekend or bank holiday, the credit moves to the next working day. International payments are settled in INR (Indian Rupees), irrespective of the currency in which the payment was made, using the exchange rate at the time of payment creation. Know more about [International Settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements.md#international-settlements).
...
### 4. How to reconcile settlements along with the transactions made?
         ...
         You can [download a daily or a monthly report](https://razorpay.com/docs/build/llm-docs/payments/dashboard/reports.md#generate-reports) for the **Settlement Reconciliation Report** from the **Reports** section on the Razorpay  Dashboard. The report contains transactions and the corresponding settlement ids.
...
### 3. How is the fees and tax for an Instant Settlement deducted?
         ...
         For example, you place a request for 2000. Fees of 3 and tax of 1 is deducted from the requested amount and the remaining amount, 1995 is settled to your bank account.
...
### 8. How do I enable instant settlements?
         ...
         Instant settlements is an on-demand feature. [Raise a request](https://razorpay.com/support/#request) with our support team to get this feature activated on your account. Know more about [initiating instant settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements/instant.md#initiate-instant-settlements).
...
### 3. Is it mandatory to use Smart Settlements if the amount is > 5 L?
         ...
         Find out more about [Instant Vs Smart Settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements/instant.md#instant-vs-smart-settlements)
