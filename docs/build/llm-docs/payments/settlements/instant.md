...
Settle amounts **up to ₹5 Crores** through **Instant Settlement** feature via Dashboard and API: 
        ...
        5. Click **Settle Now** to settle instantly.
            ...
            Create and retrieve Instant Settlements requests using APIs. Refer to the [list of Instant Settlements APIs](https://razorpay.com/docs/build/llm-docs/payments/settlements/apis.md#list-of-settlements-api).
