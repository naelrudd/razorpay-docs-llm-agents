...
You can view settlement details using the [Settlements API](https://razorpay.com/docs/build/llm-docs/api/settlements.md).
...
- [Settlements API](https://razorpay.com/docs/build/llm-docs/payments/settlements/apis.md)
