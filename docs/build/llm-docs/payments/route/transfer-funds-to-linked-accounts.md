...
2. Provide [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md) access to the Linked Account to ensure transparency between the two parties, such as:
...
This eliminates the extra step of triggering the [Direct Transfers](https://razorpay.com/docs/build/llm-docs/api/payments/route/direct-transfers.md) or [Transfers via Payments API](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-transfers-payments.md).
...
1. Create an Order using the [Transfer via Orders API](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-transfers-orders.md).
2. [Capture the Payment](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/how-it-works.md#capture-payments).
3. Set up the [webhook event `transfer.processed`](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md).
...
You can initiate a transfer from a payment received from a customer. This can be done from the Dashboard or using the [Create Transfers from Payments API](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-transfers-payments.md).
...
You can transfer funds to your Linked Accounts directly from your account balance using Direct Transfers. You can make direct transfers from the Dashboard or using the [Direct Transfer API](https://razorpay.com/docs/build/llm-docs/api/payments/route/direct-transfers.md).
...
### Related Information
- [Transfers and Related Fees](https://razorpay.com/docs/build/llm-docs/payments/route/transfer-fees-example.md)
- [Schedule Settlements](https://razorpay.com/docs/build/llm-docs/payments/route/schedule-settlement.md)
- [Payment Reversals](https://razorpay.com/docs/build/llm-docs/payments/route/reversal.md)
- [Refund to Customers](https://razorpay.com/docs/build/llm-docs/payments/route/refund.md)
