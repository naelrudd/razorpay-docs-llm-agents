...
### 1.3 Enable Webhooks on the Dashboard
            ...
            [Enable Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md#set-up-webhooks) to receive notifications for these events.
...
###  1.6 Verify Payment Status
                ...
                1. Log in to the **WordPress Admin Dashboard** and navigate to **Razorpay Route woocommerce** → **Payments**.
                2. Check if a **Payment Id** has been generated and note the status. In case of a successful payment, the status is marked as **Captured**. Know more about various [payment states](https://razorpay.com/docs/build/llm-docs/payments/payments.md#payment-life-cycle).
...
- Ensure you have entered [Test Mode API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) in the Checkout code.
...
For Mutual Funds Distributors (MFDs), Linked Accounts with their Asset Management Company (AMC) details are automatically created after they get access to the Route. MFDs do not need to create any Linked Accounts from the Dashboard. Please get in touch with our [support team](https://razorpay.com/support/) for any help on creating Linked Accounts.
            ...
            1. Log in to the Dashboard and click the **Route** menu.
...
### 3.2 Generate an API Key in Live Mode
            ...
            1. Replace the Test API Key with the Live Key in the WordPress Dashboard and accept actual payments.
            

            

            You have successfully generated your API keys in Live Mode. Use this pair of `Key_ID` and `Key_Secret` to accept payments from your customers and route them to the involved third parties using [Route](https://razorpay.com/docs/build/llm-docs/payments/route.md).
