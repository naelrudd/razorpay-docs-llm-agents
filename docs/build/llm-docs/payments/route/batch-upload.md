...
- [Create Linked Accounts](https://razorpay.com/docs/build/llm-docs/payments/route/batch-upload.md#create-linked-accounts-via-batch-upload)
- [Create Transfers](https://razorpay.com/docs/build/llm-docs/payments/route/batch-upload.md#create-transfers-via-batch-upload)
...
1. Update and save the file with the following details. Refer to the [Linked Accounts Batch Fields](https://razorpay.com/docs/build/llm-docs/payments/route/batch-upload.md#linked-account-batch-fields) section for more information.
    - `account_name`
    - `account_email`
    - `dashboard_access`
    - `customer_refunds`
...
[Route FAQs](https://razorpay.com/docs/build/llm-docs/payments/route/faqs.md)
