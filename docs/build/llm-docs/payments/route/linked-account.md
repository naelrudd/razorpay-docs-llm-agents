...
### Features
        ...
        - [Process individual and bulk refunds](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/initiate-refund.md).
        - [View reversals and settlements](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/reversals-settlements.md).
        - [Manage profile and team members](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/manage-profile.md).
...
- **Settlement Timing**: Linked Account settlements take 2 working days, regardless of your primary settlement schedule.
        ...
        Create Linked Accounts programmatically using the [Route APIs](https://razorpay.com/docs/build/llm-docs/api/payments/route.md) for automated onboarding and bulk operations.
...
Know more about [penny testing](https://razorpay.com/docs/build/llm-docs/payments/route/faqs.md#penny-testing).
...
- [Route Overview](https://razorpay.com/docs/build/llm-docs/payments/route.md)
- [Processing Refunds](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/initiate-refund.md)
- [Settlements and Reversals](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/reversals-settlements.md)
- [Profile Management](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/manage-profile.md)
- [Route APIs](https://razorpay.com/docs/build/llm-docs/api/payments/route.md)
