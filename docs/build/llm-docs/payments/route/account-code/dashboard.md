...
Also, they can perform other actions such as processing refunds. Know more [about Linked Account Dashboard](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md).
...
[Learn more about Dashboard operations](https://razorpay.com/docs/build/llm-docs/payments/route/batch-upload.md).
