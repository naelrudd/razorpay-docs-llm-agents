...
The Linked Account holders must send an offline request to you to use [Refund Credits](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md#enable-refund-credits). Upon gaining access, funds can be transferred to the Refund Credits pool through the account number that you share.
...
You can initiate the following types of refunds from the Linked Account: [Individual Refund](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/initiate-refund.md#individual-refunds), [Full Refund](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/initiate-refund.md#full-refund), [Partial Refund](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/initiate-refund.md#partial-refund) and [Batch Refund](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/initiate-refund.md#batch-refunds).
...
- [Reversals and Settlements](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/reversals-settlements.md)
- [Manage Profile and Team](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/manage-profile.md)
