...
In certain cases, Linked Accounts must directly refund the amount to the customers. To handle this, you can [enable customer refunds](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md#enable-refunds-capability) for linked accounts from your Dashboard. The Linked Account users can [issue refund to the customer](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account/initiate-refund.md) from the Linked Account Dashboard.
