...
### How It Works
         ...
         2. Razorpay detects a `payment.captured` [webhook event](https://razorpay.com/docs/build/llm-docs/webhooks/payments.md).
...
1. Set up your [Razorpay Webhook](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md). 
    - You will need the [Zapier **Catch Hook** URL](https://razorpay.com/docs/build/llm-docs/payments/ecommerce-plugins/ghost-integration/zapier-integration.md)to complete the webhook set up. 
...
2. Create a [Razorpay Payment Button](https://razorpay.com/docs/build/llm-docs/payments/ecommerce-plugins/ghost-integration/add-payment-button.md).
...
4. Create a [Zapier Zap](https://razorpay.com/docs/build/llm-docs/payments/ecommerce-plugins/ghost-integration/zapier-integration.md).
