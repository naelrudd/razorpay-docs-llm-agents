...
- If you are a new Razorpay user, click **I am new to Razorpay** and [set up](https://razorpay.com/docs/build/llm-docs/payments/set-up.md) an account.
...
- Webhooks is auto-configured. You need to verify if webhooks are enabled on your [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/ecommerce-plugins/razorpay-direct-credit-card/troubleshooting-faqs.md#7-how-can-i-verify-if-webhooks-are).
...
- [Troubleshooting and FAQs](https://razorpay.com/docs/build/llm-docs/payments/ecommerce-plugins/razorpay-direct-credit-card/troubleshooting-faqs.md)
- [Ecommerce Plugins](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins.md)
