...
You can issue refunds to your customers from the Dashboard. Know more about [issuing refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds/issue.md).

## Subscribe to Webhook Events

You can subscribe to webhook events from the Dashboard. Know more about [Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md).
...
Know more about [webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md) and check the [sample payloads](https://razorpay.com/docs/build/llm-docs/webhooks/payments.md).

### Related Information 

- [About Payments](https://razorpay.com/docs/build/llm-docs/payments/payments.md)
- [Payment APIs](https://razorpay.com/docs/build/llm-docs/payments/payments/apis.md)
