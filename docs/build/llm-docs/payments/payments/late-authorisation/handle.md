...
Auto refunds are issued within 5 days. However, if you want to issue a refund instantly, you can capture the payment and issue a refund as per your requirements. Know more about [Refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds.md).
...
This is the easiest way to handle late authorisation. This feature gives you control over which payments should be auto-captured and which payments should be auto-refunded by allowing you to:
  ...
  - Setup custom timeouts for automatic and [manual capture](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings/api.md).
  - Manually capture all payments.

Know more about [Payment Capture settings](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md).
...
- Allows you to auto-capture payments based on the parameters passed in the [Orders API](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings/api.md). Capture values passed in the Orders API take precedence over the Payment Capture settings configured on the Dashboard.
...
You can send email notifications to your customers about the payment status, asking them to take further action to deliver the service. You can set up webhooks from the Dashboard. Know more about [webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md).
...
### 1. Is Late Authorisation of payment specific to Razorpay?
     ...
     - [Payment capture settings on the Dashboard](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md).
...
- [Late Authorisations](https://razorpay.com/docs/build/llm-docs/payments/payments/late-authorisation.md)
- [About Payments](https://razorpay.com/docs/build/llm-docs/payments/payments.md)
