...
You can update Subscriptions from the [Dashboard](#update-a-subscription-from-dashboard) or using [APIs](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions.md#update-a-subscription).
...
- `Subscription Start Date` for the updated Subscription details. This can either be immediate or any future date. You can choose to update a Subscription:
    - [Immediately](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/update.md#update-subscriptions-immediately)
    - [At the end of the current billing cycle](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/update.md#update-subscription-at-the-end-of-the-current)
...
**Watch Out!**
- You can only update Subscriptions in the `authenticated` and `active` states. Subscriptions in the `created`, `pending` or `halted` state cannot be updated. There is no state change when a Subscription is updated. Know more about the [Subscription states.](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/states.md)
...
- [Charge the customer an extra amount](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/update.md#charge-a-customer-extra)
- [Refund an amount to the customer](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/update.md#refund-money-to-a-customer)
...
(since customers are charged at the end of the day) | Remaining days (original plan) = 30
            ...
            ---
            Amount to be charged/refunded | N/A | Amount to be charged (new plan) - Remaining Amount (original plan)  = 0
...
(since customers are charged at the end of the day) | Remaining days (original plan) = 3
            ...
            ---
            Amount to be charged/refunded | N/A | Amount to be charged (new plan) - Remaining Amount (original plan) = -600(refund)
...
If the plans have different billing cycles, the new plan is billed at the new interval, starting on the day of the change.
            ...
            ---
            Plan amount per day | (Plan amount x Quantity)/Frequency at which the amount should be charged in days = 30 | N/A
            ---
...
(since customers are charged at the end of the day) | Remaining days (original plan) = 121
            ...
            ---
            Amount to be charged | Plan amount per day x Days to be charged = 7320 | Plan amount x Quantity = 21900
            ---
            Remaining amount | Plan amount per day x Remaining days = 3630 | N/A
            ---
            Amount to be charged/refunded | N/A | Amount to be charged (new plan) - Remaining Amount (original plan) = 18270 (charge)
...
If the plans have different billing cycles, the new plan is billed at the new interval, starting on the day of the change.
            ...
            ---
            Plan amount per day | (Plan amount x Quantity)/Frequency at which the amount should be charged in days = 10 | N/A
            ---
...
(since customers are charged at the end of the day) | N/A
            ...
            ---
            Amount to be charged | Plan amount per day x Days to be charged = 260 | Plan amount x Quantity = 1800
            ---
            Remaining amount | Plan amount per day x Remaining days = 40 | N/A
            ---
            Amount to be charged/refunded | N/A | Amount to be charged (new plan) - Remaining Amount (original plan) = 1760 (charge)
...
Use the [Update a Subscription API](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions/update-subscription.md) to update a Subscription.
...
- [Create and View Plans](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-plans.md)
- [Create Subscriptions via Links](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-subscription-links.md)
- [Charge a Card Manually](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/manually-charge-card.md)
- [Subscriptions Settings](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/settings.md)
