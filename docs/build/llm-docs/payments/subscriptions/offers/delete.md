...
You can delete an Offer linked to a Subscription from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/offers/delete.md#delete-an-offer-linked-to-a-subscription-from) or using [APIs](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/offers/delete.md#delete-an-offer-linked-to-a-subscription-using). The invoices generated after the offer is deleted will be charged in full.
...
Use the [Delete an offer Linked to a Subscription API](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions/delete-offer.md).
