...
- Use your test [KEY_ID] and [KEY_SECRET] while testing. This can be generated from the Dashboard by [generating API keys](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md) in the test mode.
...
### 1. Configure a Webhook
     ...
     Before you create Subscriptions, [configure a test webhook](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md) to receive notifications regarding Subscriptions.
    

  
### 2. Create a Plan

     Create a Plan from your [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-plans.md#create-a-plan) and use them in your code while creating Subscriptions. You can also create Plans using [Razorpay Subscriptions APIs](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions/create-plan.md).
...
### 3. Create a Subscription
     ...
     **Example**
     ...
     If you create a Subscription using the Dashboard, it can only be created as a [Subscription Link](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-subscription-links.md).

     

     

     You can also create Subscriptions using [APIs](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions/create-subscription.md). A sample request and response for the creation of **Subscription A** and **Subscription B** is given below.
...
### 4. Make Authorisation Payment
      ...
      The above code only contains the minimum required options that need to be sent to initiate a payment, that is, only `key` and `subscription_id` are mandatory. Check the [checkout fields](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/integration-steps.md#123-checkout-options) for a complete list of options that can be passed.
...
### Payment Amount
          ...
          To make a successful payment, the payment response contains a few fields carrying information about the Subscription that has been authenticated. Check the [payment verification section](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/integration-guide.md#payment-verification) to know more about how this payment response can be authenticated.
...
### Customer changes card on payment failure
      ...
      If there are any incomplete charges, you have to manually attempt to charge the card again from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/manually-charge-card.md).
...
### Complete and Cancelled Subscriptions
     ...
     - Cancelling a Subscription using [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/pause-resume-cancel.md#cancel-a-subscription-via-the-dashboard) or [API](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions.md#cancel-a-subscription).
    

### Related Information

- [Subscriptions](https://razorpay.com/docs/build/llm-docs/payments/subscriptions.md)
