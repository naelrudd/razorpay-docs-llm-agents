...
- Razorpay Subscriptions is based on the existing Razorpay [payment flow](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/how-it-works.md) process. If you are new to Razorpay, we recommend you to understand this flow before you read further.
...
1. [Install the Razorpay Subscriptions for Magento Plugin](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/plugins/magento.md#install-the-razorpay-subscriptions-for-magento-plugin).
2. [Configure Magento Store](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/plugins/magento.md#configure-magento-store).
3. [Create a Plan for a Subscription Product](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/plugins/magento.md#create-a-plan-for-subscription-product).
4. [Enable Subscriptions for your Product](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/plugins/magento.md#configure-your-product-for-subscriptions).
5. [Test it out - Sign up for a Subscription](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/plugins/magento/test-it-out.md).

On the Razorpay Dashboard:
1. [Enable Webhooks](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/plugins/magento.md#enable-webhooks).
...
For details of available events and sample payloads, refer to the [Webhook Events section](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins/woocommerce/troubleshooting-faqs.md).
