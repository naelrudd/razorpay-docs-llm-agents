...
The subscription status names used by Razorpay and Magento are different. The table below shows the mapping between the subscription statuses names used by Razorpay and Magento. Refer to the Razorpay Subscriptions status flow [here](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/states.md).
