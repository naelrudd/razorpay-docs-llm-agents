...
- To refund the subscription amount to a customer, you need to do this manually from the [Razorpay Dashboard](https://razorpay.com/docs/build/llm-docs/payments/payments/dashboard.md#issue-a-refund).
