...
Subscription Links can be created from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-subscription-links.md#create-a-subscription-link-from-dashboard) or using [APIs](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-subscription-links.md#create-a-subscription-link-using-api).
...
1. [Create a plan](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-plans.md#create-a-plan).
1. [Create and send a Subscription link](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-subscription-links.md#create-a-subscription-link).
...
You can create a Subscription Links using [Create a Subscription Link API](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions/create-subscription-link.md).
