...
1. [Create an Offer from the Dashboard](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/offers/create.md).
1. [Create a Plan for the Subscription](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-plans.md#create-a-plan).
1. [Link the Offer to a Subscription](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/offers/link.md).
