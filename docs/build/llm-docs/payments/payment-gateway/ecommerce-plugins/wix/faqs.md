...
### 4. What troubleshooting procedures should be carried out prior to initiating a support ticket?
         ...
         1. Reinstall the Razorpay Wix plugin and ensure that your system meets all the requirements mentioned [here](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins/wix/integration-steps.md).
