...
If you are using Razorpay to accept payments, you can now upgrade to the **All-in-one Razorpay Payment Gateway** on your Shopify Store. Watch the [video tutorial](#video-tutorial) or follow the [migration steps](#migration-steps) to migrate to All-in-one Razorpay Payment Gateway. Know more about why you need to [upgrade to All-in-one Razorpay Payment Gateway](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins/shopify/faqs.md#1-why-do-i-need-to-upgrade-to). 
...
### Deactivation
         ...
         For more information, see [Shopify FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins/shopify/faqs.md).
...
Know more about how to [reconcile Shopify orders on the Dashboard](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins/shopify/reconcile-payments.md). 
...
**Old Razorpay App** [columWidth="50"] | **All-in-one Razorpay Payment Gateway**
---
