...
Follow the steps given below to integrate the All-in-one Razorpay Payment Gateway App on your Shopify store.

  - **1. Build Integration**: Install the All-in-one Razorpay Payment Gateway.
...
Make sure you log in with **store owner** credentials to connect Razorpay with Shopify successfully.
         ...
         This completes your integration. For more information, see [Shopify FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins/shopify/faqs.md).
        

## 2. Test Integration

After the integration of **Shopify - All-in-one Razorpay Payment Gateway** on your Shopify store is complete, follow the steps given below:
...
### 2.1 Make a Test Transaction in Test Mode
         ...
         7. Select **All-in-one Razorpay Payment Gateway** and click **Complete order**.
