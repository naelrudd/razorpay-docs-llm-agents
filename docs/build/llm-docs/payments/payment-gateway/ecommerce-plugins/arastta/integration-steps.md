...
### 1.1 Installation
         ...
         5. Click **Edit** next to Razorpay and complete the following actions:
            1. Add your Razorpay `[KEY_ID]` and `[KEY_SECRET]`. These can be generated from your Razorpay [Dashboard](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
