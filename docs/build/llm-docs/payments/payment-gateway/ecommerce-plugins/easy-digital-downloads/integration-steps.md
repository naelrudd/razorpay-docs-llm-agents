...
If you have downloaded the extension from GitHub or elsewhere, ensure that the directory is named `edd-razorpay`.
         ...
         10. Enter your `[KEY_ID]` and `[KEY_SECRET]`. Generate the [API Keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) from the Razorpay Dashboard.
