...
- If you are not using WooCommerce, you can use our [native plugin for WordPress](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins/wordpress.md).
- Razorpay WooCommerce subscription plugin is available only in the paid versions of WooCommerce.
- For Subscriptions on a WooCommerce-based website, you can use our [Subscriptions plugin for WooCommerce](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/plugins/woocommerce.md).
...
Payment Gateway | Route | Subscriptions | [Razorpay Trusted Business](https://razorpay.com/docs/build/llm-docs/payments/widgets/trusted-business/rtb-widget-woocommerce.md)
---
✓ | ✓ | ✓ | ✓
