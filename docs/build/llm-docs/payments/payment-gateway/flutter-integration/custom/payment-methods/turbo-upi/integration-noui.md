...
1. Replace the UAT credential with the [Razorpay live keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) for prod testing.
