...
View the complete list of [UPI supported apps and their package names](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/supported-apps.md).
...
Given below is the sample code for the payment method `paylater`. Know more about [paylater](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/pay-later/custom-integration.md).
...
Given below is the sample code for the payment method `cardless_emi`. Know more about [Cardless EMI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/cardless-emi/custom-integration.md).
