...
You can easily integrate Turbo UPI with the Razorpay Flutter Standard SDK. Explore the full potential of [Razorpay Turbo UPI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md) and learn how it works.
...
### Prerequisites
                ...
                2. Review the [Razorpay Flutter Standard SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/flutter-integration/standard.md) documentation for integration guidelines.
