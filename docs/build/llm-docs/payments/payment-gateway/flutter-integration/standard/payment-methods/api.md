...
The `options` map has `key` as a required property in the open checkout method. All other properties are optional. Know about all the [options available on checkout form](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/flutter-integration/standard/integration-steps.md#17-add-checkout-options).
