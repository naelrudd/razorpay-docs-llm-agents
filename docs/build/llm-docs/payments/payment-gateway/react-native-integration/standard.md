...
Check your current SDK version. If it is outdated, please [update the SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/react-native-integration/standard/troubleshooting-faqs.md#9-how-can-i-update-the-razorpay-react) to ensure uninterrupted settlements of your funds.
