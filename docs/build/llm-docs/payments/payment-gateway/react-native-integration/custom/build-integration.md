...
Before calling `getPaymentMethods`, ensure you have initialised the SDK using `Razorpay.initRazorpay(key)`.
...
Check the [additional support for payment methods](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/react-native-integration/custom/additional-features.md) available with the Razorpay React Native Custom SDK.
...
Know more about [passing callback URL](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/callback-url.md).
...
[Step 2: Test Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/react-native-integration/custom/test-integration.md)
...
- [Payment Methods](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/react-native-integration/custom/additional-features.md)
