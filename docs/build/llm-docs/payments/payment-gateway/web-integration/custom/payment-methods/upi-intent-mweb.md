...
2. Instantiate Razorpay with your Key ID generated from the [Dashboard](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys). Skip this step if you have already completed it.
