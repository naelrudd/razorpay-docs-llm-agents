...
2. Pass `webview_intent: true` parameter in the [payload](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom/build-integration.md#132-instantiate-custom-checkout) sent to checkout to enable UPI intent support.
