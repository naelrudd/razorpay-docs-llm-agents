...
- [Generate the API Keys on Dashboard](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings.md#api-keys).

Watch the video to see how to generate API key in Test Mode.

- [Integrate with our Custom Checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom.md).
...
**Read more:** [Learn more about Flash Checkout.](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings.md#flash-checkout)
...
**Read More**: [Learn more about Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
...
**Read more:** [Learn about the other Checkout parameters](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom/build-integration.md) for web integration.
