...
2. Pass `webview_intent: true` parameter in the [payload](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/integration-steps.md#122-code-to-add-pay-button) sent to checkout to enable UPI intent support.
