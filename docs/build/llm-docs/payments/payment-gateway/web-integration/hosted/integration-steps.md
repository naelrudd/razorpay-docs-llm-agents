...
`key_id` _mandatory_
: `string` Enter [YOUR_Key_ID] generated from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md#generate-api-keys).
