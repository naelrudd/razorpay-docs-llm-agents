...
If you reuse your web integration of Razorpay Checkout inside a web view on Android or iOS, the checkout form may not open. Issues like this are handled in our [Android SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard.md) and [iOS SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard.md), with the SDKs being the preferred method of integration.
...
If you want to reuse the web integration for any reason, you can pass the following `callback_url` along with other [checkout options](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/integration-steps.md#123-checkout-options) to process the desired payment:
