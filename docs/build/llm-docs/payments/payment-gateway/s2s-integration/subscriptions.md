...
You can create, fetch, query or cancel plans, subscriptions and addons using the Subscriptions API. These operations can also be performed on the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/subscriptions.md).
...
```bash: CLI
razorpay subscriptions fetch sub_ABC123
```
...
```bash: CLI
razorpay subscriptions cancel-update sub_ABC123
```
...
```bash: CLI
razorpay subscriptions pause sub_ABC123 --pause-at now
```
...
```bash: CLI
razorpay subscriptions resume sub_ABC123 --resume-at now
```
...
: `array` List of invoices generated for the Subscription.
  ...
  : `object` Details of the customer.
      ...
      `name`
      : `string` The customer's name. Know more [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
...
1. Create a signature in your server using the following attributes:
 ...
 The `key_secret` that was generated from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard.md#prerequisites).
...
- [API authentication](https://razorpay.com/docs/build/llm-docs/api.md)
- [Subscription product documentation](https://razorpay.com/docs/build/llm-docs/payments/subscriptions.md)
