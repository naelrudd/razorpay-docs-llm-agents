...
[migrate to the 3DS2 flow](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/redirect/build-integration/cards/migrate-3ds2.0.md).
...
**Know more:** Razorpay supports [3DS2 transactions](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/cards/3ds2.0.md).
...
Descriptions for the response parameters are present in the [Payments Entity](https://razorpay.com/docs/build/llm-docs/api/payments.md#payments-entity) parameters table.
...
Know more about [errors](https://razorpay.com/docs/build/llm-docs/errors.md).
...
[Step 2: Test Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/redirect/test-integration.md)
