...
2. Familiarize yourselves with the [payment flow](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/how-it-works.md).
...
Razorpay APIs are authenticated using **Basic Auth** method where your `key_id` is the **Username** and `key_secret` is the **Password**. You can access your API keys from the [Dashboard](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
...
`currency` _mandatory_
: `string` The currency of the transaction as passed in [Orders](#1-create-a-razorpay-order). [See the list of supported currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies).
...
: `string` The unique identifier of the order created using in [Step 1](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/cards/authentication-type/native-otp.md#1-create-a-razorpay-order).
...
[`next`](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/cards/authentication-type/native-otp.md#otp-submit)
