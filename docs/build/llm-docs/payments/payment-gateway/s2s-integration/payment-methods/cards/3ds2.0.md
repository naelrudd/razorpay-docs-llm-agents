...
- [Integration Steps for New Razorpay Businesses (Integrating after October 15, 2022)](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/json/v2/build-integration/cards.md)
- [Migration Steps for Existing Razorpay Businesses (Integrated before October 15, 2022)](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/json/v2/build-integration/cards/migrate-3ds2.0.md)
