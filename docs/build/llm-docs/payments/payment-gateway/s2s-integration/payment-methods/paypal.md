...
You can accept payments based on the transaction limit of your PayPal account. Know more about the other [payment methods and the transaction limits](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/transaction-limits.md).
...
You can accept payments from the provided [list of supported currencies](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/paypal/supported-currencies.md).
...
: `string` The currency in which the transaction should be made. Refer to the [list of supported currencies](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/paypal/supported-currencies.md). Length must be of 3 characters.
...
If the payment has failed, the callback will contain details of the error. Refer to [Errors](https://razorpay.com/docs/build/llm-docs/api.md#errors) for details.
...
1. Refunds can be initiated by you either from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/payments/dashboard.md#issue-refunds) or by using the [Refunds API](https://razorpay.com/docs/build/llm-docs/api/refunds.md#refund-a-payment).
