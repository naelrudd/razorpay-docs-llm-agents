...
You can create bulk payments from the [Dashboard](https://dashboard.razorpay.com). Know more about [batch payments](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/moto/batch.md).
