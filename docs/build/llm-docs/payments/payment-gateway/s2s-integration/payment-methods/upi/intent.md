...
4. **Mobile site**  
  ...
  If you have higher traffic via mobile site, then make sure you provide the option of UPI intent payment to your users using our [m-site integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/google-pay/custom-integration.md). This will help you achieve better success rates.
5. **Gpay SDK** 
...
: `json object` A key-value pair that can hold additional information about the payment. 
 Refer the [Notes](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes) section of the API Reference Guide.
...
For the package name, you can check the [list of supported UPI apps](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/supported-apps.md).

### Step 3: Verify the Payment Status

You can verify the status of the payments using any of the following methods:

- Poll Razorpay servers periodically for the payments made for the order using our [Fetch Payment APIs](https://razorpay.com/docs/build/llm-docs/api/orders/fetch-payments.md).

- [Subscribe to the Webhook events](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md) created in our system for each of the following entities:
...
[Error reasons](https://razorpay.com/docs/build/llm-docs/errors.md#list-of-error-reasons-for-payments)
