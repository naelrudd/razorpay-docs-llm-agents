...
-  Poll the Razorpay servers to [fetch a payment](https://razorpay.com/docs/build/llm-docs/api/payments/fetch-with-id.md) or [fetch the payments made for an order](https://razorpay.com/docs/build/llm-docs/api/payments.md#fetch-payments-based-on-orders).

- Subscribe to [payments](https://razorpay.com/docs/build/llm-docs/webhooks/payments.md) and [orders](https://razorpay.com/docs/build/llm-docs/webhooks/orders.md) Webhook events that are generated in Razorpay when the customer completes the payment on your website.
