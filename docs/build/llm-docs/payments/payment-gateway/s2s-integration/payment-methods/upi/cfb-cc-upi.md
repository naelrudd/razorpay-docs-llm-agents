...
- Integrate with Server-to-Server (S2S) integration:
  ...
  - [S2S Redirect](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/redirect.md)
...
: `string` Unique identifier of the order created using the [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders/create.md).
...
Refer to the [Settlement APIs](https://razorpay.com/docs/build/llm-docs/payments/settlements/apis.md).
