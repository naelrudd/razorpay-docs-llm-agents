...
You can also [search for the Token](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/create.md#3-search-for-the-token) on your Dashboard.
...
```json: Response
{
  "id": "pay_SXk8WW4rbjbYpI",
  "entity": "payment",
  "amount": 100,
  "currency": "INR",
  "base_amount": 100,
  "status": "captured",
  "order_id": "order_SXk7glvsJDCY2K",
  "invoice_id": "inv_SXk7hITJTp0sRd",
  "international": false,
  "method": "wallet",
  "amount_refunded": 0,
  "refund_status": null,
  ...
  "customer_id": "cust_SXk7OtkunoDBe6",
  "token_id": "token_SXk8WvbsoOBS4b",
  "notes": {
...
You can also retrieve the `token_id` from the [payment.authorized webhook](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/webhooks.md#payment-authorized).
...
```json: Response
{
  ...
  "items": [
    {
      "id": "token_SXk8WvbsoOBS4b",
      "entity": "token",
      "token": "2LDV6DPBulVFrx",
      "bank": null,
      "wallet": "touchngo",
      "method": "wallet",
      "recurring": true,
