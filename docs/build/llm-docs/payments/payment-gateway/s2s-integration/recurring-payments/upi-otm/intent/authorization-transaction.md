...
2. [Fetch and manage tokens](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/tokens.md)
3. [Create a one time mandate](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/one-time-payment.md)
...
You will get the [token.confirmed](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/webhooks.md#token-confirmed) webhook after the customer approves the mandate request.
...
You can use [Token Webhooks](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/webhooks.md#check-authorization-link-status-using-webhooks) to get notifications about successful payments against a registration link. Do not use payment webhooks for Authorisation Payments.
