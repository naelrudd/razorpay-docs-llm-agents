...
Refer to the [Create a Subsequent Card Payment API](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/cards/create-subsequent-payments.md#32-create-a-recurring-payment) to proceed.

## Related Information

- [Recurring Payments Documentation](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments.md)
- [Recurring Payments APIs](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments.md)
