...
`apiKey`
: `string` API Key ID generated from the [Dashboard](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys), used to ensure the feature is enabled. 
