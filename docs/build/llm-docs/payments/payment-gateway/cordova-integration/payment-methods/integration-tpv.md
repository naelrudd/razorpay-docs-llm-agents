...
### Prerequisites
         ...
         1. Integrate with [Razorpay Cordova Standard SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/cordova-integration.md).
...
- `SERVER_ERROR`: Failure at PSP.
         ...
         [Refer to the list of possible error reasons](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/cordova-integration/payment-methods/turbo-upi/error-codes.md).
