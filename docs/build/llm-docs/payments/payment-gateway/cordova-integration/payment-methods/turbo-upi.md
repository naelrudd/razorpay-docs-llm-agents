...
You can seamlessly integrate Turbo UPI with Razorpay Cordova Standard SDK. Explore the full potential of [Razorpay Turbo UPI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md) and know how it works.
