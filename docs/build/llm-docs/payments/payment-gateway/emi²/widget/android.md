...
After you successfully integrate the widget on your Android app, you can choose to [customise the widget](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/android/customise.md) based on your requirement.
...
- [Affordability Widget FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/faqs.md)
