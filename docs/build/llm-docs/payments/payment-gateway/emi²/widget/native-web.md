...
- You can use the **Test Mode** keys to test the integration and preview the Widget. Later, switch to **Live Mode** of the Dashboard, generate the [Live API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) and replace it with the test keys.
...
`key` _mandatory_
: `string` API Key ID generated from the [Dashboard](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys). For example, `rzp_test_XXXX00000XXXX`.
...
After you preview the widget, switch to live mode and replace the test API keys in the sample code with the live ones to take the integration live. Know more about [live API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys).
...
After you successfully integrate the widget on your website, you can choose to [customise the widget](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web/customise.md) based on your requirement.
...
- [Affordability Widget FAQs for Native website](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/faqs.md#native-website)
...
- [Integrate Affordability Widget on your Android app](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/android.md)
