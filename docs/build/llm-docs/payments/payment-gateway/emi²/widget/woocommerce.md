...
- Generate the [API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) from the Dashboard by navigating to **Account & Settings** → **Website and app settings** → **API keys**. 
    ...
    - Switch to **Live Mode** on the Razorpay Dashboard → Generate the [Live API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) and replace it with the test keys.
...
Refer to [FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/faqs.md#1-i-am-integrating-with-razorpay-plugin-for) if you are integrating with our plugin for the first time.
...
After you successfully integrate the widget on your WooCommerce website, you can choose to [customise the widget](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/woocommerce/customise.md) based on your requirement.
...
[Affordability Widget FAQs for WooCommerce](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/faqs.md#woocommerce)
