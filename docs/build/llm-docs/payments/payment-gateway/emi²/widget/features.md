...
- [Android App](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/android.md)
...
### Prerequisites
         ...
         - Integrate with the [Razorpay Affordability Widget](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget.md).
         - Create instant discount and cashback offers with minimum order amount via [Razorpay Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/create.md).
...
- The eligibility check is performed only for [Debit Card EMI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/debit-card-emi.md), [Cardless EMI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/credit-card-emi.md), and [Pay Later](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/pay-later.md). 
...
### Prerequisites
         ...
         - Create a [Razorpay account](https://dashboard.razorpay.com/signup).
         - Integrate with the [Razorpay Affordability Widget](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web.md). 
