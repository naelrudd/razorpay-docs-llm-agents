...
- This feature is only supported on [Native Website](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web.md) integration.
...
- Generate the [API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) from the Dashboard. You can use the **Test Mode** keys to test the integration and preview the Widget. Later, switch to **Live Mode** of the Dashboard, generate the [Live API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) and replace it with the test keys.
...
### 1.2 Pass Function in Affordability Widget Configuration
     ...
     : `string` The currency in which the customer should make the payment. Check the list of [supported currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies).
