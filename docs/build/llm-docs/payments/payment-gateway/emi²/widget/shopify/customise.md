...
Configure the offers you want to display on the store based on your requirement. Customers can choose from a wide range of offers for your product or service. Know how to [create offers](https://razorpay.com/docs/build/llm-docs/payments/offers/create.md).
...
- [Affordability Widget: Shopify FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/faqs.md#shopify)
