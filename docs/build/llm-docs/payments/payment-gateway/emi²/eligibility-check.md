...
- You can perform the eligibility check on methods and instruments enabled for your account. Know how to [check the payment methods enabled](https://razorpay.com/docs/build/llm-docs/payments/payment-methods.md#view-payment-methods) for your account.
...
: `object` Customer details.
  ...
  `id` 
  : `string` Unique identifier of the customer created using [Customers API](https://razorpay.com/docs/build/llm-docs/payments/customers.md). For example, `cust_1Aa00000000004`.
...
Refer to the [Configurations](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/eligibility-check/configurations.md) doc for eligibility checks on specific methods or instruments.
...
[Standard Errors](https://razorpay.com/docs/build/llm-docs/api/understand.md) for Razorpay APIs are applicable.
...
- [Debit Card EMI Providers](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/faqs.md#5-can-you-provide-a-list-of-the)
- [Cardless EMI Providers](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/faqs.md#1-what-are-the-standard-interest-rates-charged)
- [Pay Later Providers](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/faqs.md#2-what-are-the-standard-interest-rates-charged)
