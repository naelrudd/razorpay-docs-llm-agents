...
- For Native users, you can [integrate the widget with checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/features.md#checkout-from-widget).
...
### Advantages
      ...
      - **Improve conversion rates** 
        ...
        The availability of affordable payment options such as [EMI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi.md) and [Pay Later](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/pay-later.md) help boost conversion rates.
 ...
 2. Integrate the widget with your [custom built-website](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web.md), [WooCommerce website](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/woocommerce.md) or [Shopify store](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/shopify.md). 
 3. Once you successfully integrate the widget on your website, you can choose to customise the [offers](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web/customise.md#1-offers), [payment methods](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web/customise.md#2-payment-methods) and the [themes and colours](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web/customise.md#3-themes-and-colours) based on your requirement.
...
[Eligibility Check on Widget](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/features.md#eligibility-check) is an on-demand feature. Write to us at [affordability-widget@razorpay.com](mailto:affordability-widget@razorpay.com) to get this feature enabled.
...
- [Checkout from the Widget](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/features.md#checkout-from-widget) is an on-demand feature. Write to us at [affordability-widget@razorpay.com](mailto:affordability-widget@razorpay.com) to get this feature enabled.
- If you have a [custom-built checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom.md), integrate with checkout from the widget using [Custom Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/custom-integration.md).
...
For Shopify and WooCommerce users, this is a view-only widget. Customers can select their preferred offer and plan **only** at checkout.
 ...
 You can choose to: 
 - [Integrate Affordability Widget on Web](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web.md)
 - [Integrate Affordability Widget on Woocommerce website](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/woocommerce.md)
 - [Integrate Affordability Widget on your Shopify store](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/shopify.md) 
 - [Integrate Affordability Widget on Android App](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/android.md)

 ### Related Information
 
 - [Features](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/features.md)
 - [FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/faqs.md)
 - [Customise the Widget on Web](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/native-web/customise.md)
 - [Customise the Widget on WooCommerce](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/woocommerce/customise.md)
 - [Customise the Widget on Shopify](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi²/widget/shopify/customise.md)
 - [Create Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/create.md)
 - [Create No Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/no-cost-emi/create.md)
 - [Create Low Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi/create.md)
 - [Payment Methods](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi².md#payment-methods)
