...
Know more about [the possible values](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi.md).

## Fetch Payment Downtime Details

To retrieve details of payment downtimes, see this [endpoint](https://razorpay.com/docs/build/llm-docs/api/payments/downtime/fetch-all.md).

## Fetch Payment Downtime Details by ID

To retrieve details of payment downtimes by ID, see this [endpoint](https://razorpay.com/docs/build/llm-docs/api/payments/downtime/fetch-with-id.md).
