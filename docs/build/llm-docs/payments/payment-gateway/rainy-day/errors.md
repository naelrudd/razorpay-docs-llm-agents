...
If you are using an official [Razorpay Language-wise SDK Integration](https://razorpay.com/docs/build/llm-docs/payments/server-integration.md), the error responses result in exceptions that need to be handled in your integration.
...
To understand more about error codes, refer to the [Error Codes](https://razorpay.com/docs/build/llm-docs/errors.md) section.
