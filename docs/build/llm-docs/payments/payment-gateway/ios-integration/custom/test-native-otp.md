...
Integrate the [Razorpay Native OTP](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/native-otp.md) feature with iOS custom checkout to avoid customer payment issues such as payment failures due to low internet speeds and bank page redirects.
...
Know [how to verify payment status](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/build-integration.md#110-verify-payment-status).
...
Know more about how to [Accept Live Payments](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/go-live-checklist.md#accept-live-payments).
