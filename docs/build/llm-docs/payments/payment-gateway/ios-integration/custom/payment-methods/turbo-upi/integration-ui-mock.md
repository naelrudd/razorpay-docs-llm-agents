...
Follow these steps to integrate with [Turbo UPI with UI](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-ui.md#1-integration-steps).
...
### 2.3.6 Transactions
                        ...
                        Payments Successful
                         ...
                         1. Begin by following the [integration steps](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-ui.md#1-integration-steps), specifically the `submit` method.
...
Complete this [Go-live Checklist](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-ui.md#3-go-live-checklist) to take your integration live.
