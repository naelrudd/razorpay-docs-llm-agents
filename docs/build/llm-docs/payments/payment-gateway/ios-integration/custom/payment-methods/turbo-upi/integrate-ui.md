...
### Prerequisites
         ...
         2. Integrate with the [Razorpay iOS Custom SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/build-integration.md).
...
- Use the `rzp_test_0wFRWIZnH65uny` API key id for testing on the UAT environment and the [Razorpay live keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) for prod testing.
