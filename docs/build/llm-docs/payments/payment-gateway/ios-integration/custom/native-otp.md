...
2. Integrate with the [Razorpay iOS Custom SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom.md).
...
To reuse the Razorpay Checkout web integration inside a WebView on Android or iOS, pass a [callback_url](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/callback-url.md) along with other checkout options to process the desired payment.
