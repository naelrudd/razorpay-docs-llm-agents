...
- [Change API Key](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/configurations.md#change-api-key)
- [Card Utilities](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/configurations.md#card-utilities)
- [Save Card Details](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/configurations.md#save-card-details)
- [Fetch Logo](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/configurations.md#fetch-logos)
...
Create a customer, whose card details should be saved, from the Dashboard or [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
