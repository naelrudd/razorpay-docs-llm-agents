...
You can seamlessly integrate Turbo UPI with Razorpay iOS Standard SDK. Explore the full potential of [Razorpay Turbo UPI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md) and know How it Works.

## Prerequisites

- Integrate with [Razorpay iOS Standard SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard/integration-steps.md). Ensure that you integrate with SDK version 1.0.0 or higher.
...
Ensure your customers [onboard with Razorpay Turbo UPI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md#2-onboarding-flow) to get started.
...
Razorpay SDK will handle all the changes related to `UpiTurbo` internally. To integrate with the payment flow, [pass payment option and display the checkout form](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard/integration-steps.md#14-pass-payment-options-and-display-checkout-form).
...
- `internal`
         ...
         [Refer to the list of possible error reasons](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard/payment-methods/turbo-upi/error-codes.md).
