...
---
App activity | Installed apps | **Yes**, only detection of installed UPI apps is done to enable [UPI intent](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/upi-intent.md) functionality.
---
