...
- [Card Utilities](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/additional-features.md#card-utilities)
- [Validate VPA](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/additional-features.md#validate-vpa)
- [Fetch Logo](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/additional-features.md#logo)
- [Validate Data](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/additional-features.md#data-validation)
- [Custom `WebViewClient` and `WebChromeClient`](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/additional-features.md#custom-webviewclient-and-webchromeclient)
- [Save Customer Data](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/additional-features.md#save-customer-data)
...
You can associate card details with a saved customer or create payments using tokens for saved cards. To use this functionality, you must use [customer APIs](https://razorpay.com/docs/build/llm-docs/api/customers.md) at server side.
