...
### Prerequisites
         ...
         1. Integrate with the [Razorpay Android Custom SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/build-integration.md).
...
- Use the `rzp_test_0wFRWIZnH65uny` API key id for testing on the UAT environment and the [Razorpay live keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) on the prod testing.
