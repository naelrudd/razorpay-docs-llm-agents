...
Third-party validation (TPV) of bank accounts is mandatory for businesses in the BFSI (Banking, Financial Services and Insurance) sector dealing with Securities, Broking and Mutual Funds. You can accept customer payments with the Turbo UPI UI TPV SDK. Know more about [How TPV works](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation.md#how-it-works).

**WARN**

**Watch Out!**

You can choose to maintain a whitelisted account per customer using the S2S [Customer Add Bank Account API](https://razorpay.com/docs/build/llm-docs/api/customers/bank-accounts.md#1-add-bank-account-of-customer) on your end. This is an additional functionality. This will help you during the onboarding flow, where only whitelisted accounts will be shown to the users during onboarding.
...
### Prerequisites
         ...
         2. Integrate with the [Razorpay Android Custom SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/build-integration.md).
...
- Use the `rzp_test_5sHeuuremkiApj` API key id for testing on the UAT environment and the [Razorpay live keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) for prod testing.
...
If the order is not created, you can provide CustomerId to get bank accounts whitelisted for the customer.
                 ...
                 ```
                        ...
                        Request Parameters
                         ...
                         ---
                         `setCustomerID` | The unique identifier of the customer. You can create `customer_id` using the [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
                         ----
                         `setActivity` | Sets the context or activity for the operation.
                         ---
                         `setOrderID` | Order ID generated via [Orders API](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation.md#upi-only).
                         ----
...
- Use the [Delete Bank Account of Customers API](https://razorpay.com/docs/build/llm-docs/api/customers/bank-accounts.md#2-delete-bank-account-of-customer) to delete bank account of the customers.
...
- `SERVER_ERROR`: Failure at PSP.
         ...
         [Refer to the list of possible error reasons](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/error-codes.md).
...
- Replace the UAT credential with the [Razorpay live keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) for prod testing.
