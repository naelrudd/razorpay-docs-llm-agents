...
### Prerequisites
         ...
         2. Integrate with [Razorpay Android Custom SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/build-integration.md).
...
`customer_id`
: The unique identifier of the customer. You can create `customer_id` using the [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
...
: Order ID generated via [Orders API](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation.md#upi-only).
