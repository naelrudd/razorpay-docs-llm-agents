...
### 1.2 Initialize Razorpay Android Standard SDK
     ...
     Add your `` dynamically using Checkout's `setKeyId()` method. You can generate the [API Keys](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md#generate-api-keys) from the Dashboard.
...
### JSONObject
         ...
         Create an instance of the `Checkout` and pass the payment details and options as a `JSONObject`. Ensure that you add the `order_id` generated in [Step 3](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard/integration-steps.md#13-create-an-order-in-server).
...
### Related Information
[Google Play's Data Safety](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard/google-data-safety.md)
