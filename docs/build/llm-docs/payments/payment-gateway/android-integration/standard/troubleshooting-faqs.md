...
### 3. Does Razorpay support Xamarin for SDK integration?
         ...
         No, we do not support Xamarin. However, since Xamarin is essentially a wrapper around Android and iOS, you can create your own Xamarin wrapper using our [Android](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard.md) and [iOS](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard.md) SDKs.  
...
### 7. Can I enable UPI Intent on my Android or iOS app?
         ...
         Yes, you can enable UPI Intent on your [Android](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/webview/upi-intent-android.md) or [iOS](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/webview/upi-intent-ios.md) app. 
