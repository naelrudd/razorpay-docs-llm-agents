...
### Prerequisites
         ...
         2. Integrate with the [Razorpay Android Standard Checkout SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard/integration-steps.md).
...
- Use the [Razorpay live keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#live-mode-api-keys) for prod testing.
...
### Step 4: Payment Flow
         ...
         Razorpay SDK will handle all the changes related to Turbo UPI internally. To integrate with the payment flow, [initiate payment and display the checkout form](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard/integration-steps.md#14-initiate-payment-and-display-checkout-form).
...
- `SERVER_ERROR`: Failure at PSP.
         ...
         [Refer to the list of possible error reasons](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard/payment-methods/turbo-upi/error-codes.md).
