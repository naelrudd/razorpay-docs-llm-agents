...
You can seamlessly integrate Turbo UPI with Razorpay Android Standard SDK. Explore the full potential of [Razorpay Turbo UPI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md) and know How it Works.
...
### Prerequisites
         ...
         1. **SDK Version Compatibility:**
             - Integrate with [Razorpay Android Standard SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard.md). Ensure that you integrate with SDK version 1.6.37 or higher.
         ...
         5. **Contact Prefill in Standard Checkout:**
             ...
             - Make sure your Checkout options include [**prefill contact**](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard/integration-steps.md#14-initiate-payment-and-display-checkout-form).
        

## Onboarding Flow

Ensure your customers [onboard with Razorpay Turbo UPI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md#onboarding-flow) to get started.
