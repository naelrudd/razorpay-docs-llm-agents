...
## Webhooks
Payments made using this method will also trigger webhooks much like regular payments. Refer our [Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md) documentation to learn how to use webhooks.
