...
The bank transfer payment method will appear for the [payment gateway](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/hosted.md) and products such as Payment Links, Payment Pages and Subscriptions.
...
You must subscribe to the `virtual_account.credited` webhook event on the Dashboard to receive notifications whenever customers make payments using bank transfers. Know how to [set up webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md#set-up-webhooks).
...
The bank transfer payment method will appear for the [payment gateway](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/hosted.md) and products such as Payment Links, Invoices and Subscriptions.
...
**Read More**: [List of parameters for Hosted Checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/hosted/integration-steps.md#1-build-integration).
