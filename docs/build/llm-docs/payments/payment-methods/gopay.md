...
- You can refund customer payments made using GoPay by following the usual [refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds.md) process.  
 
- GoPay payments take T+22 days to get settled to your Razorpay account.

### Supported Integrations

Secure [S2S integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/gopay/s2s-integration.md) for seamless payment processing.
