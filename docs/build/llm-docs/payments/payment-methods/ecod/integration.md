...
Step 4 described above involves creating an Invoice using Razorpay’s API. For creating an Invoice, you require the amount and the contact number of the customer. Know more about the [Invoice APIs](https://razorpay.com/docs/build/llm-docs/api/payments/invoices.md).
