...
- You can refund customer payments made using Klarna by following the usual [refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds.md) process.  
 
- Klarna payments take T+21 days to get settled to your Razorpay account.

### Supported Integrations

Secure [S2S integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/klarna/s2s-integration.md) for seamless payment processing.
