...
4. Verify the payment status either by polling Razorpay APIs or by[subscribing to Webhook events](https://razorpay.com/docs/build/llm-docs/webhooks.md).
...
2. Verify that the `virtual_account` feature enabled on your account.
    ...
    If you are already using the [Smart Collect](https://razorpay.com/docs/build/llm-docs/payments/smart-collect.md) product of Razorpay, this feature is enabled for your account. If you are not, then you must log in to Dashboard and complete the onboarding process of the Smart Collect product for the `virtual_account` feature to be enabled for your account.

    

3. Know about the [Virtual Accounts APIs](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect.md).
...
: `string` Unique identifier of the customer for whom UPI QR Code is created. Know more about the [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
...
: `object` Object consisting of key value pairs that allow you to store additional data. 
 Know more about[Notes](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes).
...
To know if the customer has made the payment or not, you can track the payment status either by polling the Razorpay servers or subscribing to [specific events generated in our system](https://razorpay.com/docs/build/llm-docs/webhooks.md).
