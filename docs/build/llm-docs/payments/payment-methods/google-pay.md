...
Google Pay™ option will only be visible to customers registered with an international phone number or international IP address. Along with that, they also need to save the card in their Google Pay™ app or wallet.
