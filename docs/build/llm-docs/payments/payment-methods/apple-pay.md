...
- Shopify, Mobile SDKs (Flutter, Native iOS, React Native) and Razorpay no-code solutions, such as [Payment Links](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md), [Payment Pages](https://razorpay.com/docs/build/llm-docs/payments/payment-pages.md), [Payment Handles (razorpay.me)](https://razorpay.com/docs/build/llm-docs/payments/mobile-app/accept-payments/razorpay-me.md) and [Invoices](https://razorpay.com/docs/build/llm-docs/payments/invoices.md).
...
### 8. I am not able to verify my URL via the self-serve dashboard. What should I do?
    ...
    Follow the [Apple Pay documentation](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/apple-pay.md) and ensure the file is publicly accessible.
...
- [Apple Pay Custom Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/apple-pay/custom-integration/web-sdk.md)
