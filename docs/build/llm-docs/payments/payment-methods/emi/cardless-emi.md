...
Following is the list of supported Payment Partners for Cardless EMI and the minimum order amount stipulated by them:
        ...
        ---
        [axio](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/cardless-emi/axio.md) | `walnut369` | ₹900 
        ---
...
Check the standard [interest rates charged by Banks/Partners](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/faqs.md#1-what-are-the-standard-interest-rates-charged).
...
Check the standard [interest rates charged by Pay Later Providers](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/faqs.md#2-what-are-the-standard-interest-rates-charged).
        ...
        Payment Partners | Provider Code | Minimum Order Amount 
        ---
        [ShopSe](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/cardless-emi/shopse.md) | `shopse` | ₹3000
        ---
        [Snapmint](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/cardless-emi/snapmint.md) | `snapmint` | None
...
See: [Cardless EMI FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/faqs.md#cardless-emi).
