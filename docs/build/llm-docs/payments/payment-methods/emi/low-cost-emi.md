...
You can create [Low Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/offers/low-cost-emi.md) for a selected issuer from your Dashboard. 
...
See: [Low Cost EMI FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/faqs.md#low-cost-emi).
