...
Following is the list of supported Payment Partners for Credit Card EMI and the minimum order amount stipulated by them:
   ...
   Check the standard [credit card interest rates charged by major banks](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/faqs.md#1-what-are-the-standard-credit-card-interest).
...
To fire this API, you must provide your [KEY_ID] for authorization. Your [KEY_SECRET] is not required and should not be passed. Know how to generate the [API Keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
...
[Credit Card EMI FAQs](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/faqs.md#credit-card-emi).
