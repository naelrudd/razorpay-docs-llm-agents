...
No additional integration is required to show Snapmint as a Cardless EMI service provider on your Standard Checkout integration. Know [how to integrate Snapmint as a payment method on custom checkout.](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom/payment-methods.md#cardless-emi)
