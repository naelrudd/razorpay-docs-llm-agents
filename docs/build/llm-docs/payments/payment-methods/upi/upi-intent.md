...
## Integrate on Android, iOS and Mobile Web
        ...
        Refer to the [list of supported UPI intent apps for Android SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/supported-apps.md).
        ...
        - [Generate API Keys](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md#generate-api-keys) from the Dashboard.
        ...
        1. Ensure that the [latest version of the iOS Standard SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard.md#list-of-razorpay-ios-standard-sdk-versions-last) is integrated with your app.
...
By default, the top PSP apps appear on the customer's mobile irrespective of the installation status of the UPI apps.
        ...
        - [Generate API Keys](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md) from the Dashboard.
        - Integrate Razorpay Standard Checkout on your [Website](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard.md).

        #### Standard Checkout

        UPI Intent for mobile websites works automatically if the intent flow is enabled on your account. You can enable UPI Intent in WebView on your [Android app](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/webview/upi-intent-android.md)or [iOS app](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/webview/upi-intent-ios.md).
...
- [UPI Error Codes](https://razorpay.com/docs/build/llm-docs/errors.md)
