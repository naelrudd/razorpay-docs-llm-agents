...
- [Onboarding Flow](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md#onboarding-flow)
- [Transactional Flow](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md#transactional-flow)
- [Non-Transactional Flow](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/turbo-upi.md#non-transactional-flow)
...
Perform the following steps to integrate Turbo UPI:
     ...
     - [Android Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard/payment-methods/turbo-upi.md)
     - [iOS Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard/payment-methods/turbo-upi.md)
    
    
     - [Android Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi.md)
     - [iOS Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi.md)
