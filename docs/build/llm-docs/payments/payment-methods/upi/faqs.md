...
### 3. Will this impact Standard, Custom and S2S Checkout?
     ...
     - [Standard Integration](https://razorpay.com/docs/build/llm-docs/announcements/upi-collect-migration/standard-integration.md).
     - [Custom Integration](https://razorpay.com/docs/build/llm-docs/announcements/upi-collect-migration/custom-integration.md)
     - [S2S Integration](https://razorpay.com/docs/build/llm-docs/announcements/upi-collect-migration/s2s-integration.md)
...
### 8. My UPI payments stopped working after UPI Collect was disabled. What should I do?
     ...
     If UPI Collect was disabled on your account and you have not enabled UPI Intent or QR code, your checkout may break and prevent customers from completing UPI payments.
            ...
            - Refer to the [Standard Checkout migration guide](https://razorpay.com/docs/build/llm-docs/announcements/upi-collect-migration/standard-integration.md) for more information.
