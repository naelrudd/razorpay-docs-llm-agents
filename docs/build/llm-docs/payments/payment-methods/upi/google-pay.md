...
- If you are an existing Razorpay user not covered by exemptions, you must migrate to UPI Intent or UPI QR code to continue accepting UPI payments. For detailed migration steps, refer to the [migration documentation](https://razorpay.com/docs/build/llm-docs/announcements/upi-collect-migration/standard-integration.md).
     ...
     1. You should have already integrated [Razorpay Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard.md).
     1. [Generate API Keys](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md#generate-api-keys) from the Dashboard.
...
This adds the dependencies for the SDK and creates a Google Pay UPI payment method on your Checkout form.
     ...
     This is same as [UPI Collect Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/payment-methods.md#collect-flow).
     ...
     **NPCI Restrictions for UPI Collect Flow**
     ...
     - UPI Collect Flow is not available for these MCCs. You can use [UPI Intent Flow](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/upi-intent.md) as an alternative.
        - 5816
        - 6540
        - 4812
        - 4814
...
Know more about [Google Pay Custom Checkout Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/google-pay/custom-integration.md).
