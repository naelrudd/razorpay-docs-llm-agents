...
- Integrate with [Razorpay Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins).
...
### 3. How can I identify UPI payments made using RuPay credit cards?
         ...
         1. **Payment Webhook**: The payment entity will now include the payer account type details. Refer to the [Payment Authorized Payload](https://razorpay.com/docs/build/llm-docs/webhooks/payments.md#payment-authorized).
         2. **Fetch Payment API**: The payment entity will now include the payer account type details. Refer to the [Fetch API sample code](https://razorpay.com/docs/build/llm-docs/api/payments.md#expanded-upi). 
