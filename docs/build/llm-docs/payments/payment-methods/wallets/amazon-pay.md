...
The wallet payment option can be used for a purchase amount of up to ₹20000 (2000000 in paise).
    ...
    To list external wallets on your web application, you need to first integrate our [Checkout form](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard.md). After you integrate, follow the steps given below:
