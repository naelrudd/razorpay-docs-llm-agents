...
The iOS integration for Amazon Pay is similar to the [Razorpay iOS Custom UI SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/custom.md) integration.
