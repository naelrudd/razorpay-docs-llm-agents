...
To list external wallet on your web application, you need to first integrate our [checkout form](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/integration-steps.md#checkout-options). After you integrate, follow the steps given below:
...
To list external wallets on your Android app, you need to first integrate our [Android checkout SDK](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard.md). After you integrate our Android checkout, follow the steps given below:
...
To list external wallet on your iOS app, you need to first set up your framework. Know more about[Razorpay iOS Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ios-integration/standard.md). Perform the following steps:
