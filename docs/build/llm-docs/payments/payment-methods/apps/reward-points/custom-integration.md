...
- Integrate Razorpay Custom Checkout on your [website](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom.md).
...
Follow the steps mentioned in the [Web Custom Integration document](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom.md). 
