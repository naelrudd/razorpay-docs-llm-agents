...
### 11. How can a business enable card payments on Razorpay?
         ...
         Businesses can enable card payments by signing up with Razorpay, completing the KYC process, and configuring the card payment option in the [dashboard](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/payment-methods.md#request-for-payment-methods).
