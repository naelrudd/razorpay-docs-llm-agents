...
DCC Custom Checkout payment flow is similar to the [S2S payment flow](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/dynamic-currency-conversion/s2s-integration.md).

### Related Information

- [DCC S2S Payment Flow](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/dynamic-currency-conversion/s2s-integration.md)
