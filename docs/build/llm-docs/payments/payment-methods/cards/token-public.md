...
: `string` Unique identifier of the customer. You can create a customer using [API](https://razorpay.com/docs/build/llm-docs/api/customers.md) or via the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/customers.md#create-a-customer).
...
All server-side requests must be [authenticated](https://razorpay.com/docs/build/llm-docs/api.md#authentication) with `Basic Auth` using the [KEY_ID] as username. You can generate your API keys on the [Dashboard](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
