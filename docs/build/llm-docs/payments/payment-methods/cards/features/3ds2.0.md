...
- Razorpay supports [3DS2 transactions on S2S](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/cards/3ds2.0.md).
