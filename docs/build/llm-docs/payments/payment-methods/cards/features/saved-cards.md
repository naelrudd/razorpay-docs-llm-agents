...
Know [how to integrate saved cards at Standard Checkout.](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/features/integrate-saved-cards.md)
...
3. They enter the OTP sent to their phone or use their fingerprint if [Biometric Authentication](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/features.md) biometric authentication is set up, then click **Verify**.
