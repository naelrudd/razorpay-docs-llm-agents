...
3. Understand the [payment process](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/how-it-works.md).
...
: `string` The unique identifier of the order created in [step 1](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/authentication/native-otp.md#creating-the-workflow-for-native-otp).
...
**Know More**: Know more about [API error codes](https://razorpay.com/docs/build/llm-docs/errors.md#error-response).
...
Know more about [Error Codes](https://razorpay.com/docs/build/llm-docs/errors/payments/payment-methods-error-parameters.md#cards).
