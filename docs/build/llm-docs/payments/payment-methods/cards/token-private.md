...
`customer_id`
: The unique customer ID. To create a customer, refer the [Customer API](https://razorpay.com/docs/build/llm-docs/api/customers.md) section.
...
All server-side requests must be authenticated with Basic Auth using the **key-id** as username and **key-secret** as password. You can acces your keys on your Dashboard. Know more about [API authentication](https://razorpay.com/docs/build/llm-docs/api.md#authentication) to get started with Razorpay APIs.
