...
- Configure [payment capture settings](https://razorpay.com/docs/build/llm-docs/payments/payments.md#dashboard-actions) on the Dashboard.
- Follow the [Razorpay S2S Integration documentation](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/redirect.md).
...
- [Fetch Payments API](https://razorpay.com/docs/build/llm-docs/api/payments.md#fetch-multiple-payments)
- [Payments Webhooks (Recommended)](https://razorpay.com/docs/build/llm-docs/webhooks/payments.md#payments)
- [Orders Webhooks (Recommended)](https://razorpay.com/docs/build/llm-docs/webhooks/orders.md#orders)
