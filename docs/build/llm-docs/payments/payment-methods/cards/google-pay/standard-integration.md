...
- You should have already integrated [Razorpay Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/standard.md) on your Android app.
