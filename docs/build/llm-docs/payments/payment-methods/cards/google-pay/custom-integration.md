...
1. [Show Google Pay as a separate option when Google Pay is set-up on your customer’s device](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/google-pay.md#onboarding-and-integration).
...
## Prerequisites
- You should have already integrated [Razorpay Custom Checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom.md) on your Android app.
- Complete the onboarding process mentioned [here](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/google-pay.md).
...
Know [how to integrate the different payment methods](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/android-integration/custom/payment-methods.md) using Razorpay Android Custom SDK in detail.
