...
`customer_id`
: `string` This is the Razorpay customer id. You can create token for a specific customer using their customer id. Use the [Customers API](https://razorpay.com/docs/build/llm-docs/payments/customers.md) to create customer id. This is an optional parameter.
...
The `service_provider_tokens` object is an on-demand feature, made available only to PCI DSS compliant businesses.
 ...
 Know about the complete list of [token states](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/token-hq/merchant-requestor-with-network-tokens/token-lifecycle.md).
...
: `string` The overall status for the token. Possible values:
 ...
 Know about the complete list of [token states](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/token-hq/merchant-requestor-with-network-tokens/token-lifecycle.md#overall-token-states).
...
: `string` The unique identifier of the order created for this payment. Create an order using the [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md).
...
Know more about the [S2S Integration payment flow](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/json/v2.md).
