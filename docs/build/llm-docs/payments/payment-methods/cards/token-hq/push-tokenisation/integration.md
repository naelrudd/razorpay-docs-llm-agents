...
For more information, refer [Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard.md)
...
Refer to the [Fetch Token API](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/token-private.md) document for more information.
...
For more information, refer to the [S2S Integration - Tokenisation APIs](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/token-hq/merchant-requestor/apis.md) documentation.
...
### Step 1 - Fetching Customer Tokens
     ...
     To be able to create tokens using Push Tokenisation, you must create a customer using phone number as the primary identifier. For more details, refer [Create a Customer API](https://razorpay.com/docs/build/llm-docs/api/customers/create.md). 
...
2. Webhook Setup:
    - Watch this [tutorial video](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md) for detailed steps on setting up the webhook.
