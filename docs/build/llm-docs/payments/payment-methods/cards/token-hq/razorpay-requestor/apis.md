...
`customer_id`
: `string` This is the Razorpay customer id. You can create token for a specific customer using their customer id. Use the [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md) to create customer id.
...
- [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md)
- [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md)
- [Server-to-Server JSON V2 Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/json/v2.md)
