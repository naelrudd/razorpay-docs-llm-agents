...
### Entity Parameters
      ...
      `customer_id`
      : `string` This is the Razorpay customer id. You can create token for a specific customer using their customer id. Use the [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md) to create customer id. This is an optional parameter.
...
### Request Parameters
      ...
      : `string` The unique identifier of the customer created using [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
