...
- [Set up](https://razorpay.com/docs/build/llm-docs/payments/set-up.md#sign-up) your Razorpay account.
- Log in to the Dashboard.
- The Dashboard has [test and live modes](https://razorpay.com/docs/build/llm-docs/payments/dashboard/test-live-modes.md). Payment Buttons created in the test mode do not appear in the live environment. **You must create a new Payment Button in live mode**.
...
7. Select the payment method of your choice to proceed with the payment. 
            ...
            You can use these [test card details](https://razorpay.com/docs/build/llm-docs/payments/payments/test-card-details.md#test-cards).
        
        
            You can use these [test UPI details](https://razorpay.com/docs/build/llm-docs/payments/payments/test-card-details.md#test-upi-id).
...
You can ensure that your customers receive payment receipts via email once they complete the payment. Know how to [send and download automated or manual payment receipts](https://razorpay.com/docs/build/llm-docs/payments/payment-button/receipt.md).

If you are an NGO, you can [send and download payment receipts with 80-G information](https://razorpay.com/docs/build/llm-docs/payments/payment-button/80g-receipt.md).
...
You can view the payments as and when they are made in the [Transactions Details View](https://razorpay.com/docs/build/llm-docs/payments/payment-button/view-reports.md) of the page.
...
### Related Information
- [Payment Button](https://razorpay.com/docs/build/llm-docs/payments/payment-button.md)
- [How Payment Button Works](https://razorpay.com/docs/build/llm-docs/payments/payment-button/how-it-works.md)
- [Payment Button States](https://razorpay.com/docs/build/llm-docs/payments/payment-button/states.md)
- [Quick Pay Button](https://razorpay.com/docs/build/llm-docs/payments/payment-button/quick-pay.md)
- [Buy Now Button](https://razorpay.com/docs/build/llm-docs/payments/payment-button/buy-now.md)
- [Donations Button](https://razorpay.com/docs/build/llm-docs/payments/payment-button/donations.md)
- [Manage Payment Button](https://razorpay.com/docs/build/llm-docs/payments/payment-button/manage.md)
- [Prefill Amount Fields](https://razorpay.com/docs/build/llm-docs/payments/payment-button/manage/prefill-amount-fields.md)
- [Search for a Payment Button](https://razorpay.com/docs/build/llm-docs/payments/payment-button/search.md)
- [View Reports](https://razorpay.com/docs/build/llm-docs/payments/payment-button/view-reports.md)
