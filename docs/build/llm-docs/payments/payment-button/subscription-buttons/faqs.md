...
You cannot setup a one-time payment subscription button. For one-time payment, please use [Payment Button](https://razorpay.com/docs/build/llm-docs/payments/payment-button.md).
...
You can view the payments as and when they are made in the [Transactions Details View](https://razorpay.com/docs/build/llm-docs/payments/payment-button/view-reports.md) of the Subscription Button.
...
Raise a request on the Dashboard to display more [payment methods](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/payment-methods.md#request-for-payment-methods-and-support) on Checkout.
...
You can accept payments in international currency using Subscription Button. Refer to the [list of supported currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies). Follow these steps:
