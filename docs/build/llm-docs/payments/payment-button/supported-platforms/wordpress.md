...
3. Navigate to **Settings** → **API Keys** and [generate API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) in the test mode.
...
- [Create a WordPress Website](https://razorpay.com/docs/build/llm-docs/payments/payment-button/supported-platforms/wordpress/create-website.md)
- [Payment Button Elementor Plugin for WordPress](https://razorpay.com/docs/build/llm-docs/payments/payment-button/supported-platforms/wordpress/elementor.md)
- [Payment Button SiteOrigin Plugin for WordPress](https://razorpay.com/docs/build/llm-docs/payments/payment-button/supported-platforms/wordpress/site-origin.md)
- [Payment Button Visual Composer Plugin for WordPress](https://razorpay.com/docs/build/llm-docs/payments/payment-button/supported-platforms/wordpress/visual-composer.md)
