...
As consumers or buyers, you get the option to make payments through the [Razorpay payment gateway](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway.md). On selecting Razorpay, various payment methods will be displayed at the Razorpay checkout to complete the payment.
