...
Integrate with [Razorpay Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/third-party-validation.md#integration-flow). No additional integration is required for Outward Remittances.
