...
`currency` _mandatory_
: `string` Currency code for the currency in which you want to accept the payment. For example, `INR`. Refer to the [list of supported currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments/outward-remittances/s2s-integration/supported-currencies.md). Length must be of 3 characters.
...
[Step 2: Test Integration](https://razorpay.com/docs/build/llm-docs/payments/international-payments/outward-remittances/s2s-integration/test-integration.md)
