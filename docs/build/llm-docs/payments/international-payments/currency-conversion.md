...
### Sample Code
        ...
        : `string` Currency in which you want to accept the payment. For example, `GBP`. Check the [supported international currencies.](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-products-and-currencies)
        ...
        For example, when selling a product for 1000 in the domestic market, you pass INR in the `currency` parameter and `100000` in the `amount` parameter (since the amount should be in sub units).
...
### Payment Entity
         ...
         The [Payment entity](https://razorpay.com/docs/build/llm-docs/api/payments.md#payment-entity) will contain additional fields when the currency is not INR to provide visibility into the conversion rate.
