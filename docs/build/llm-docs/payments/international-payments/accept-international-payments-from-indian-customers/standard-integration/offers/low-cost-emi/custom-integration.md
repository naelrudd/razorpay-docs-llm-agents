...
You can decide the cost to subvent for each EMI tenure while [creating an offer](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create.md) and the customer bears the remaining cost. This approach ensures that customers enjoy the benefits of EMI at an affordable cost, helping you minimise the overall cost.

**INFO**

**New to Custom Checkout Integration?**

If yes, know more about the [custom integration flow](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom.md).

## Prerequisites

Before integrating Low Cost EMI offers for your custom Checkout, run through this checklist:

1. Understand the [payment flow](https://razorpay.com/docs/build/llm-docs/payments/payments.md#payment-life-cycle).
2. Generate the API keys from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings.md#api-keys).
...
The procedure for integrating Custom Checkout on your website is explained in the [Custom Integration document](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom.md). However, the procedure varies while passing the offers in the payment details.
...
You can create a Low Cost EMI offer from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create.md).
...
This is mandatory only in cases where you want to associate an offer or offers with the Order or you had not selected the [Show Offer on Checkout](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create.md#offer-validity) while creating the offer from the Dashboard.
...
For example, you can view the image below to see how Low Cost EMI offers appear on [Razorpay Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/low-cost-emi.md).
...
- By polling our [payment APIs](https://razorpay.com/docs/build/llm-docs/api.md#fetch-payments-based-on-orders).
...
- [Create Low Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create.md)
- [Tutorial - How to Create Low Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/tutorial.md)
