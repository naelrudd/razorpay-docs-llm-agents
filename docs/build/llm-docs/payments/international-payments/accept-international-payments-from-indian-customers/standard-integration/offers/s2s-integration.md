...
[Create an offer](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create.md) from the Dashboard.
...
Know more about the [error codes](https://razorpay.com/docs/build/llm-docs/api.md#error-codes).
