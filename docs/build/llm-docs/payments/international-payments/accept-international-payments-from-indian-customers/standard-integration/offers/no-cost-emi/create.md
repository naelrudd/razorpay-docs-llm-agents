...
## Steps to Create No Cost EMI Offers

Watch this video to see how to create a No Cost EMI offer.
...
4. Select **EMI**.
5. Select the payment option you created the offer on from the Dashboard. Enter the required [test details](https://razorpay.com/docs/build/llm-docs/payments/payments/test-card-details.md).
...
4. In the pane that appears, go to the **Status** field, click **Disable**.
...
Know more about [integrating No Cost EMI Offers with Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/standard-integration.md).
