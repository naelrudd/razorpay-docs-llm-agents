...
No Cost EMI is an offer by which your customer pays the EMI provider only the product price, which is equally divided over the repayment timeline. Know more about [No Cost EMIs](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/no-cost-emi.md) as a Razorpay payment method. 
...
- [Create No Cost EMI Offers from the Dashboard](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/create.md)
- [Integrate No Cost EMI Offers with Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/standard-integration.md)
- [Tutorial on How to Create No Cost EMI Offers](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/tutorial.md)
...
- [EMI²](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/emi².md)
