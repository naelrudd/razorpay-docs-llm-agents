...
4. Select **EMI**.
5. Select the payment option you created for the offer on from the Dashboard. Select the EMI plan and enter the required [test details](https://razorpay.com/docs/build/llm-docs/payments/payments/test-card-details.md).
6. Click **Pay via EMI**
...
Know more about [integrating Low Cost EMI Offers with Standard Checkout](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/standard-integration.md).
