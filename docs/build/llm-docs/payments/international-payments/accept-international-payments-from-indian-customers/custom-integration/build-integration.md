...
```json: Failure - Address Line
{
  "error": {
    "code": "BAD_REQUEST_ERROR",
    "description": "Address line 1 and line 2 can only contain alphanumeric characters and limited special characters",
    "metadata": {},
    "reason": "input_validation_failed",
    "source": "business",
    "step": "payment_initiation"
...
Know more about [sample codes for various payment methods](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom/payment-methods.md) and [supported payment methods](#supported-payment-methods).
...
```
    ...
    Following payment methods are supported under the Import Flow:
      ...
      - UPI
      - Cards
      - [Recurring](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/custom-integration/recurring-payments.md) 
...
[Step 2: Test Integration](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/custom-integration/test-integration.md)
