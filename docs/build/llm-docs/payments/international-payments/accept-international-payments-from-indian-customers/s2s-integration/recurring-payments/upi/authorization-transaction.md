...
If the payment request is valid, the response contains the following fields. Refer to the [UPI Intent Flow document](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/upi/intent.md#step-2-initiate-a-payment) for more details.
...
### Next Steps by Platform
      ...
      Use the link returned in the response as a deeplink to redirect the customer to their preferred UPI app to complete the mandate registration. See [UPI Intent on iOS - S2S](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi/upi-intent/s2s-integration.md).
