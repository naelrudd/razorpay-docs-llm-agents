...
### 18. Is QR Code supported for UPI Autopay?
     ...
     Yes, [QR Code](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/upi/qr-codes.md) is supported on Standard Checkout to collect Recurring Paymennts. The customers can scan the QR using any PSP app and make the payment.
