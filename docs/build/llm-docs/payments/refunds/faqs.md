...
### 1. How do I initiate a refund?
       ...
       - [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/refunds/issue.md#issue-refunds).
       - [APIs](https://razorpay.com/docs/build/llm-docs/api/refunds.md).
...
### 3. I am unable to refund a payment. What do I do?
       ...
       If your current balance is less than the amount you are trying to refund, you can either initiate the refund once you receive further payments or you can [add funds](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings.md#add-funds) to your account from the Dashboard.
