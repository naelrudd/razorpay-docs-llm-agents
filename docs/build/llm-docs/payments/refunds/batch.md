...
: `string` The speed at which the refund should be processed. Possible values: 
    ...
    - `optimum` : Instant Refunds. If it is not possible to process the refund instantly, we will process the refund in 5-7 working days. Know more about [Instant Refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds/instant.md).
