...
You can create registration links using APIs. Refer to the [API section](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments.md) for more details.
