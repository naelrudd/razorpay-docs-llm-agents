...
### 1. Which banks have enabled Recurring Payments through Cards?
       ...
       Refer to the [list of banks that support cards](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/cards/supported-banks.md).
...
### 4. Can we continue to process recurring payments through card tokens of banks that are not yet available for Recurring Payments on Cards?
       ...
       All the card tokens of the banks that are not yet available for Recurring Payments on cards are put in a `paused` state. You cannot debit these mandates. Please contact your customers and register new mandates using other methods such as UPI or Emandate. Know more about other [Recurring Payments methods](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments.md). Alternatively, use [Payment Links](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md) from the Dashboard or Razorpay [Mobile App](https://razorpay.com/docs/build/llm-docs/payments/mobile-app.md) and collect payment from customers on the due date.
...
### 6. Are there any changes in the APIs for processing card-based mandates?
       ...
       There are no changes in the existing integration flow. However, we have added a few optional token parameters to the **Create Order API**. If these parameters are not passed in the request, the default values are assumed. Know more about [Recurring Payments APIs](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/cards/create-authorization-transaction.md#112-create-an-order).
...
Businesses should initiate the debit. The banks and Razorpay take action on the rest of the process.
       ...
       To process subsequent debits above ₹15,000 (upto ₹1,00,000 for [certain merchant categories](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/cards/faqs.md#8-is-there-a-maximum-monetary-limit-for)):
...
### 13. What is the TAT for processing debits of cards mandates?
       ...
       - For processing debits **above ₹15,000** (upto ₹1,00,000 for [certain merchant categories](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/cards/faqs.md#8-is-there-a-maximum-monetary-limit-for)), the amount will be debited as soon as the customer provides consent through AFA, which has a validity of 72 hours.
...
### 15. Can I cancel a card mandate?
       ...
       - [From the Dashboard](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/create.md#delete-the-token)
       - [Using APIs](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/cards/tokens.md#23-delete-tokens)
