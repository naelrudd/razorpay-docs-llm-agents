...
To charge tokens using the batch upload feature, you will first need the list of [Tokens](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/create.md#3-search-for-the-token) for which recurring payments are to be created.
...
1. Add the required data. Know more about the Batch Fields from the [below table](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/batch-operations.md#charge-token-batch-fields).
1. Upload the file to the Dashboard.
...
### Related Information
- [Create Recurring Payments](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/create.md)
- [Paper NACH Form](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/upload-paper-nach-form.md)
