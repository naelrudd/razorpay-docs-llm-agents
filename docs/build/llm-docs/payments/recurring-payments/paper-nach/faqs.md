...
### 1. How can I create physical mandates?
         ...
         You can generate and submit physical mandates from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/create.md) or [using our APIs](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments.md).
