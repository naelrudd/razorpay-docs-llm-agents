...
### Phase 1: Mandate Registration
         ...
         [Mandate Registration →](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/upi/integrate.md#1-mandate-registration)
...
### Phase 2: Fetch Token
         ...
         [Token Fetch →](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/upi/integrate.md#2-fetch-mandate-registration-details)
...
### Phase 3: Subsequent Debits
     ...
     [Charge Subsequent Payments →](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/upi/integrate.md#3-charge-customers)
...
Given below are the steps to proceed with UPI Autopay.
        ...
        If you are new to Razorpay, [set up your account](https://razorpay.com/docs/build/llm-docs/payments/set-up.md) to start accepting payments using UPI Autopay.
...
**Recommendations:**
- Use **Subscriptions** for predictable, fixed-amount recurring billing. Know more about [Razorpay Subscriptions](https://razorpay.com/docs/build/llm-docs/payments/subscriptions.md).
...
### UPI Autopay
         ...
         **Available Integrations** 
         ...
         ---
         Standard Checkout | [Link to Guide](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/upi/create-authorization-transaction.md)
         ---
         Custom Checkout | [Link to Guide](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/custom/upi/create-authorization-transaction.md)
         ---
         S2S APIs | [Link to S2S Guide](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/upi/authorization-transaction.md)
...
### UPI TPV (Third Party Validation)
         ...
         Integrations | Docs Link
         ---
         Standard Checkout | [Link to Guide](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/upi-tpv/create-authorization-transaction.md)
         ---
         Custom Checkout | [Link to Guide](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/custom/upi-tpv/create-authorization-transaction.md)
         ---
         S2S APIs | [Link to Guide](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/upi-tpv/authorization-transaction.md)
...
### UPI OTM (One Time Mandate)
         ...
         **Example** 
         ...
         Integrations | Docs Link
         ---
         Standard Checkout | [Link to Guide](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/upi-otm/authorization-transaction.md)
         ---
         Custom Checkout | Not Applicable
         ---
         S2S APIs | [Link to S2S Guide](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/authorization-transaction.md)
