...
Yes. You can use the QR Code to accept Recurring payments in any of our [supported international currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies).
