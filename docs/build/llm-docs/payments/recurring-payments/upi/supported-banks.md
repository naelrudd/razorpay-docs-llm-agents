...
Refer to the [list of supported MCCs, issuing banks and PSP applications](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/supported-banks-apps.md#supported-mccs).
...
- [Recurring Payments APIs for UPI](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/upi/apis.md)
