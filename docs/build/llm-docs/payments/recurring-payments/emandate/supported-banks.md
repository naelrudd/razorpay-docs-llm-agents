...
Use the **Methods API** endpoint to fetch the list of banks that support Emandate payments using Netbanking, Aadhaar and Debit card authorisation types. Know more about [authentication types](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/emandate/integrate.md#12-complete-authentication).
