...
- At present, Magic Checkout is available only on [Web](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/web.md), [Android](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/android-integration.md), [iOS](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/ios-integration.md), [React Native Android](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/react-native-android-integration.md), [React Native iOS](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/react-native-ios-integration.md), [Flutter](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/flutter-integration.md), [Capacitor](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/capacitor-integration.md), [WooCommerce](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/woocommerce.md) and [Shopify](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/shopify.md) integrations.
...
### Prerequisites
         ...
         - [Generate test API keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) on the Dashboard. 
...
- [How Magic Checkout Works](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/how-it-works.md)
- [Use Cases](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/use-cases.md)
- [Features](https://razorpay.com/docs/build/llm-docs/payments/magic-checkout/features.md)
