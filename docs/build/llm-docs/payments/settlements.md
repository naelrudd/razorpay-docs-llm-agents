...
- Your account must be fully activated for payments to be settled to your bank account. Know more about [KYC Verification](https://razorpay.com/docs/build/llm-docs/payments/set-up.md#2-submit-kyc-details).
- The payment must be captured. Know more about [capturing payments](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md).

## Settlement Cycle

We automatically settle captured payments to the bank account you submitted to us during your [KYC verification](https://razorpay.com/docs/build/llm-docs/payments/set-up.md#2-submit-kyc-details) following our settlement cycle. The settlement cycle is subject to bank approval and can vary based on your business vertical, risk factors and so on.
...
Razorpay allows you to accept payments in any of the [supported international currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies).
...
- [View settlement details](https://razorpay.com/docs/build/llm-docs/payments/settlements/dashboard.md#view-settlements-using-dashboard)
- [Check settlements break-up](https://razorpay.com/docs/build/llm-docs/payments/settlements/dashboard.md#settlements-break-up-description)
- [Enable settlements on hold](https://razorpay.com/docs/build/llm-docs/payments/settlements/dashboard.md#enable-settlements-placed-on-hold)
- [View reports related to settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements/dashboard.md#reports)

### Related Information

- [Settlements APIs](https://razorpay.com/docs/build/llm-docs/payments/settlements/apis.md)
- [Settlement FAQs](https://razorpay.com/docs/build/llm-docs/payments/settlements/faqs.md)
