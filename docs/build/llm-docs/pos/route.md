...
You should add Linked Accounts using [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md#add-and-manage-linked-accounts).
...
1. After login, you should add linked accounts to start using Route. Refer to the [Linked Accounts](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md) page for more information.
...
Know more about [Route](https://razorpay.com/docs/build/llm-docs/payments/route.md) and the [Dashboard actions](https://razorpay.com/docs/build/llm-docs/payments/route/batch-upload.md).

### Related information

[Route Use Cases](https://razorpay.com/docs/build/llm-docs/payments/route/use-cases.md)
