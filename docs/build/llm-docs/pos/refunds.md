...
You can use [Normal Refunds](https://razorpay.com/docs/build/llm-docs/payments/refunds/normal.md) to refund payments to your customers. The amount is refunded within 5-7 working days.

## Dashboard Actions

You can perform the following actions on refunds from the Dashboard:

- [View Refunds](https://razorpay.com/docs/build/llm-docs/pos/refunds/view.md)
- [Issue Refunds](https://razorpay.com/docs/build/llm-docs/pos/refunds/issue.md)
- [View Settlement Details of a Refund](https://razorpay.com/docs/build/llm-docs/pos/refunds/view.md#view-settlement-details-of-a-refund)
...
Detailed insights can be gained using reports and real-time data on the Dashboard. These reports can then be used for accounting and recon purposes. Know more about [reports](https://razorpay.com/docs/build/llm-docs/payments/dashboard/reports.md).

Understand [how the Refund process works](https://razorpay.com/docs/build/llm-docs/payments/refunds/normal.md#how-normal-refunds-work).

### Related Information

- [Handle refund errors](https://razorpay.com/docs/build/llm-docs/pos/refunds/errors.md)
- [Refunds API](https://razorpay.com/docs/build/llm-docs/pos/refunds/apis.md)
