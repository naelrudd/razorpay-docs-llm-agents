...
`Transfer`
: Transfers made if any, Transfers are payouts made to your [linked accounts](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md). 
...
Detailed insights can be gained using reports and real-time data on the Dashboard. These reports can then be used for accounting and reconciliation purposes. Know more about [reports.](https://razorpay.com/docs/build/llm-docs/pos/dashboard/reports.md)

### Related Information

- [About Settlements](https://razorpay.com/docs/build/llm-docs/pos/settlements.md)
