...
Know more about [supported banks for EMI](https://razorpay.com/docs/build/llm-docs/pos/payment-methods/emi/emi-by-razorpay.md).
...
There are certain error codes specific to each payment method supported by Razorpay. Know more about the [Payment Method Error Codes](https://razorpay.com/docs/build/llm-docs/errors/payments/payment-methods-error-parameters.md).
