...
Detailed insights can be gained using reports and real-time data on the Dashboard. These reports can then be used for accounting and recon purposes. Know more about [reports](https://razorpay.com/docs/build/llm-docs/pos/dashboard/reports.md).

### Related Information

[About Orders](https://razorpay.com/docs/build/llm-docs/pos/orders.md)
