...
### 1. How do I download Razorpay DigiPOS?
...
### 5. Who should have the username and password credentials?
...
### 6. How do I change my store's user credentials?
...
### 7. Can I install DigiPOS on all Apple devices?
...
### 8. What payment modes are supported on DigiPOS v1?

         DigiPOS v1 supports full-swipe card payments, UPI, Bank EMI, Apple brand EMI, and SMS Payment Links.
        

    
### 9. Is Exchange flow supported on DigiPOS?

         Yes, exchange flow is supported on DigiPOS.
        

    
### 10. What are the steps to do an Exchange transaction on DigiPOS?
...
### 11. What transaction amount should I enter for an exchange transaction?

         Enter the original amount minus the value of the old device being exchanged.
        

    
### 12. I cannot find the Exchange flow on the DigiPOS app.
...
### 1. Do I need another device apart from iPhone or iPad to accept payments?
...
### 4. I am facing issues with the DigiPOS device. How do I fix them?

         We apologise for the inconvenience. Contact your Razorpay Key Account Manager for a DigiPOS device replacement within 2 days, or email  digipos-support@razorpay.com  with your concerns and our team will respond within a business day. Meanwhile, please ensure you fully charge the DigiPOS device.
        

    
### 5. Can I void a transaction from my iPad?
...
### 6. How can I share the charge slip of the payment with customers?
...
### 8. How will I know whether my DigiPOS device is connected to my iPad?
...
### 9. Can I initiate a card transaction without being connected to a DigiPOS device?
...
### 10. How can I get Apple Brand EMI enabled on DigiPOS device?
...
### 1. How will I receive Settlements?
...
### 2. What transaction details are included in the Offer Settlement Report?
...
### 3. When will I receive the funds and the report?
...
### 4. Will UTR be shared in the Offer Settlement Report?

         Yes, the UTR will be included in the Offer Settlement Report as proof of settlement for easy reconciliation.
        

    
### 5. How can I view the transaction details for all my stores in one place?
...
### 6. How can I create a username and password for the Dashboard?
...
### 7. I have forgotten my username and password for the Dashboard. How can I recover them?
...
### 8. Is it possible to integrate DigiPOS with my billing software?
