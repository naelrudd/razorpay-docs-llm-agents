...
- [Issue a refund for a payment](https://razorpay.com/docs/build/llm-docs/pos/refunds/issue.md)
- [View details of a payment](https://razorpay.com/docs/build/llm-docs/pos/payments/dashboard.md#view-payment-details)
- [View settlement details of a payment](https://razorpay.com/docs/build/llm-docs/pos/settlements/dashboard.md#view-settlements-using-dashboard)
