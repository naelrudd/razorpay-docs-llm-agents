...
- [View orders](https://razorpay.com/docs/build/llm-docs/pos/orders/dashboard.md#view-order-details)
- [View reports related to orders](https://razorpay.com/docs/build/llm-docs/pos/orders/dashboard.md#reports)
