...
- [View settlement details](https://razorpay.com/docs/build/llm-docs/pos/settlements/dashboard.md#view-settlements-using-dashboard)
- [Check settlements break-up](https://razorpay.com/docs/build/llm-docs/pos/settlements/dashboard.md#settlements-break-up-description)
- [Enable settlements on hold](https://razorpay.com/docs/build/llm-docs/pos/settlements/dashboard.md#enable-settlements-placed-on-hold)
- [View reports related to settlements](https://razorpay.com/docs/build/llm-docs/pos/settlements/dashboard.md#reports)

### Related Information

- [Settlement FAQs](https://razorpay.com/docs/build/llm-docs/pos/settlements/faqs.md)
