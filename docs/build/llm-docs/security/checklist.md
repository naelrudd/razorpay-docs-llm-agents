...
- Implement [Two-Factor Authentication (2FA)](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#2-step-verification-team-level) across your team for additional security.
...
- The [Razorpay API secret](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) is not included in the final Android or iOS build.
...
While integrating with our [Payments API](https://razorpay.com/docs/build/llm-docs/api/payments.md), ensure that you:
- Use the [Capture a Payment API](https://razorpay.com/docs/build/llm-docs/api/payments.md#capture-a-payment) to assert the payment status.
- Fetch the amounts of captured payments only from the backend or a trusted source.

### Orders API

While integrating with our [Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md), ensure that:

- [Payments are auto-captured](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md#auto-capture-all-payments) from the Dashboard.
...
- [Razorpay IPs](https://razorpay.com/docs/build/llm-docs/security/whitelists.md#webhook-ips) are added to all the whitelisted webhook requests.
...
- Define [user roles](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#standard-user-roles) for team members based on their usage of the Dashboard.
- Implement [Two-Factor Authentication (2FA)](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#2-step-verification-team-level) on all your Razorpay accounts.
- Never share Razorpay Two-Factor Authentication OTPs among employees.

## Plugin Integration

Implement the below best practices while integrating with Razorpay using [third-party plugins](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/ecommerce-plugins.md).
...
- [Razorpay Security](https://razorpay.com/docs/build/llm-docs/security.md)
- [Shared Responsibility Model](https://razorpay.com/docs/build/llm-docs/security/shared-responsibility-model.md)
