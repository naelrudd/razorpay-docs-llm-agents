...
We highly recommend using [Webhook Signature](https://razorpay.com/docs/build/llm-docs/webhooks.md#validation) to validate the integrity of the webhooks, even if you have whitelisted our Webhook IPs.
