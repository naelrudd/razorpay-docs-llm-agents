...
You can also manually disable webhooks from the Dashboard. Know more about [Payments Deactivation](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md#enable-disable-a-webhook) and [RazorpayX Deactivation](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payouts.md#deactivation).
