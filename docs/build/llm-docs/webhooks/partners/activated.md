...
Refer to the [Appendix](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md#business-type) for `business_type` parameter values.
