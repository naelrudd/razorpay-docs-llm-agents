...
### 1. What is the Razorpay n8n Community Node?
      ...
      View [Getting Started Guide](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node.md).
...
### 3. What operations are available in the node?
      ...
      View [Complete Operations Reference](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/operations-reference.md) to know about the available operations.
...
### 3. I get a "Bad Request" error when creating a Payment Link. What is wrong?
      ...
      **Fix**: 
      ...
      3. Check [Operations Reference](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/operations-reference.md) for required fields.
...
- [Install the Node](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/installation.md)
- [Explore Use Cases](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/use-cases.md)
- [View Operations](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/operations-reference.md)
