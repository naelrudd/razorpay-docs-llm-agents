...
#### Understand Key Types
    ...
    **For Development & Testing**
    ...
    - Free to use
    - Use [test cards](https://razorpay.com/docs/build/llm-docs/payments/payments/test-card-details.md)
...
- Choose the [operation](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/operations-reference.md) you want to perform (Create Order, Fetch Payment and so on.)
...
- Check API Documentation: Refer to [Razorpay API documentation](https://razorpay.com/docs/build/llm-docs/api.md) for detailed parameter information.
- Use Webhooks: Consider setting up [Razorpay webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md) for real-time payment updates in your workflows.

### Related Documentation

- [Explore Use Cases & Examples](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/use-cases.md)
- [View Available Operations](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/operations-reference.md)
- [Frequently Asked Questions](https://razorpay.com/docs/build/llm-docs/razorpay-n8n-node/troubleshooting-faqs.md)
- [Set up Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md)
