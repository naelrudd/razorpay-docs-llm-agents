...
Restart your AI assistant application after configuration. You should see [Razorpay MCP tools](https://razorpay.com/docs/build/llm-docs/mcp-server/tools-reference.md) become available. Test the connection by asking: **Show me available Razorpay tools**.
...
2. **Configure Advanced Options**: See [Configuration Guide](https://razorpay.com/docs/build/llm-docs/mcp-server/configuration.md) for detailed settings.
3. **Review Use Cases**: Check [practical examples](https://razorpay.com/docs/build/llm-docs/mcp-server/use-cases.md) that leverage local-only tools.
