...
- You can download a copy of our [TLS certificate](https://razorpay.com/docs/build/llm-docs/security/whitelists.md#ssl-certificates).
...
Know more about [API authentication](https://razorpay.com/docs/build/llm-docs/api/authentication.md).
...
Know more about [fraud protection for customers](https://razorpay.com/docs/build/llm-docs/security/customers.md#fraud-and-risk).

## Firewall

If you want to limit or authenticate ingress/egress to Razorpay, we provide a list of IP addresses for APIs and Webhooks.

- Razorpay API requests are resolved to these [IP addresses](https://razorpay.com/docs/build/llm-docs/security/whitelists.md#api-ips).
- Razorpay webhooks use these [IP addresses](https://razorpay.com/docs/build/llm-docs/security/whitelists.md#webhook-ips).
...
- [Business Security Checklist](https://razorpay.com/docs/build/llm-docs/security/checklist.md)
- [Shared Responsibility Model](https://razorpay.com/docs/build/llm-docs/security/shared-responsibility-model.md)
- [Security For Customers](https://razorpay.com/docs/build/llm-docs/security/customers.md)
