...
### Features
     ...
     Transform your payment operations with AI-powered automation:
      ...
      Explore [Use Cases & Examples](https://razorpay.com/docs/build/llm-docs/mcp-server/use-cases.md).
...
View [Complete Tools Reference](https://razorpay.com/docs/build/llm-docs/mcp-server/tools-reference.md).
...
### Remote MCP Server (Recommended)
     ...
     Get Started with [Razorpay Remote MCP Server](https://razorpay.com/docs/build/llm-docs/mcp-server/remote.md).
...
### Local MCP Server
     ...
     Get Started with [Razorpay Local MCP Server](https://razorpay.com/docs/build/llm-docs/mcp-server/local.md).
    

## Get Started

1. **Choose Your Deployment**: Select between [Remote (recommended)](https://razorpay.com/docs/build/llm-docs/mcp-server/remote.md) or [Local MCP Server](https://razorpay.com/docs/build/llm-docs/mcp-server/local.md).
2. **Set Up Prerequisites**: Install required tools (Node.js for Remote, Docker for Local).
3. **Get API Keys**: Generate Razorpay API keys from your Razorpay Dashboard. Alternatively, use [OAuth](https://razorpay.com/docs/build/llm-docs/mcp-server/oauth.md).
