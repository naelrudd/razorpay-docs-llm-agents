...
Create Razorpay [QR Codes](https://razorpay.com/docs/build/llm-docs/payments/qr-codes.md) and share them with customers to accept digital payments.
...
Fork the Razorpay Postman Public Workspace and try the QR Codes (Image Content) APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
