...
```bash: CLI
razorpay qr-codes payments qr_ABC123 --count 10 --skip 0 --from 1776754530 --to 1776758130
```
...
`customer_id`
: `string` Unique identifier of the customer associated with this QR code.

`invoice_id`
: `string` Unique identifier of the invoice associated with this QR code.
