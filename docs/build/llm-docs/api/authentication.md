...
You can roll the Live and Test mode API keys if you have lost them or exposed them. You can choose to regenerate the API keys by deactivating them immediately or after 24 hours.
      ...
      Know how to [regenerate Razorpay API keys](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md#regenerate-api-keys).
    
    
      Know how to [regenerate RazorpayX API keys](https://razorpay.com/docs/build/llm-docs/x/dashboard/api-keys.md#regenerate-api-keys).
