...
A [dispute](https://razorpay.com/docs/build/llm-docs/payments/disputes.md) arises when your customer or the issuing bank questions the validity of a payment. You can manage disputes using APIs or from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/disputes.md#dashboard-actions) to ensure a seamless dispute management experience.

 

 Fork the Razorpay Postman Public Workspace and try the Disputes APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
...
[Webhook Payloads](https://razorpay.com/docs/build/llm-docs/webhooks/disputes.md)
