...
Using Razorpay APIs, you can create a fund account for a customer. Know more about [customers](https://razorpay.com/docs/build/llm-docs/payments/customers.md).
