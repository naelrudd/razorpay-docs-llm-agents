...
`description`
: `string` A brief description of the order, used for display purposes.

`offers`
: `array` List of offer IDs (`offer_xxxx`) applied to this order, if any.
...
* code: 400
* description: The order being fetched was created more than 180 days ago. The live Orders API only retains recent orders for direct fetch.
