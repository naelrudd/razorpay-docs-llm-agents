...
Use this endpoint to retrieve all webhooks for a given account. Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API.
