...
Use this endpoint to delete the webhook of a sub-merchant's account generated by Razorpay. Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API.
