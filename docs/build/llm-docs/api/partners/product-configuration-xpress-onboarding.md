...
As a partner, you can fetch the Razorpay terms and conditions using the [Fetch Terms and Conditions API](https://razorpay.com/docs/build/llm-docs/api/partners/terms-conditions/fetch.md).
...
### Error Response Parameters
     ...
     Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API.
...
- [Xpress Onboarding](https://razorpay.com/docs/build/llm-docs/partners/aggregators/xpress-onboarding.md)
