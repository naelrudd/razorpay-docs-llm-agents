...
Use this endpoint to update a product's configuration and request payment methods like UPI, netbanking and card. Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API. 
