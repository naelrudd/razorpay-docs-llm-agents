...
Use this endpoint to retrieve the details of a product for a given sub-merchant's account. Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API.
