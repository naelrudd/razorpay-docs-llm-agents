...
Use this endpoint to update a product's configuration. Update settlement account details and request for Payment Gateway and Payment Links products. In this sample, the payment methods object has not been used. Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API. 

Check the [use cases](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api.md#use-cases-to-update-settlement-account-details) and [updates permitted for different product activation statuses](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api.md#product-activation-status-and-updates-permitted) before using this API.
...
: `object` Details of the payment method you want to enable for the product.
    ...
    : `object` The payment method to be enabled.
        ...
        : `object` Details regarding the bank.
            ...
            `bank`
            : `string` The bank code. Refer to the [list of bank codes](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md#netbanking-bank-codes).
...
`activation_status`
: `string` The status of the [product activation](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/product-activation.md).
  - `requested`
  - `needs_clarification`
  - `under_review`
  - `activated`
    ...
    : `object` The payment methods configured, such as, netbanking, UPI, Wallet and EMI.
        ...
        : `object` The netbanking type payment method.
            ...
            : `array` The netbanking instrument object.
                ...
                `bank`
                : `array` The list of netbanking banks requested or enabled. Refer the [Appendix](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md#netbanking-bank-codes) page for netbanking bank codes.
