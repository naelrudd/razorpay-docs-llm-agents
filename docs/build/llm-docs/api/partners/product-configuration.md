...
You can even accept terms and conditions for the requested product using these APIs. You can fetch the terms and conditions using the [Fetch Terms and Conditions API](https://razorpay.com/docs/build/llm-docs/api/partners/terms-conditions/fetch.md).
...
Fork the Razorpay Postman Public Workspace and try the Product Configuration APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api.md#api-authentication).
