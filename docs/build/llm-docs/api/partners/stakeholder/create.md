...
Use this API endpoint to create a stakeholder. Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API.
