...
Use this endpoint to update the details of a stakeholder. Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API. 

The information you can update for a stakeholder using the Update a Stakeholder API differs based on the [product activation status](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api.md#product-activation-status-and-updates-permitted).
