...
Use the Document APIs to upload and fetch documents for the KYC verification process. Check the [product activation status and updates permitted](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api.md#product-activation-status-and-updates-permitted) for Document APIs.
...
Fork the Razorpay Postman Public Workspace and try the Document APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api.md#api-authentication/).
