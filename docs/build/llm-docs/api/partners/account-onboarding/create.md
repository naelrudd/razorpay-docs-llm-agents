...
: `string` The type of business operated by the sub-merchant. Possible values: [Business Types](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md).
...
: `object` The business details of the sub-merchant's account.
    ...
    : `string` The business category of the sub-merchant. Possible values: [List of Business Categories](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md#business-category).

    `subcategory` _mandatory_
    : `string` The business sub-category of the sub-merchant. Possible values: [List of Business Sub-Categories](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md#business-sub-category).
...
: `object` The business details of the sub-merchant's account.
    ...
    `category`
    : `string` The business category of the sub-merchant. Possible values: [Business Category](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md#business-category)

    `subcategory`
    : `string` The business sub-category of the sub-merchant. Possible values: [Business Sub-Category](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md#business-sub-category)
