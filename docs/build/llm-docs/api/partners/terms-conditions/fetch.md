...
Use this endpoint to retrieve the terms and conditions of a sub-merchant. Know about the [various error responses](https://razorpay.com/docs/build/llm-docs/api/partners/errors.md) for this API.
