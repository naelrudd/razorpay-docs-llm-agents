...
: `string` The fund account type to be retrieved. Possible values:
    - `bank_account`
    - `vpa`
    - `card` (if [payouts to cards](https://razorpay.com/docs/build/llm-docs/x/payouts/cards.md) is enabled on your account)
...
* solution: Re-check or find the Fund Account ID: - In the response body of [create a Fund Account](https://razorpay.com/docs/build/llm-docs/api/x/fund-accounts.md) API.
