...
With Payouts to Cards APIs, you can make payouts directly to a credit card, debit card or prepaid card. Payouts via **Visa Direct** and **MasterCard Send** are temporarily unavailable. Know more about the [supported networks](https://razorpay.com/docs/build/llm-docs/x/payouts/cards.md#supported-networks-and-banks).
...
[Allowlist IPs](https://razorpay.com/docs/build/llm-docs/x/dashboard/allowlist-ip.md) that you use while making payouts via APIs and pass the [idempotency key](https://razorpay.com/docs/build/llm-docs/api/x/payout-idempotency.md). [Create a Contact](https://razorpay.com/docs/build/llm-docs/api/x/contacts/create.md) and [Fund Account](https://razorpay.com/docs/build/llm-docs/api/x/fund-accounts.md) before creating payouts.

Fork the Razorpay Postman Public Workspace and try the Payouts to Cards APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/x/dashboard/api-keys.md).
...
[About Payout to Cards](https://razorpay.com/docs/build/llm-docs/x/payouts/cards.md)
...
[Status Details](https://razorpay.com/docs/build/llm-docs/errors/x/payout-status-details.md)
