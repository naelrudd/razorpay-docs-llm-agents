...
We do not recommend using the Fetch Payout API to check the status of the payouts. Instead, we recommend that you subscribe to our [Webhooks](https://razorpay.com/docs/build/llm-docs/x/apis/subscribe.md) to get instant notifications. Whenever the status of your payouts change, you will be notified via these webhooks.
...
: `string` The payout status. Possible payout states:
  ...
  Know more about [Payout statuses](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md) and [Payout Status Details](https://razorpay.com/docs/build/llm-docs/errors/x/payout-status-details.md). 
...
: `string` The status of the payout. Possible payout states:
    ...
    Know more about [Payout States](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md) and [Payout Status Details](https://razorpay.com/docs/build/llm-docs/errors/x/payout-status-details.md).  
...
: `object` This parameter returns the current status of the payout. For example, `IMPS is not enabled on beneficiary account, Retry with different mode.`
    ...
    `reason`
    : `string` The error reason. For example, `imps_not_allowed`. Know more about [Payout Status Details and Next Steps](https://razorpay.com/docs/build/llm-docs/errors/x/payout-status-details.md).
