...
Use this endpoint to create a payout to a wallet. You cannot enter a custom narration when creating a payout via Amazon Pay. Know more about [RazorpayX Payout API](https://razorpay.com/docs/build/llm-docs/api/x/payouts.md).
...
: `string` The status of the payout. Possible payout states:
  ...
  Refer to [Payout Life Cycle](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md).
