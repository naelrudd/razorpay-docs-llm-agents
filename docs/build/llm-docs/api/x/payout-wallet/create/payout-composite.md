...
Use this endpoint to create a payout to a Fund Account of type wallet. Know more about [RazorpayX Composite API](https://razorpay.com/docs/build/llm-docs/api/x/payout-composite.md). 
