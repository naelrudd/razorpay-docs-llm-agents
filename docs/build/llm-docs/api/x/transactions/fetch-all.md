...
`mode`
: `string` The payout mode. Refer to the [Supported Banks and Payout Modes section](https://razorpay.com/docs/build/llm-docs/api/x/payouts-cards.md#supported-banks-and-payout-modes) for more details. 
 This value is returned only when the source entity is `payout`.
