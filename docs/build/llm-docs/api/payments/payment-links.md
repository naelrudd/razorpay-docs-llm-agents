...
[Payment Links](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md) are URLs that you can send to your customers through SMS and email to collect payments from them. Customers can click on the URL, which opens the payment request page, and complete the payment using any of the available payment methods. You can create, fetch, edit or cancel Payment Links using APIs or from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/refunds.md#dashboard-actions).

Fork the Razorpay Postman Public Workspace and try the Payment Links APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
...
[About Payment Links](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md)
[Set Up Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md)
[Webhook Payloads](https://razorpay.com/docs/build/llm-docs/webhooks/payment-links.md)
