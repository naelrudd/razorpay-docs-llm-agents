...
You should create a linked account to integrate Route and start transferring payments to vendors.
 ...
 Below are the steps to integrate Route. You can also refer to our comprehensive [Route Integration guide](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md).

 1. [Create a Linked Account](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-linked-account.md)
 2. [Create a Stakeholder](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-stakeholder.md)
 3. [Request a Product Configuration](https://razorpay.com/docs/build/llm-docs/api/payments/route/request-product-config.md)
 4. [Update a Product Configuration](https://razorpay.com/docs/build/llm-docs/api/payments/route/update-product-config.md)
 5. Transfer funds to Linked Accounts using [Orders](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-transfers-orders.md), [Payments](https://razorpay.com/docs/build/llm-docs/api/payments/route/create-transfers-payments.md) or [Direct Transfer](https://razorpay.com/docs/build/llm-docs/api/payments/route/direct-transfers.md) methods.

 Fork the Razorpay Postman Public Workspace and try the Linked Account APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
...
[About Linked Accounts](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md)
[About Route](https://razorpay.com/docs/build/llm-docs/payments/route.md)
[Integrate With Route](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md)
