...
* code: 400
* description: The invoice does not have a customer attached. An invoice cannot be issued without customer details.
...
* code: 400
* description: The invoice has an `expire_by` value that is in the past or less than 15 minutes from the current server time. An invoice cannot be issued with an immediate or past expiry.
