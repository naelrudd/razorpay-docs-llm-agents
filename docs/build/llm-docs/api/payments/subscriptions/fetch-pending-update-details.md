...
* code: 400
* description: There is no scheduled update on the subscription to retrieve. This endpoint is only meaningful after a `PATCH /v1/subscriptions/:id` with a `schedule_change_at` value.
