...
: `string` Unique identifier of the customer to whom the Customer Identifier must be tagged. Create a customer using the [Customer API](https://razorpay.com/docs/build/llm-docs/api/customers.md).

`notes` _optional_
: `json object` Any custom notes you might want to add to the Customer Identifier can be entered here. Know more about [notes](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes).
...
`notes`
: `json object` Any custom notes you might want to add to the Customer Identifier can be entered here. Know more about [notes](https://razorpay.com/docs/build/llm-docs/api/understand.md).

`customer_id`
: `string` Unique identifier of the customer the Customer Identifier is linked with. Know more about [Customer API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
...
: `json object` Configuration of desired receivers for the Customer Identifier.
  ...
  `notes`
  : `json object` Any custom notes you might want to add to the virtual bank account or virtual UPI ID can be entered here. Know more about [notes](https://razorpay.com/docs/build/llm-docs/api/understand.md). This parameter appears in the response only when `bank_account` is passed as the receiver `type`.
