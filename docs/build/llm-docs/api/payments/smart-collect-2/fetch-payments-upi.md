...
```bash: CLI
razorpay smart-collect fetch-upi-payment pay_DlGmm7jInLudH8
```
...
: `object` Details of the Customer Identifier.
    ...
    `customer_id`
    : `string` The unique identifier of the customer the Customer Identifier is linked with. For more details, refer to the [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
