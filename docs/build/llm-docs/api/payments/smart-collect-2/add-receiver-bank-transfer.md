...
- Use [Smart Collect TPV](https://razorpay.com/docs/build/llm-docs/api/payments/smart-collect-tpv.md)  APIs to **Add an Allowed Payer** or **Delete an Allowed Payer**
