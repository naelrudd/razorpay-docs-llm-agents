...
---
[Fetch Card Reference Number Using Card Number](https://razorpay.com/docs/build/llm-docs/api/payments/cards/fingerprints/fetch-card-number.md) | Fetches the card reference number for a specific card using card number.
---
[Fetch Card Reference Number Using Tokenised Card Number](https://razorpay.com/docs/build/llm-docs/api/payments/cards/fingerprints/fetch-tokenised-number.md) | Fetches the card reference number for a specific card using tokenised card number.
---
[Fetch Card Reference Number Using Razorpay Token](https://razorpay.com/docs/build/llm-docs/api/payments/cards/fingerprints/fetch-razorpay-token.md) | Fetches the card reference number for a specific card using Razorpay Token.
