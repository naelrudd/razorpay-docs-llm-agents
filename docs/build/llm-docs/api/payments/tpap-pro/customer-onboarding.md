...
Explore Razorpay's TPAP Pro - Customer Onboarding APIs, which facilitate the registration of devices and the management of payment sources, such as bank accounts, RuPay credit cards and credit lines, to enhance your UPI onboarding process. As part of this process, you need to create a unique identifier called a [fingerprint](https://razorpay.com/docs/build/llm-docs/payments/tpap-pro/integration-guide.md#create-a-device-fingerprint) using various device attributes.
