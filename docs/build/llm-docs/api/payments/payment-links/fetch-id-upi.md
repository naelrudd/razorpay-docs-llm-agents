...
- X GET https://api.razorpay.com/v1/payment_links/plink_KBnb7I424Rc1R9 \
...
body, err := client.PaymentLink.Fetch("", nil, nil)
...
```bash: CLI
razorpay payment-links fetch plink_ABC123
```
...
```json: Failure 
{
  "error": {
    ...
    "description": "invalid input [strippedId] = [KBnb7I424Rc1R]",
    "metadata": [],
    "reason": null,
    "source": null,
    "step": null
...
`order_id`
: `string` Unique identifier of the order associated with this payment link.
