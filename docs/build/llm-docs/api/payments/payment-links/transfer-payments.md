...
Use this endpoint to transfer the payments received from your customers automatically to your linked accounts. Know how to [create a linked account and transfer payments](https://razorpay.com/docs/build/llm-docs/payments/payment-links/transfer-payments.md).
...
razorpay payment-links create \
  --amount 1000 \
  --currency INR \
  --transfers '[{"account":"acc_ABC123","amount":500,"currency":"INR","on_hold":false}]'
```
