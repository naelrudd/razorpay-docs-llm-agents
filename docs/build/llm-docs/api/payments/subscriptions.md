...
You can use Subscriptions to charge a customer periodically. A Subscription contains details like the plan, the start date, the total number of billing cycles, the free trial period (if any) and the upfront amount to be collected. 
 ...
 Below are the steps to integrate Subscriptions. You can also refer to our comprehensive [Subscriptions Integration guide](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/integration-guide.md).

 1. [Create a Plan](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions/create-plan.md)
 2. [Create a Subscription](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions/create-subscription.md)
 3. [Checkout Integration](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/integration-guide.md#step-14-integrate-with-standard-checkout/)

 Fork the Razorpay Postman Public Workspace and try the Subscription APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
...
[Integrate With Subscriptions](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/integration-guide.md)
[Set Up Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md)
[Webhook Payloads](https://razorpay.com/docs/build/llm-docs/webhooks/subscriptions.md)
