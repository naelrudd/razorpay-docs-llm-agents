...
: `object` Details of the Customer Identifier.
    ...
    `customer_id`
    : `string` The unique identifier of the customer the Customer Identifier is linked with. Know more about [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
