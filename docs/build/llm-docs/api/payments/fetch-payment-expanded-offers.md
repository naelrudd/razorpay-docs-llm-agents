...
```bash: CLI
razorpay payments fetch pay_ABC123 --expand offers
```
...
`offers`
: `object` Collection of offers applied to this payment. Contains entity type, count, and items array with offer details.

`customer_id`
: `string` Unique identifier of the customer associated with this payment.
