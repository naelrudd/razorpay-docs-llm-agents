...
`business_type`
: `string` The type of business operated by the account holder. Possible values: See [Business Types](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-type). 

`profile`
: `object` The account holder's business details.

    `category`
    : `string` The business category of the account holder. For example, `healthcare`. Possible values: See [Business Category](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-category).

    `subcategory`
    : `string` The business sub-category of the account holder. For example, `clinic`. Possible values: See [Business Sub-Category](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-sub-category).
