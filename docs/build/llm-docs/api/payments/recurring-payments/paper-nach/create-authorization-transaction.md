...
`max_amount`
: `integer` The maximum amount in paise a customer can be charged in a transaction. Know about [maximum and default values](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/paper-nach/faqs.md#3-is-there-a-limit-on-the-debit).
...
: Details of the authorisation payment.
  ...
  `max_amount` _optional_
  : `integer` Use to set the maximum amount, in paise, per debit request. Know about [maximum and default values](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/paper-nach/faqs.md#3-is-there-a-limit-on-the-debit).
