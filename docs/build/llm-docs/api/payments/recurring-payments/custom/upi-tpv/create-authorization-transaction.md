...
You can create customers with basic details such as `email` and `contact` and use them for various Razorpay offerings. Know more about [Customers](https://razorpay.com/docs/build/llm-docs/api/customers.md).
