...
After this step, you can proceed to integrate with the [Fetch Token API](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/custom/cards/tokens.md).
