...
Fork the Razorpay Postman Public Workspace and try the Smart Collect with TPV APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).
