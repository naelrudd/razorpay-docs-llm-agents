...
`order_receipt`
: `string` Receipt number entered while [creating the Order](https://razorpay.com/docs/build/llm-docs/api/orders.md#create-an-order).
...
The year and month fields are required.
* code: 400
* description: The `year` and/or `month` query parameter was not included in the request. Both are mandatory.
