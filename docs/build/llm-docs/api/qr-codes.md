...
You can use Razorpay [QR Codes](https://razorpay.com/docs/build/llm-docs/payments/qr-codes.md) to create QR Codes and share them with customers to accept digital payments. You can create and manage QR Codes using APIs or from the [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/qr-codes/create.md).

 
Refer to the [QR Code Flow](https://razorpay.com/docs/build/llm-docs/payments/qr-codes/how-it-works.md) and [Integration Checklist](https://razorpay.com/docs/build/llm-docs/payments/qr-codes/apis.md#integration-checklist) before you begin integrating with the APIs for QR Codes.

 Fork the Razorpay Postman Public Workspace and try the QR Codes APIs using your [Test API Keys](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/api-keys.md#generate-api-keys).
...
[About QR Codes](https://razorpay.com/docs/build/llm-docs/payments/qr-codes.md)
