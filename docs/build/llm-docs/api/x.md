...
It is assumed that you have already added funds to your business account. This action **cannot** be performed via APIs and has to be done before you can make a payout. Refer to the business account section to know [how to add funds to your business account](https://razorpay.com/docs/build/llm-docs/x/account-types.md#add-funds).
...
Know more about [API parameters](https://razorpay.com/docs/build/llm-docs/x/apis.md).
...
Know more about [Test Mode](https://razorpay.com/docs/build/llm-docs/x/dashboard/test-mode.md).
...
## Webhooks
[Set up Payout Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payouts.md)to configure and receive notifications when a [specific event occurs](https://razorpay.com/docs/build/llm-docs/webhooks.md#available-events). When one of these events is triggered, we send an HTTP POST [payload](https://razorpay.com/docs/build/llm-docs/webhooks.md) in JSON to the webhook's configured URL.

### Related Information

- [Set up your RazorpayX account](https://razorpay.com/docs/build/llm-docs/x/set-up.md)
- [RazorpayX Account Types](https://razorpay.com/docs/build/llm-docs/x/account-types.md)
