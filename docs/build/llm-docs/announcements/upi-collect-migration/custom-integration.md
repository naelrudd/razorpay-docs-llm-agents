...
- If you are a new customer, use [UPI Intent](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom/payment-methods.md#intent-flow). 
