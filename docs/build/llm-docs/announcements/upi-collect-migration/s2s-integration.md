...
- If you are a new customer, use [UPI Intent](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/upi/intent.md). 
...
### Web (Desktop Web)
         ...
         **Supported API Endpoints:**
         ...
         Refer to the [UPI Intent documentation](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/payment-methods/upi/intent.md) for implementation details.
