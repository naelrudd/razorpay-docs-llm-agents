...
### Desktop Web
         ...
         **Change Needed**
         ...
         1. Update your API call to use UPI Intent flow instead of UPI Collect flow. Remove `vpa` and `expiry_time` parameters from the request body. Replace `collect` with `intent` as the value of the `upi.flow` parameter. Refer to the [UPI Intent guide](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/upi/authorization-transaction.md#113-create-an-authorisation-payment) for further information.
         ...
         3. Use [webhooks to get payment status updates](https://razorpay.com/docs/build/llm-docs/webhooks/payments.md).
...
- [Recurring Payments - UPI Autopay S2S Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/upi/authorization-transaction.md)
