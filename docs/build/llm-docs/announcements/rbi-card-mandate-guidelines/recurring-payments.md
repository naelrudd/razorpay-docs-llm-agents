...
**Read More**: Learn more about UPI Autopay from our [blog](https://razorpay.com/blog/what-is-upi-autopay-recurring-payments-razorpay-subscriptions/) and [documentation](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/upi/create-authorization-transaction.md).
