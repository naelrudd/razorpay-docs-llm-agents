...
Refer to the [Recurring Payments document](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments.md) for more information on payment methods.
...
Refer to the [Payment Link document](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md) for more information.
...
Refer to the [Recurring Payments API document](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/cards/create-authorization-transaction.md#112-create-an-order) for more information on changes.
...
Yes, businesses can cancel card tokens by deleting them. Tokens can be deleted either from the [dashboard](https://razorpay.com/docs/build/llm-docs/payments/recurring-payments/create.md#delete-the-token) or using [APIs](https://razorpay.com/docs/build/llm-docs/api/payments/recurring-payments/cards/tokens.md#23-delete-tokens).
