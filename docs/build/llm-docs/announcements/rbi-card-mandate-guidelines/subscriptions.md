...
We will soon be enabling UPI Autopay on your Dashboard. You can [create a subscription link](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/create-subscription-links.md) that will allow your customers to choose UPI to make recurring payments.
...
Learn more about UPI Autopay from our [blog](https://razorpay.com/blog/what-is-upi-autopay-recurring-payments-razorpay-subscriptions/) and [documentation](https://razorpay.com/docs/build/llm-docs/payments/subscriptions/faqs.md#upi).
