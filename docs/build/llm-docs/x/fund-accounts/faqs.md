...
You can add a bank account for a contact by [creating a Fund Account](https://razorpay.com/docs/build/llm-docs/x/fund-accounts.md#create-a-contact-with-fund-account) for that Contact. 
...
You must provide the Contact’s VPA while [creating a Fund Account](https://razorpay.com/docs/build/llm-docs/x/fund-accounts.md#create-a-contact-with-fund-account) of type VPA.
...
Currently, it can be done via the [Fund Account Validation API](https://razorpay.com/docs/build/llm-docs/api/x/composite-account-validation.md) only. We do not support validation of Fund Accounts through the Dashboard.

### 3. For VPA validation, does `active` status mean that the underlying bank account is also active?
...
If this is not the case, please raise [a support query](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-users).
...
For more information on fund account validation charges, please raise [a support query](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-users).
...
No, it is not supported in [test mode](https://razorpay.com/docs/build/llm-docs/x/dashboard/test-mode.md).
...
Know more about [Fund Account Validation statuses](https://razorpay.com/docs/build/llm-docs/api/x/account-validation.md).
