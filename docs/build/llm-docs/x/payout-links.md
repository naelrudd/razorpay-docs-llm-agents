...
RazorpayX then sends them a link where the [Contact](https://razorpay.com/docs/build/llm-docs/x/contacts.md) can then enter their account details (bank account or UPI ID). Once we get their verified account details, we transfer the amount. 
...
- Allowlisting your IP is mandatory for using the Payout Link APIs. Know how to [allowlist your IP](https://razorpay.com/docs/build/llm-docs/x/dashboard/allowlist-ip.md).
...
1. [Create a Payout Link](https://razorpay.com/docs/build/llm-docs/x/payout-links/create.md) by entering:
...
To do this, [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md) and request the feature. The configured mode will be used to process all payouts made via links from your account. 
...
With Payout Links, you just send a Payout Link to your Contact and they can use it to get their refund in their preferred fund account. You can set up the [Shopify Payout Links](https://razorpay.com/docs/build/llm-docs/x/payout-links/shopify.md) integration and simplify refunds for your business. 
...
- [Create Payout Links](https://razorpay.com/docs/build/llm-docs/x/payout-links/create.md) 
- [Payout Links API](https://razorpay.com/docs/build/llm-docs/api/x/payout-links.md)
- [Payout Link Life Cycle](https://razorpay.com/docs/build/llm-docs/x/payout-links/life-cycle.md)
