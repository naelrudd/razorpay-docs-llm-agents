...
Tax Deducted at Source (TDS) is mandated by the government. You can upload TDS data to [RazorpayX Tax Payments](https://x.razorpay.com/tax-payments) and make payments. You can set up an automated method to pay taxes. Know more about [Automatic TDS payments](https://razorpay.com/docs/build/llm-docs/x/tax-payments/automatic-tds.md).
...
1. After you make the payment, it follows the [Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/manage-teams/approval-workflow.md) set on your RazorpayX account.
...
- [Advance Tax Payments](https://razorpay.com/docs/build/llm-docs/x/tax-payments/advance.md)
