...
Payout Status details are returned when a payout is created and moves to another state. Know more about [Payout States](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md).
...
- [Fetch Payout API response](https://razorpay.com/docs/build/llm-docs/errors/x/payout-status-details.md)
...
### Subscribe to Daily Reports
             ...
             To subscribe, [raise a support ticket](https://razorpay.com/docs/build/llm-docs/x/support.md) from the RazorpayX Dashboard with a list of recipient email IDs. We will enable the function for you in 3 working days.
...
- [Status Details via API](https://razorpay.com/docs/build/llm-docs/errors/x/payout-status-details.md)
