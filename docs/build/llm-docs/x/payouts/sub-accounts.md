...
You can [download reports](https://razorpay.com/docs/build/llm-docs/x/dashboard.md#reports) for your sub-accounts and see the real-time limit assigned to them.
...
1. [Sign Up](https://razorpay.com/docs/build/llm-docs/x/set-up.md#new-users) on the RazorpayX Dashboard.
2. Open a [Current Account](https://razorpay.com/docs/build/llm-docs/x/account-types/current-account.md#current-account) using RazorpayX.
...
Sub-account holders can only make [Payouts](https://razorpay.com/docs/build/llm-docs/x/payouts.md#how-to-make-payouts).
...
The sub-account Name, Customer Identifier, Merchant ID and Live balance of the sub-accounts are visible to the Master account. 
...
1. [Sign Up](https://razorpay.com/docs/build/llm-docs/x/set-up.md#new-users) to the RazorpayX Dashboard.
...
- [Current Account](https://razorpay.com/docs/build/llm-docs/x/account-types/current-account.md)
- [Support](https://razorpay.com/docs/build/llm-docs/x/support.md)
