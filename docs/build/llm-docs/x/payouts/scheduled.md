...
1. Create a [Contact](https://razorpay.com/docs/build/llm-docs/x/contacts.md#contacts).
2. Create a [Fund account](https://razorpay.com/docs/build/llm-docs/x/contacts.md#fund-accounts) for the Contact.
3. Create a payout.
...
You can create Scheduled payouts created using [Bulk Upload](https://razorpay.com/docs/build/llm-docs/x/contacts/bulk-uploads.md). Select the following options while uploading the bulk upload file:
...
After a bulk file is uploaded, it is picked up for processing immediately. Know more about [bulk payouts](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts.md).
...
Know  more about the [states and the life cycle of a payout](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md).
