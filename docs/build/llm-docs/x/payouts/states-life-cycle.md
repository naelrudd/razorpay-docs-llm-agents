...
[Payouts](https://razorpay.com/docs/build/llm-docs/x/payouts.md) are made to [Contacts](https://razorpay.com/docs/build/llm-docs/x/contacts.md). A payout has various states in its life cycle.
...
For more information on the complete Payout States and the Status Response Code, refer [Payout Status Details.](https://razorpay.com/docs/build/llm-docs/errors/x/payout-status-details.md)

Get automatic notifcations about the payout states using [Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md). [Set up and configure webhooks](https://razorpay.com/docs/build/llm-docs/x/apis/subscribe.md) to improve process efficiency, and stay updated on the status of the payout.

### Pending

If you have the [Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/manage-teams/approval-workflow.md) feature enabled on your account, the payout moves to the `pending` state if the payout requires approval as per the Approval Workflow. 
...
The `scheduled` state does not apply to Queued Payouts. Know more about [Queued Payouts](https://razorpay.com/docs/build/llm-docs/x/payouts/queued.md).
...
The `queued` state does not apply to Scheduled Payouts. Know more about [Scheduled Payouts](https://razorpay.com/docs/build/llm-docs/x/payouts/scheduled.md).
...
- `queued` state. You can cancel a payout in the `queued` state either from the [Dashboard](https://x.razorpay.com/) or using our [APIs](https://razorpay.com/docs/build/llm-docs/api/x/payouts/cancel.md).
...
The payout failed status is applicable when you're making payouts using your current account balance.
...
- [Scheduled Payouts](https://razorpay.com/docs/build/llm-docs/x/payouts/scheduled.md)
