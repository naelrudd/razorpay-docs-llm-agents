...
When banks experience downtimes, payouts you initiate on the RazorpayX Dashboard may fail, that is, the payouts move to the `failed` or `deemed_duccess` state. Know more about [Payout States](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md). 
...
To receive alerts for partner bank downtime via email and SMS, [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-users). We shall enable the feature for you in 2 days. 
...
You can get notified about the beneficiary bank downtimes via [Payout Webhook](https://razorpay.com/docs/build/llm-docs/x/apis/subscribe.md) events. To enable downtime webhooks: 

1. Follow the steps to [set up Payout Webhooks](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payouts.md#set-up-and-edit-webhooks).
...
- [payout.downtime.started](https://razorpay.com/docs/build/llm-docs/webhooks.md#payout-downtime-started): Triggered when the beneficiary bank downtime begins. 
- [payout.downtime.resolved](https://razorpay.com/docs/build/llm-docs/webhooks.md#payout-downtime-resolved): Triggered when the beneficiary bank has resolved the downtime. 
...
### Webhook Response Parameters
         ...
         `method` 
         : Contains the list of [payout modes/methods](https://razorpay.com/docs/build/llm-docs/x/payouts.md#payout-modes-and-tat) impacted. For example, `IMPS`, `UPI` and more. 
...
- Customise and route your payouts via other bank accounts using [Multi-bank Routing](https://razorpay.com/docs/build/llm-docs/x/payouts/multi-bank-routing.md). 
- Let RazorpayX automatically queue and process your payouts via [Intelligent payouts](https://razorpay.com/docs/build/llm-docs/x/payouts/intelligent-payouts.md). 
...
- [Check Payout Status Details](https://razorpay.com/docs/build/llm-docs/x/payouts/status-details.md)
