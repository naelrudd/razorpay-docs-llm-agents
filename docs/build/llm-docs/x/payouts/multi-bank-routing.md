...
RazorpayX **Payouts Pro** is a Multi-bank Routing feature which allows you to set primary, secondary and tertiary accounts and helps avoid payout failures by detecting bank downtimes. While [Intelligent Payouts](https://razorpay.com/docs/build/llm-docs/x/payouts/intelligent-payouts.md) prevents the money from being blocked, Multi-bank Routing changes the account of the transaction and prevents payment delays in real-time. 
...
- Dynamic Multi-bank Routing is applicable only to payouts made via [Payout APIs](https://razorpay.com/docs/build/llm-docs/api/x/payouts.md).
...
1. [Account Statements](https://razorpay.com/docs/build/llm-docs/x/account-statement.md)
2. [Reports](https://razorpay.com/docs/build/llm-docs/x/reports.md)
3. [Payouts](https://razorpay.com/docs/build/llm-docs/x/payouts/reports.md)

### Related Information

- [About Payouts](https://razorpay.com/docs/build/llm-docs/x/payouts.md)
- [Open a Current Account](https://razorpay.com/docs/build/llm-docs/x/account-types/current-account.md)
