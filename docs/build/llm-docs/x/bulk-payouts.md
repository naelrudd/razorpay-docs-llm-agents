...
- Make a payout to an existing [fund account](https://razorpay.com/docs/build/llm-docs/x/fund-accounts.md). 
- Create a new [contact and fund account](https://razorpay.com/docs/build/llm-docs/x/fund-accounts.md#create-a-contact-with-fund-account) to make a payout.

Alternatively, you can also [create contacts and fund accounts in bulk](https://razorpay.com/docs/build/llm-docs/x/contacts/bulk-uploads.md). 
...
10. Click **Next** to make the payouts or [schedule the payouts](https://razorpay.com/docs/build/llm-docs/x/payouts/scheduled.md).
...
---
Incorrect format of the file | Download and fill from the [templates](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts.md#bulk-payouts-templates) provided.
---
