...
Download the Bulk Upload report from the [RazorpayX Dashboard](https://x.razorpay.com/) after your bulk upload file gets [processed](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts/uploads.md#bulk-upload-status).  
...
- Additional details as per the [fields populated in the Bulk Upload file](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts.md#sample-template).
...
To troubleshoot the errors that appear in the report, see [Bulk Uploads Error Codes](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts.md).
