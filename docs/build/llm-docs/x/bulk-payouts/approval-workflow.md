...
After you set up an [approval workflow](https://razorpay.com/docs/build/llm-docs/x/manage-teams/approval-workflow.md) and [create bulk payout](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts.md#create-bulk-payout), you can review the bulk payout batch files and approve them with a single OTP. 
...
1. Log in to the [RazorpayX Dashboard](https://x.razorpay.com/auth) as an [Owner/Admin](https://razorpay.com/docs/build/llm-docs/x/manage-teams.md) and go to **My Account & Settings** under the user profile icon. 
...
You have successfully enabled the setting to approve a batch of bulk payout with a single OTP. Your team can now create bulk payout batches using the [new templates](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts.md#download-templates) and send them for approval.

## Review Bulk Payouts 

To approve/reject the bulk payout batches pending on you: 

1. Log in to the [RazorpayX Dashboard](https://x.razorpay.com/auth) as an [Owner/Approver](https://razorpay.com/docs/build/llm-docs/x/manage-teams.md).
...
Only the bulk payout batch file moves to the `processing` status. Know more about [Bulk Payouts batch processing vs Payout processing](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts.md#bulk-payouts-batch-processing-vs-payouts-processing).
...
- [Bulk Payouts Life Cycle](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts/life-cycle.md)
