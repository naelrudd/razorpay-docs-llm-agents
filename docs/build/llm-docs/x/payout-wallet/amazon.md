...
You can make payouts to Amazon Pay Gift Cards using your [RazorpayX Lite](https://razorpay.com/docs/build/llm-docs/x/account-types/razorpayx-lite.md). Once you process the payout, the amount gets instantly credited to your end customer's Amazon Pay Gift Card balance. 
...
- This feature is available only on [RazorpayX Lite](https://razorpay.com/docs/build/llm-docs/x/account-types/razorpayx-lite.md).
...
1. Create a [Contact](https://razorpay.com/docs/build/llm-docs/x/contacts.md#create-a-contact-with-fund-account).
...
See: [Payout states and life cycle](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md).
...
Know more about [creating a Fund account via API](https://razorpay.com/docs/build/llm-docs/api/x/payout-wallet/create/fund-account.md) with `type: wallet` and `provider: amazonpay` and [creating payouts via Amazon Pay](https://razorpay.com/docs/build/llm-docs/api/x/payout-wallet/create/payout.md).
...
Know more about to the [Amazon Branding Guidelines](https://razorpay.com/docs/build/llm-docs/x/payout-wallet/amazon/branding-guidelines.md).
...
- [Amazon Payout APIs](https://razorpay.com/docs/build/llm-docs/api/x/payout-wallet.md)
