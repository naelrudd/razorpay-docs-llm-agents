...
Cost centers can be used to tag expenses while creating a Purchase Order. An approval workflow can be triggered based on the Cost Center selected, using [Purchase Order Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/purchase-order.md#purchase-order-approval-workflow).

You can also set up a separate [Invoices Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices/approval-workflow.md).
...
- [Invoices Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices/approval-workflow.md)
