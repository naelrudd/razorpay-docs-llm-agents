...
1. [Upload an invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md#add-invoices) on the [RazorpayX Dashboard](https://x.razorpay.com/auth).
2. Add the vendor/s details.
3. Make the payment as per your business requirements.

You can also pay an [advance](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/advances.md) to your vendor via RazorpayX without worrying about reconciliation because we take care of that for you, when you pay for the invoice.
...
RazorpayX automatically checks if your vendors have filed their GST, identify discrepancies in the filing and control your vendor payouts to recover previously lost credit dues. Know more about [Input Tax Credit Checker](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/gst-credit-checker.md).

## Vendor Portal
 
The RazorpayX Vendor Portal is a platform created for your vendors where they can upload the invoices and receive updates to the payment. Know more about how to [setup a Vendor Portal](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/portal/business.md) and how your Vendors can use the [RazorpayX Vendor Portal](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/portal.md).
 
## Manage Teams
 
You can assign assign users roles to limit their access to the RazorpayX Dashboard as per your business requirements. Know more about [User Roles](https://razorpay.com/docs/build/llm-docs/x/manage-teams.md#vendor-payments).
 
### Related Information
 
- [Bulk Invoices](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/bulk-invoices.md)
- [Tally Accrual](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/sync-purchase-vouchers.md)
