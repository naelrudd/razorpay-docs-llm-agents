...
When you make a payout using [RazorpayX Lite](https://razorpay.com/docs/build/llm-docs/x/account-types/razorpayx-lite.md), the fees and taxes are charged as a part of the payout in real-time.
...
In case of a [payout reversal](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md#reversal-transaction), the fees and tax are also reversed.

### Payouts from Current Account

When you make a payout from your [Current Account](https://razorpay.com/docs/build/llm-docs/x/account-types/current-account.md), you are charged a fee. The fees and taxes are collected once everyday and **appear as a payout** in your account statement. This is an automated process and does not require any action from you.
