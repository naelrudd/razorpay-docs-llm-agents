...
Approval Workflow can be applied to all payouts created on RazorpayX, whether they are created individually from the [RazorpayX Dashboard](https://x.razorpay.com/), using [API](https://razorpay.com/docs/build/llm-docs/api/x/payouts.md) or using the [Bulk Payout](https://razorpay.com/docs/build/llm-docs/x/bulk-payouts.md#payouts) feature.
...
1. Confirm saving workflow and [2FA](https://razorpay.com/docs/build/llm-docs/x/manage-teams/2fa.md) to create workflow successfully.
...
In addition to the [webhook events available for payouts](https://razorpay.com/docs/build/llm-docs/webhooks.md), the Approval Workflow has the following events.
...
- [Manage Teams](https://razorpay.com/docs/build/llm-docs/x/manage-teams.md)
- [Chartered Accountant Portal](https://razorpay.com/docs/build/llm-docs/x/manage-teams/ca-portal.md)
- [Invoices - Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/approvals-on-invoices.md)
