...
To understand the Dashboard actions, assume that an organisation, Acme Corp., has [asked RazorpayX](https://razorpay.com/docs/build/llm-docs/x/support.md#raise-a-new-request) to create two user group types for them:
- Teams
- Departments

## Add a Group 

You can add groups one by one or [request RazorpayX](https://razorpay.com/docs/build/llm-docs/x/support.md#raise-a-new-request) to create the groups.
...
4. Select the role to be assigned to the user or [**+ Create New Role**](https://razorpay.com/docs/build/llm-docs/x/manage-teams/create-user-role.md). Review the permissions and click **Send Invite**.
...
You can navigate to **My Account and Settings** → **Team Management** → **Roles & Permissions** to [edit the permissions](https://razorpay.com/docs/build/llm-docs/x/manage-teams/create-user-role.md#edit-custom-user-roles) for different roles.
...
You can [contact us](https://razorpay.com/docs/build/llm-docs/x/support.md#raise-a-new-request) to set up, modify or remove workflow/s based on your requirements for POs, Invoices or Payouts.
