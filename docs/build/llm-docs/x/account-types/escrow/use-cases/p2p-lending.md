...
LSP partners are onboarded as [sub-accounts](https://razorpay.com/docs/build/llm-docs/x/payouts/sub-accounts.md) with P2P Escrow as the master account.
...
Connect with your RazorpayX POC or [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md) for document templates, letters and other supporting material.
...
You can make payouts via your Escrow Account using our [Payout APIs](https://razorpay.com/docs/build/llm-docs/x/payouts/api.md).

Points to remember:

- Ensure to follow all the payout [best practices](https://razorpay.com/docs/build/llm-docs/x/payouts/best-practices.md).
- Contact type must be `borrower` or `investor`. Know more about [Contact APIs](https://razorpay.com/docs/build/llm-docs/x/contacts/api.md).
- Payout purpose must be `Loan disbursement` or `Investor withdrawal`. Know more about [Payout purpose](https://razorpay.com/docs/build/llm-docs/x/payouts.md#payout-purpose).
- [Allowlist your IPs](https://razorpay.com/docs/build/llm-docs/x/dashboard/allowlist-ip.md).
