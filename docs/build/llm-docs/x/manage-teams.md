...
3. You can either select an existing role or you can [create a new role](https://razorpay.com/docs/build/llm-docs/x/manage-teams/create-user-role.md).
...
4. Select from the existing user role templates or [create a new role](https://razorpay.com/docs/build/llm-docs/x/manage-teams/create-user-role.md).
...
- First [create the custom role](https://razorpay.com/docs/build/llm-docs/x/manage-teams/create-user-role.md) to change the role of a team member to a new custom role.
...
3. If you are already logged in, you can accept the invite by navigating to **My Account & Settings** → **User Profile** and [Switch Merchant](https://razorpay.com/docs/build/llm-docs/x/dashboard.md#switch-merchant).

### Related Information

- [Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/manage-teams/approval-workflow.md)
- [Two-Factor Authentication](https://razorpay.com/docs/build/llm-docs/x/manage-teams/2fa.md)
- [Chartered Accountant Portal](https://razorpay.com/docs/build/llm-docs/x/manage-teams/ca-portal.md)
