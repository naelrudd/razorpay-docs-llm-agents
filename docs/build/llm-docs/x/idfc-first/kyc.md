...
Below are the list of KYC documents required to be submitted by the operators/beneficial owners/partners/directors/proprietors of a business entity to open a current account with RazorpayX in partnership with IDFC First Bank. You can find the list of acceptable documents for [Indian Residents](https://razorpay.com/docs/build/llm-docs/x/idfc-first/kyc.md#indian-residents), [NRIs](https://razorpay.com/docs/build/llm-docs/x/idfc-first/kyc.md#non-resident-of-india), [Foreign Nationals](https://razorpay.com/docs/build/llm-docs/x/idfc-first/kyc.md#foreign-nationals-residing-in-india), [Hindu Undivided Families](https://razorpay.com/docs/build/llm-docs/x/idfc-first/kyc.md#hindu-undivided-family-huf) and [Business Entities](https://razorpay.com/docs/build/llm-docs/x/idfc-first/kyc.md#kyc-documents-for-the-business-entity).
...
Below are the **additional documents** required in case of [Escrow Accounts](https://razorpay.com/docs/build/llm-docs/x/account-types/escrow.md)
    - **Escrow Board Resolution** (Click to download the format )
