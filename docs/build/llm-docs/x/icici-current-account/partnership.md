...
- Communication Address Proof (if different from what is mentioned in Certificate of Registration) Click [here](https://razorpay.com/docs/build/llm-docs/x/icici-current-account/entity-address-proof.md)for a list of acceptable documents 
