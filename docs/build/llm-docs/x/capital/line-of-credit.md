...
- [Withdraw funds](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#make-withdrawals) from your line, 24/7. 
- Choose the tenure within which you want to repay the withdrawn amount, including the interest accumulated. 
- [Repay your withdrawals](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#make-repayments) in two different ways, or pre-close withdrawal.
...
---
`partially repaid` | If you repay less than total due amount when [repaying a withdrawal](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#make-repayments), this is the status.
---
...
---
`failed` | If your EMI repayment had failed, this is the status. This usually happens due to unavoidable server downtimes. Retry making the EMI payment. [Contact support](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-capital) from the Dashboard for any queries. 
---
...
- However, **overdue charges are applicable** when you do not pay the EMIs on the due date. 
 ...
 The interest accrued is shown on the right pane of the [withdrawal summary](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md) with ⓘ and is inclusive of the overdue charges when you view it after the due date.
...
- [Line of Credit FAQs](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/faqs.md)
