...
### 1. I am unable to make my EMI payment and the due date is close. What are the alternative ways in which I can make timely repayments?
         ...
         - If the autopay/NACH fails, we trigger a [Payment Link](https://razorpay.com/docs/build/llm-docs/payments/payment-links.md) to collect the overdue amount. The overdue amount is adjusted to include the [delayed interest](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit.md#delayed-interest) charges. 
         - If you still want to make a manual repayment, [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-capital). Any amount received from the NACH will be credited back to your account. 
...
### 2. How can I know if NACH is already initiated?
         ...
         You can view if the [NACH is initated](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#autopay-using-nach) on your RazorpayX Dashboard. 
        

    
### 3. Where can I view my credit limit/balance?

         You can view it on your LOC [**Overview** page](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#make-withdrawals). 
...
### 5. Where can I view my EMI details?
         ...
         Know more about [EMI details](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#make-withdrawals).
...
### 6. What are my modes of repayment?
         ...
         - [Manual EMI payments](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#manual-emi-payments).
         - [Pre-closing withdrawals](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#pre-close-withdrawal).
...
### 7. I am unable to withdraw money from my available credit limit. Why?
         ...
         1. You are **making a fourth withdrawal**. 
            ...
            To withdraw again, close any one of the three active withdrawal EMIs. There are no [pre-closure charges](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit/dashboard.md#pre-close-withdrawal) for pre-payment.
