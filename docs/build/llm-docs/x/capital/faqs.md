...
### 1. How can I revoke the consent to pull my bureau report through Razorpay and partner?
         ...
         To revoke the consent you gave through Razorpay to pull your credit report, [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md#razorpayx-users) from the RazorpayX Dashboard. 
...
### 7. How can I increase my credit limit on RazorpayX Corporate Card?
         ...
         We send you a confirmation mail to get your consent to increase the limit. You can [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md) for further query resolution.
...
### 1. What are On-demand Instant Settlements and Same-day Scheduled Settlements?
         ...
         Know more about [Instant Settlements](https://razorpay.com/docs/build/llm-docs/payments/settlements/instant.md).
