...
Fund accounts are accounts associated with a [Contact](https://razorpay.com/docs/build/llm-docs/x/contacts.md) (similar to a *beneficiary* in your netbanking portal).
...
- **Cards**: Know more about [Payouts to Cards](https://razorpay.com/docs/build/llm-docs/api/x/payouts-cards.md).
...
- **Wallet**: Make payouts to your beneficiary's wallet. You can make payouts to a beneficiary via an Amazon Pay gift card. Know more about [Payouts to Amazon Pay Wallet](https://razorpay.com/docs/build/llm-docs/api/x/payout-wallet.md).

Know about the [payout modes available for each Fund account type](https://razorpay.com/docs/build/llm-docs/x/payouts.md#payout-modes-and-tat) and the [list of banks/cards supported](https://razorpay.com/docs/build/llm-docs/x/payouts/cards.md#banks).
...
You can create Fund accounts using APIs either with [bank account](https://razorpay.com/docs/build/llm-docs/api/x/fund-accounts/create/bank-account.md) details or [VPA](https://razorpay.com/docs/build/llm-docs/api/x/fund-accounts/create/vpa.md), or [create contacts in bulk](https://razorpay.com/docs/build/llm-docs/x/contacts/bulk-uploads.md).
...
You can also [create and update Fund Account using APIs](https://razorpay.com/docs/build/llm-docs/api/x/fund-accounts.md#list-of-endpoints). 
...
- [Contacts](https://razorpay.com/docs/build/llm-docs/x/contacts.md)
