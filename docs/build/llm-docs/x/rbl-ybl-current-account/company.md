...
SL. No. | Documents
---
1 | [KYC documents](https://razorpay.com/docs/build/llm-docs/x/rbl-ybl-current-account/cif.md) of all Authorised Signatories
---
...
---
7 | Valid address proof in the name of the entity, **if address is not available or is incomplete in the above documents**. [Proof of Company Address](https://razorpay.com/docs/build/llm-docs/x/rbl-ybl-current-account/company/kyc.md#proof-of-company-address-any-1) (any one).
---
