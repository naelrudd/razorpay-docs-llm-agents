...
Sl. No. | Documents
---
1 | [KYC documents](https://razorpay.com/docs/build/llm-docs/x/rbl-ybl-current-account/cif.md) in the name of all authorised signatories/partners.
---
2 | Partnership declaration signed by all the partners.
---
3 | Partnership PAN card.
---
4 | Valid address proof in the name of the entity. [List of acceptable documents](https://razorpay.com/docs/build/llm-docs/x/rbl-ybl-current-account/partnership/kyc.md)(any one).
---
