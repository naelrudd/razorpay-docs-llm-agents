...
A payout transaction is made to a [Fund account](https://razorpay.com/docs/build/llm-docs/x/fund-accounts.md) associated with a [Contact](https://razorpay.com/docs/build/llm-docs/x/contacts.md). Contact is the beneficiary (person or institution) and Fund account is the account used for payment transactions.

**SUCCESS**

**What's New**

You can now initiate payouts directly to mobile numbers using the [Payout Composite API](https://razorpay.com/docs/build/llm-docs/api/x/payout-composite/create/phone-number.md). This feature is currently not available on dashboard.
...
### Features and Functions
            ...
            Payouts in RazorpayX come with variety of features and functions. You can:
                ...
                - [Make payouts in Test Mode](https://razorpay.com/docs/build/llm-docs/x/dashboard/test-mode.md#payouts) to understand the payout process and life cycle.

            If a payout fails at any stage, [a reversal is created](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md#reversal-transaction), which ends with the debited balance being credited back to your RazorpayX account.

            The payout amount, fees and tax are deducted from your RazorpayX account balance. These appear as a debit against your RazorpayX account. Know more about [Billing in RazorpayX](https://razorpay.com/docs/build/llm-docs/x/manage-teams/billing.md).
...
2. Create a Contact and a Fund account. This is similar to adding a beneficiary on your netbanking portal. Know more about adding [Contacts and Fund accounts](https://razorpay.com/docs/build/llm-docs/x/contacts.md).
3. Make a payout.
...
3. Select an existing contact or [create a new one](https://razorpay.com/docs/build/llm-docs/x/contacts.md#create-a-contact).
4. Hover over the fund account to which you want to make the payout and click **NEXT** or [**+ FUND ACCOUNT**](https://razorpay.com/docs/build/llm-docs/x/fund-accounts.md#update-a-contact-and-fund-account) as per requirement.
...
1. [Status Details via API](https://razorpay.com/docs/build/llm-docs/errors/x/payout-status-details.md)
2. [Status Details via Dashboard](https://razorpay.com/docs/build/llm-docs/x/payouts/status-details.md)
3. You can subscribe to daily reports to receive a detailed document on the status, reason for status and SLA for the payouts in `processing state`. [Raise a support ticket](https://razorpay.com/docs/build/llm-docs/x/support.md) from the Dashboard, with a list of recipient email IDs. We will enable the function for you in 3 working days.
...
You can cancel the payouts in a [`queued`](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md#queued), [`pending`](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md#pending) or [`scheduled`](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md#scheduled) state only.
...
Know more about creating [payouts using APIs](https://razorpay.com/docs/build/llm-docs/api/x/payouts.md) and [payouts in bulk](https://razorpay.com/docs/build/llm-docs/x/contacts/bulk-uploads.md).
...
### RazorpayX Lite
         ...
         The transaction limits and operating hours for different payout modes for [RazorpayX Lite](https://razorpay.com/docs/build/llm-docs/x/account-types.md#virtual-account) are as below:
...
### Current Account
         ...
         The transaction limits and operating hours for different payout modes for [Current account](https://razorpay.com/docs/build/llm-docs/x/account-types.md#current-account):
...
[Contact support](https://razorpay.com/docs/build/llm-docs/x/support.md) for enabling **NEFT 24 * 7** in RBL and Yes Bank accounts.
...
- [Payout Status](https://razorpay.com/docs/build/llm-docs/x/payouts/status-details.md)
