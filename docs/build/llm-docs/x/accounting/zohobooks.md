...
### General
       ...
       You can choose to disable or enable the following options:
         ...
         - Sync and Categorise [Vendor Payments](https://razorpay.com/docs/build/llm-docs/x/accounting/zohobooks/vendor-payments.md) from RazorpayX to Zoho Books
         - Sync and Categorise [Payouts](https://razorpay.com/docs/build/llm-docs/x/accounting/zohobooks/payouts.md) from RazorpayX to Zoho Books
