...
The [**Accounting** tab](https://razorpay.com/docs/build/llm-docs/x/accounting.md) appears on your RazorpayX Dashboard left navigation. You can change the existing settings from **Accounting** → [**Rules & Configuration**](#rules--configuration) at any time.
...
### General
       ...
       You can choose to disable or enable the following options:
         ...
         - Sync and Categorise [Vendor Payments](https://razorpay.com/docs/build/llm-docs/x/accounting/zohobooks/vendor-payments.md) from RazorpayX to Tally
         - Sync and Categorise [Payouts](https://razorpay.com/docs/build/llm-docs/x/accounting/zohobooks/payouts.md) from RazorpayX to Tally
...
### Rules
       ...
       - Contact Rules
         - Set contact rules for [categorisation of Vendor Payments](https://razorpay.com/docs/build/llm-docs/x/accounting/zohobooks/vendor-payments.md#categorise).
       ...
       - Purpose Rules
         - Set purpose rules for [categorisation of Payouts](https://razorpay.com/docs/build/llm-docs/x/accounting/zohobooks/payouts.md#categorise).
