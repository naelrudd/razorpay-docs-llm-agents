...
The [smart bank statement sync](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/bank-statement-sync.md) feature is available as part of the [Tally Integration](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally.md). With this integration, you can understand your transactions in a business perspective, rather than just a banking perspective.

The account statements is synced every day at **6:00 am** and **8:00 pm**.

## Prerequisites

See [RazorpayX-Tally Integration](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/set-up.md). 
