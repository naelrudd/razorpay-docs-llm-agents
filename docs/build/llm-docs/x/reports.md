...
3. Select the type of report:
    ...
    - [Account Statement](https://razorpay.com/docs/build/llm-docs/x/account-statement.md)
    - [TDS/Advance Tax Challans](https://razorpay.com/docs/build/llm-docs/x/tax-payments.md)
    - [Sub-Account Limits](https://razorpay.com/docs/build/llm-docs/x/payouts/sub-accounts.md)
    - [Purchase Orders](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/purchase-order.md)
    - [Vendor Advances](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/advances.md)
    - [Vendor Invoices](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md)
