...
---
RazorpayX Account | **RazorpayX Account** is a Current Account used for business transactions. Know more about [RazorpayX Accounts](https://razorpay.com/docs/build/llm-docs/x/account-types.md). 
---
...
---
Contact | A **Contact** is an entity to whom payouts are made. [Contacts](https://razorpay.com/docs/build/llm-docs/x/contacts.md#contacts/) have certain identification properties such as name, email id and phone number. To make a payout to a contact, you must add a fund account to the contact.
---
Fund Account | **Fund Account** is an entity to which payouts can be made. Currently, RazorpayX supports three types of [fund accounts](https://razorpay.com/docs/build/llm-docs/x/contacts.md#fund-accounts/):
...
Know more about tax payment [here](https://razorpay.com/docs/build/llm-docs/x/tax-payments.md).
---
...
- [Contacts and Fund Accounts](https://razorpay.com/docs/build/llm-docs/x/contacts.md)
