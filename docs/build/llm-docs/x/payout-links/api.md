...
---
[Create Payout Links Using Contact Details](https://razorpay.com/docs/build/llm-docs/api/x/payout-links/create/use-contact-details.md) | Creates a Payout Link using customer's contact details like email id/mobile number. 
---
[Create Payout Links Using Contact ID](https://razorpay.com/docs/build/llm-docs/api/x/payout-links/create/use-contact-id.md) | Creates a Payout Link using the Contact id of the customer. [Create a Contact](https://razorpay.com/docs/build/llm-docs/x/contacts.md#list-of-endpoints) to generate the Contact id. 
---
