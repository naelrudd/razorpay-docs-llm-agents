...
After processing your [Payout Links bulk upload](https://razorpay.com/docs/build/llm-docs/x/payout-links/bulk.md#process-bulk-payout-links) file, RazorpayX generates a Bulk Upload report. The report shows the: 
...
- Additional details as per the [fields requested](https://razorpay.com/docs/build/llm-docs/x/payout-links/bulk.md#requested-fields-in-template) in the sample template for Payout Links.
...
---
3 | Expiry Date missing, but Expiry Time present | Expiry time has been entered but not the expiry date. Enter expiry date in the batch file and upload again. Know about [Payout Link Expiry](https://razorpay.com/docs/build/llm-docs/x/payout-links/set-expiry.md).
---
...
- [Payout Links Life Cycle](https://razorpay.com/docs/build/llm-docs/x/payout-links/life-cycle.md)  
- [Payout Links FAQs](https://razorpay.com/docs/build/llm-docs/x/payout-links/faqs.md)
