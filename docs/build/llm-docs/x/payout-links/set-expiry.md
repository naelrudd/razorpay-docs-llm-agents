...
- Once you enable expiry for Payout Links from the Dashboard, you can find the expiry parameters in the API response too (if you are using the [Payout Links API](https://razorpay.com/docs/build/llm-docs/api/x/payout-links.md)).
