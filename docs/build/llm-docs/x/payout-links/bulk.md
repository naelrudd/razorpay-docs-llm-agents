...
You need your recipients' contact details to send the link. Once they receive the Payout Link, they can enter their account details. RazorpayX then creates a [Contact](https://razorpay.com/docs/build/llm-docs/x/contacts.md) and the respective [Fund Account](https://razorpay.com/docs/build/llm-docs/x/fund-accounts.md). 
...
: `string` After you [enable expiry](https://razorpay.com/docs/build/llm-docs/x/payout-links/set-expiry.md#enable-expiry), you can set the expiry date for the payout link. For example, `22/07/2021`. 

`Expiry Time` _optional_
: `string` After you [enable expiry](https://razorpay.com/docs/build/llm-docs/x/payout-links/set-expiry.md#enable-expiry), you can enter the expiry time for the payout link. Input should be in the 24-hour format. For example, `14:52`.
...
You can also [set expiry on Payout Links](https://razorpay.com/docs/build/llm-docs/x/payout-links/set-expiry.md).
...
The processed state means the bulk file was fully processed. To check the status of the individual Payout Links, download the [Bulk Payout Links Report](https://razorpay.com/docs/build/llm-docs/x/payout-links/report-and-errors.md).
...
Know more about [Payout Links Statuses](https://razorpay.com/docs/build/llm-docs/x/payout-links/life-cycle.md) and [Payout Statuses](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md#payout-states).

### Related Information

- [About Payout Links](https://razorpay.com/docs/build/llm-docs/x/payout-links.md)
- [Set Expiry for Payout Links](https://razorpay.com/docs/build/llm-docs/x/payout-links/set-expiry.md)  
