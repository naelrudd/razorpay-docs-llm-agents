...
As soon as a Payout Link is created, it immediately moves to the `pending` state as shown in the image below. The Payout Link remains in this state until it is sent for approval. This status is applicable only for cases where [Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/manage-teams/approval-workflow.md) is enabled.
...
Know how you can [set Payout Links to expire](https://razorpay.com/docs/build/llm-docs/x/payout-links/set-expiry.md) after a certain duration. 

### Rejected

A Payout Link moves to the `rejected` state if it is rejected by the Approver. This status is applicable only for cases where [Approval Workflow](https://razorpay.com/docs/build/llm-docs/x/manage-teams/approval-workflow.md) is enabled.
...
Refer to [Payout Life Cycle and States](https://razorpay.com/docs/build/llm-docs/x/payouts.md#payout-life-cycle) for more information.

### Related Information

- [About Payout Links](https://razorpay.com/docs/build/llm-docs/x/payout-links.md)
- [Bulk Payout Links](https://razorpay.com/docs/build/llm-docs/x/payout-links/bulk.md)
