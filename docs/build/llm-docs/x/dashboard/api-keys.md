...
After you [set up your RazorpayX account](https://razorpay.com/docs/build/llm-docs/x/set-up.md), you can generate API keys in both Test mode and Live mode. 
...
- [Allowlist IPs](https://razorpay.com/docs/build/llm-docs/x/dashboard/allowlist-ip.md)

### Related Information

- [About RazorpayX](https://razorpay.com/docs/build/llm-docs/x.md)
- [Payout APIs](https://razorpay.com/docs/build/llm-docs/x/apis.md)
