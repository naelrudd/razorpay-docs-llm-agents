...
First, [add invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md) on the RazorpayX Dashboard.
...
Know more about the [Invoice Life Cycle](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/life-cycle.md).

**INFO**

**Handy Tips**

In case an [accounting integration](https://razorpay.com/docs/build/llm-docs/x/accounting.md) is enabled, the invoices sync only post-approval.

Know how to [approve or reject invoices via email](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/approve-invoices.md).
...
- [Approve Invoices](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/approve-invoices.md)
