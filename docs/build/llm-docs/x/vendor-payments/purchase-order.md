...
Before creating your first Purchase Order, set your **Billing Address** via [Branches](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/multi-branch-management.md) that will appear on the header of the Purchase Order. You can add only 1 billing address.
...
This approval workflow is based on the [cost center](https://razorpay.com/docs/build/llm-docs/x/cost-centers.md) that you have linked to your PO. You can [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md) to setup this approval workflow and assign it to relevant team members.
