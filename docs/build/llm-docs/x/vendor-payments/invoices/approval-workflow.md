...
This approval workflow is based on the [cost center](https://razorpay.com/docs/build/llm-docs/x/cost-centers.md) that you have linked to your invoice. You can add a cost center to your invoice at the time of creation and the workflow linked to that cost center for an invoice will become applicable to your invoice.

You can [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md) to setup this approval workflow and assign it to relevant team members.

While [creating or adding an invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md#add-invoices), you can **Link PO** and add a **Cost Center** in the **Invoice Details** section.
