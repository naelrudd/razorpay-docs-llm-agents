...
- [Payment of invoices issued to respective branches](https://razorpay.com/docs/build/llm-docs/x/vendor-payments.md#invoices-and-advances).
...
Know more about [accounting integrations](https://razorpay.com/docs/build/llm-docs/x/accounting.md).
