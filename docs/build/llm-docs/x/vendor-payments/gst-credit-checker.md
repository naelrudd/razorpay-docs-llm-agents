...
This feature is available only for GST registered businesses. If you want to update your GSTIN on RazorpayX, [contact support](https://razorpay.com/docs/build/llm-docs/x/support.md).
