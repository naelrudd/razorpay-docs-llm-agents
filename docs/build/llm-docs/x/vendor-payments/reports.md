...
To generate a report, you can either navigate to [**Reports**](https://razorpay.com/docs/build/llm-docs/x/reports.md) on the RazorpayX Dashboard or follow the steps below:
...
You can share the invoice report with your Chartered Accountant or Financial Manager via the [CA user role feature](https://razorpay.com/docs/build/llm-docs/x/manage-teams/ca-portal.md) available in RazorpayX.
