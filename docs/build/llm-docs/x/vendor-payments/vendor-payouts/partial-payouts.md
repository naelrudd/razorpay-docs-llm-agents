...
5. You must now create a payout. 
    - In the **New Payout** window, enter the Contact's valid details and [create a Fund Account](https://razorpay.com/docs/build/llm-docs/x/contacts.md#create-a-contact-with-fund-account) if the Contact doesn't have one. You can also select the [Contact type](https://razorpay.com/docs/build/llm-docs/x/contacts.md#contact-types) to be `Vendor`.
