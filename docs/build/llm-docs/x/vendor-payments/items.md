...
[Invoices](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md) and [purchase orders](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/purchase-order.md) often feature multiple items, making them records of a business transactions. The effective use of items streamlines the process of procurement, sales and financial management, contributing to more efficient and accurate business operations.
...
4. Enter the fields mentioned [above](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/items.md#item-fields).
5. Click **Save**.
