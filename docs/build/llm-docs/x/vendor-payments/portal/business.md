...
6. You can either **Invite all vendors** or **Select vendors** from the contact list. Only the [Contact type](https://razorpay.com/docs/build/llm-docs/x/contacts.md#contact-types) saved as **vendor** is eligible to use the portal.
...
Check and share the url: [https://razorpay.com/docs/x/vendor-payments/portal](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/portal.md) with your vendors for them to see the activities they can perform on the portal.
