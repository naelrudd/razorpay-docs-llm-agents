...
4. Search and select from existing contacts or create [**+ NEW CONTACT**](https://razorpay.com/docs/build/llm-docs/x/contacts.md#create-a-contact).
...
- When you [add an invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md#add-invoices) for a vendor to whom you have already paid an advance, RazorpayX recognises it and asks you if that particular advance is relevant to the current invoice. 
