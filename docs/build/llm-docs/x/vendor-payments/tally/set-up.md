...
After setup, change or modify the settings in your Tally application to make the [four flows](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally.md#four-flows) of the integration work seamlessly.
...
Start integrating RazorpayX with Tally by yourself or invite your Finance Team to do it. Know more about [managing teams and user roles](https://razorpay.com/docs/build/llm-docs/x/manage-teams.md) in RazorpayX. 
...
To fully configure the application, enable and disable the settings as per the [four flows](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally.md#four-flows) applicable to your business. 
- If you choose to [bring bills](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/bring-bills.md) to Tally from RazorpayX, enable it at this step. 
- You can change the settings to sync [Purchase Vouchers](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/sync-purchase-vouchers.md) and [Payment Vouchers](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/sync-payment-vouchers.md) entries in Tally and RazorpayX. Select **Yes** against only one of them at a time. 
...
- [Create RazorpayX Ledger](https://razorpay.com/docs/build/llm-docs/x/tally-epayments/set-up.md)
