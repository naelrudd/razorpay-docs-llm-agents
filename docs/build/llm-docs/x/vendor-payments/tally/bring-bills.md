...
2. The bills received from the below-mentioned modes are auto-read by the RazorpayX AI OCR reader. You can create bills in RazorpayX via: - [Vendor Portal](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/portal/business.md)
- [Bulk drag and drop](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/bulk-invoices.md)
- [Email Integration](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md#add-invoices-through-email)
 You can pay bills in RazorpayX via: - [Bulk Payouts](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/vendor-payouts/bulk.md)
- [Partial Payouts](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/vendor-payouts/partial-payouts.md)
- [Scheduled Payouts](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/vendor-payouts/scheduled-payouts.md)
...
When you [generate an invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments.md) in Vendor Payments, you can automate bringing that bill to Tally. 
...
After you [create an invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments.md) in Vendor Payments, sync the bill in Tally. To do so: 
