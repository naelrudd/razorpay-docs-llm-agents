...
Whether you [make a payout](https://razorpay.com/docs/build/llm-docs/x/payouts.md#how-to-make-payouts), or the money is debited as part of a [payout link](https://razorpay.com/docs/build/llm-docs/x/payout-links.md), payroll, tax payments and more, **all transactions** can be synced in Tally. 
...
- [Bring bills from RazorpayX to Tally](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/bring-bills.md)
- Sync Vouchers in RazorpayX
   - [Purchase Vouchers](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/sync-purchase-vouchers.md)
   - [Payment Vouchers](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/sync-payment-vouchers.md)
