...
After you [set up and configure the integration](https://razorpay.com/docs/build/llm-docs/x/accounting/tally.md), you can send your [Payment Vouchers](#send-and-sync-payment-vouchers-to-razorpayx) to RazorpayX and sync them for reconciliation. 
...
Go to RazorpayX and pay your invoices as per the standard [vendor payment flow](https://razorpay.com/docs/build/llm-docs/x/vendor-payments.md).
...
All the payments made can be brought back to Tally. Know more about [bringing bills to Tally](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/bring-bills.md) from RazorpayX.
