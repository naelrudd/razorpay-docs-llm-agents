...
After you [set up and configure the integration](https://razorpay.com/docs/build/llm-docs/x/accounting/tally.md), you can send your Purchase Vouchers to RazorpayX and sync them for reconciliation.
...
If the section is empty, [create a Contact](https://razorpay.com/docs/build/llm-docs/x/contacts.md) of the type Vendor and [create a Fund Account](https://razorpay.com/docs/build/llm-docs/x/fund-accounts.md) for that Contact. 
...
You have now successfully synced a Purchase Voucher made in Tally to RazorpayX. Know more about [syncing Payment Vouchers](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/sync-payment-vouchers.md). 

## Pay Invoices

After you send and sync the vouchers in RazorpayX, you can pay the invoices in the following ways:
- [Pay your vendor immediately](https://razorpay.com/docs/build/llm-docs/x/vendor-payments.md).
- [Pay vendor partially](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/vendor-payouts/partial-payouts.md).
- [Schedule the vendor payment](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/vendor-payouts/scheduled-payouts.md).
- [Make vendor payouts in bulk](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/vendor-payouts/bulk.md).

All the payments made can be brought back to Tally. Know more about [bringing bills](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/bring-bills.md) to Tally from RazorpayX.

### Related Information

- [Bring Bills to Tally](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/tally/bring-bills.md) 
