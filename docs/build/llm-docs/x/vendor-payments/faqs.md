...
### 3. Can I cancel a Payout for an invoice in the processing state?
         ...
         Yes, you can reject or cancel the payout in processing state. Know more about [Vendor Payments Life Cycle](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/life-cycle.md#processing).
        

    
### 4. After uploading an invoice, can I replace it?

         Yes, you can [replace an invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md#replace-an-invoice) after it has been added.
        

    
### 5. How to cancel an invoice?

         Refer to the [Cancel an Invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md#cancel-an-invoice) section.
...
### 7. After uploading an invoice how to set reminders to make the payment?
         ...
         When you upload and [save an invoice](https://razorpay.com/docs/build/llm-docs/x/vendor-payments/invoices.md#add-invoices), we send automatic reminders to make payment. Reminder emails are sent to your registered email address. We also show you reminder alerts on the Dashboard.
...
### 9. I uploaded an invoice but made the payment offline. Do I have to cancel the invoice?
         ...
         No, you need not cancel the invoice. You can instead [Mark as Paid](https://razorpay.com/docs/build/llm-docs/x/vendor-payments.md#mark-invoice-as-paid).
...
### 2. Why is the TDS calculated not showing up in the Tax Payment section after uploading and saving the invoice?
         ...
         TDS is recorded in the Tax Payment section only when you [make a vendor payment](https://razorpay.com/docs/build/llm-docs/x/vendor-payments.md#invoices). It is not recorded when you upload and save an invoice.
...
### 4. What happens if I do not have sufficient account balance on the 4th to make the TDS payment?
         ...
         If you do not have enough balance on the 4th, we [queue](https://razorpay.com/docs/build/llm-docs/x/payouts/states-life-cycle.md#queued) the Payout and send out reminders. You can add balance to your account and manually initiate the payment from the [RazorpayX Dashboard](https://x.razorpay.com/auth). 
