...
When firing [Contact APIs](https://razorpay.com/docs/build/llm-docs/api/x/contacts.md), you might run into errors for various reasons. These error codes are returned in an error body, which you can use to understand the reason for the error and the steps to resolve it.
...
`field`
: The Contact details in the [Contact entity](https://razorpay.com/docs/build/llm-docs/api/x/contacts.md#contact-entity) such as `name`, `email`, `type` and so on.

### Related Information

- [Contact APIs](https://razorpay.com/docs/build/llm-docs/api/x/contacts.md)
