# Razorpay POS Error Codes and Troubleshooting

Razorpay POS APIs, when fired, can have either a successful response or a failure response. All successful Razorpay POS API responses return with HTTP Status code 200. In case of failure, a JSON error response is returned with the relevant error parameters.
...
## POS error categories

- [Device and Hardware Errors](https://razorpay.com/docs/build/llm-docs/errors/pos/device-errors.md)
- [Payment Processing Errors](https://razorpay.com/docs/build/llm-docs/errors/pos/payment-errors.md)
- [System and Configuration Errors](https://razorpay.com/docs/build/llm-docs/errors/pos/system-configuration-error.md)
