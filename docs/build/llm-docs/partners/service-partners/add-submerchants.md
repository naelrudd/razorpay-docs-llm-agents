...
Once the file is successfully processed, you will receive the account creation status via email. The email attachment will include both success and/or failure details for each account, including the error code and exact reason for the failure.
        ...
        - To get started, the Sub-merchants must proceed to complete the [Account Set Up](https://razorpay.com/docs/build/llm-docs/payments/set-up.md) and [KYC Verification](https://razorpay.com/docs/build/llm-docs/payments/set-up.md#2-submit-kyc-details) processes by using their Razorpay account credentials.
...
## Actions After Inviting
        ...
        Your contact will receive an invite via email and SMS to create a Razorpay account. To get started, the contacts invited for `Payment` products, must proceed to create a Razorpay account and complete account activation and [KYC Verification](https://razorpay.com/docs/build/llm-docs/payments/set-up.md#2-submit-kyc-details). Sub-merchants invited for `Payments` can be seen under **Payments**.
...
- [About Service Partners](https://razorpay.com/docs/build/llm-docs/partners/service-partners.md)
- [Partner Commissions](https://razorpay.com/docs/build/llm-docs/partners/commissions.md)
