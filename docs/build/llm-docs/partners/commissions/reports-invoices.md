...
The commission data under the **Earnings** tab is based on the Partner type and the following factors:
        ...
        The commission data is displayed if the third-party application with Razorpay is created (for client credentials) and [OAuth](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth.md) integration is necessary.
...
The **Invoices** section is available for partners who have commissions processed using the [Commission Payout with Auto-generated Invoice](https://razorpay.com/docs/build/llm-docs/partners/commissions/settlement-process.md#automated-invoice-commission-payout) process. The following columns are displayed:
...
### Related Information
- [Commission for Payment Products](https://razorpay.com/docs/build/llm-docs/partners/commissions.md)
- [Referral Bonus for RazorpayX powered Current Accounts](https://razorpay.com/docs/build/llm-docs/partners/commissions/referral-bonus.md)
- [Commission Settlement Process](https://razorpay.com/docs/build/llm-docs/partners/commissions/settlement-process.md)
