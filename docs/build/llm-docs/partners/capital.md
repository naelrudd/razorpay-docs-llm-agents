...
[Razorpay Capital](https://razorpay.com/docs/build/llm-docs/x.md) is a lending platform enabling businesses to meet their cash flow challenges. With the Partnership program for Capital, you can refer businesses to Razorpay [Line of Credit](https://razorpay.com/x/line-of-credit/) and earn lucrative rewards when your leads use the product. 
...
1. Sign up or log in to your Dashboard.
    - [New to Razorpay](https://razorpay.com/docs/build/llm-docs/partners/new-to-razorpay.md). 
    - [Existing Razorpay Merchant](https://razorpay.com/docs/build/llm-docs/partners/existing-merchant.md#become-a-razorpay-partner). 
...
1. Open the link and [sign up for the Partner Program](https://razorpay.com/docs/build/llm-docs/partners.md#next-steps).
...
- [Line of Credit](https://razorpay.com/docs/build/llm-docs/x/capital/line-of-credit.md)
