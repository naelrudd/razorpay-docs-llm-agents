...
You can become a Razorpay Partner, offer your customers a complete suite of payment solutions and get rewarded for it in the form of [commissions](https://razorpay.com/docs/build/llm-docs/partners/commissions.md). As an existing Razorpay merchant, you can join the Razorpay Partnership program by completing a few simple steps.
...
- All Partners are onboarded as Service Partners by default. If you have a use case, you can request a Partner type switch to [Technology Partners](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/become-technology-partner.md).
...
Know how to [add new sub-merchants](https://razorpay.com/docs/build/llm-docs/partners/service-partners/add-submerchants.md) on your Dashboard.

### Related Information

- [Partners](https://razorpay.com/docs/build/llm-docs/partners.md)
- [Become a Partner - New to Razorpay](https://razorpay.com/docs/build/llm-docs/partners/new-to-razorpay.md)
