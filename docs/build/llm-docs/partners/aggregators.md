...
After onboarding as a Razorpay Partner, you need to request a Partner type switch to [become an Aggregator](https://razorpay.com/docs/build/llm-docs/partners/aggregators/become-aggregator.md).

## Add Sub-merchants

You can add your affiliate partners/sub-merchants directly using the Dashboard. Know more about [adding sub-merchants](https://razorpay.com/docs/build/llm-docs/partners/aggregators/add-submerchants.md).
...
Know more about [user roles](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#standard-user-roles).
...
Know more about [using the Partner credentials](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth.md).
...
You can also set up webhooks for specific events on the sub-merchant account. Know more about [webhooks](https://razorpay.com/docs/build/llm-docs/webhooks.md).
...
- [Aggregators - Add Sub-merchants](https://razorpay.com/docs/build/llm-docs/partners/aggregators/add-submerchants.md)
