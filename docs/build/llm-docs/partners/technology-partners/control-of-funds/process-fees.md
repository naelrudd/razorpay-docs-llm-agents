...
The parameter descriptions and errors are present in the [Create Transfers from Orders](https://razorpay.com/docs/build/llm-docs/api/payments/route.md) documentation.

## Set Up Webhooks

To receive notifications on when a transfer is processed, set up the [`transfer.processed` webhook event](https://razorpay.com/docs/build/llm-docs/webhooks/setup-edit-payments.md). Check the [sample payload for Transfer Processed](https://razorpay.com/docs/build/llm-docs/webhooks/route.md#transfer-processed).
...
- [Set up Platform and Third-Party Accounts](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/control-of-funds/set-up-accounts.md)
- [Refunds and Reversals](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/control-of-funds/refunds-and-reversals.md)
