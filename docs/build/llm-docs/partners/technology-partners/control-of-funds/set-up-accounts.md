...
You can create Linked Accounts using [Dashboard](https://razorpay.com/docs/build/llm-docs/payments/route/linked-account.md#add-and-manage-linked-accounts) and [APIs](https://razorpay.com/docs/build/llm-docs/api/payments/route.md).
