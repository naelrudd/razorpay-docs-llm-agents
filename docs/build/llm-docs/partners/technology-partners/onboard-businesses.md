...
- [Sign up as Partner](https://razorpay.com/partners/) and complete KYC to activate your account. Request for a partner type [switch to Technology Partner](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/become-technology-partner.md).
...
- [Register your application](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps.md#1-create-an-application) on Razorpay.
...
1. [Integrate with Razorpay OAuth](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth.md)
2. [Customise client Onboarding](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/settings.md)
...
[Integrate with Custom Onboarding SDK](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/onboarding-sdk.md) to create a customer account using APIs and pre-fill KYC details.

### Related Information 

- [Track Onboarding Status](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/status.md)
