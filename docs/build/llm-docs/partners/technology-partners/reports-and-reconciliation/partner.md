...
If your Linked Account is created with the same email as your Partner account, log in to your Partner account and **Switch Merchant**. If the email is different, log in to the Linked Account [set up earlier](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/control-of-funds/set-up-accounts.md).
