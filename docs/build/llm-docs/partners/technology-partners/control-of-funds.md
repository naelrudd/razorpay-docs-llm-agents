...
1. [Set up Platform and Third-Party Accounts](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/control-of-funds/set-up-accounts.md)
2. [Process Platform and Third-Party Fees](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/control-of-funds/process-fees.md)

You can also create [refunds and reversals](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/control-of-funds/refunds-and-reversals.md) for transactions.
