...
All Partners are onboarded as Service Partners by default. You can request a switch if you have a use case for the Technology Partner type. Know how to become a [Razorpay Partner](https://razorpay.com/docs/build/llm-docs/partners/new-to-razorpay.md).
...
If your switch request is approved, you will have to complete [full KYC](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/kyc.md) to start receiving commissions.
...
- [Submit KYC Details](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/kyc.md)
