...
2. **GST Details**: This will be auto-filled if your [PAN verification](https://razorpay.com/docs/build/llm-docs/payments/business-types-kyc-documents.md) is successful. If not, add your GST details for taxation and compliance. Select the check box if you do not have a GSTIN. Click **Done**.
...
4. **Business Documents**: Upload the relevant [business documents](https://razorpay.com/docs/build/llm-docs/payments/business-types-kyc-documents.md) based on your business type.
