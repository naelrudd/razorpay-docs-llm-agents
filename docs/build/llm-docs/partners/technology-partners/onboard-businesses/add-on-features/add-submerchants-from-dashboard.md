...
You can use the `Switch` option to access the sub-merchant's account. Once you are on the sub-merchant's Dashboard, you can perform all the actions that the sub-merchant can perform. Know more about [switching to sub-merchant Dashboard](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/add-on-features/switch-dashboard.md).
...
- [About Embedded Payments](https://razorpay.com/docs/build/llm-docs/partners/technology-partners.md)
- [Perform Sub-merchant KYC](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/add-on-features/perform-submerchant-kyc.md)
- [Switch to Sub-merchant Dashboard](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/add-on-features/switch-dashboard.md)
