...
3. Copy the auth `code` from the URL and use it to obtain the new [access token](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps.md#22-get-access-token).
