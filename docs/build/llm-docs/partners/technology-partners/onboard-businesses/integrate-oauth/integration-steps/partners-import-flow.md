...
After completion, the sub-merchant's browser is redirected to URI specified in the `redirect_uri` parameter. Once the [sub-merchant authorises](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps/sub-merchants.md), you can proceed with the steps ahead.
...
### Response Parameters
     ...
     Once the sub-merchant authorises, the following tokens become available to both you and the sub-merchant. You can use these tokens later to create API requests on behalf of the sub-merchant. Know more [about tokens](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps/sub-merchants.md#about-tokens).
...
### Error Response Parameters
             ...
             Refer to our [errors](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/errors.md#revoke-token-api) page for the list of errors and solutions.
...
### 1. Access Customer APIs using OAuth
     ...
     You can process payments on behalf of your sub-merchants using [Razorpay APIs](https://razorpay.com/docs/build/llm-docs/api.md). Use the tokens generated during [OAuth integration](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps/partners-import-flow.md).

     Use the `access_token` generated in the [build integration](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps/partners-import-flow.md#22-get-access-token) step to authenticate using `Bearer Auth`.
     ...
     Below is a sample code to create a customer in server.
      ...
      The parameter descriptions and errors are present in the [Create a Customer API](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/build-integration/saas.md#11-create-a-customer-in-server).
...
### 2. Access Order APIs using OAuth
     ...
     Below is a sample code to create an Order and process payments.
      ...
      The parameter descriptions and errors are present in the [Create an Order API](https://razorpay.com/docs/build/llm-docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/build-integration/saas.md#12-create-an-order-in-server).
...
Follow these steps to [subscribe to webhooks](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/subscribe-to-webhooks.md).
...
[2. Test Integration](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/test-integration.md)

### Related Information

- [Revoke Access to Application](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/revoke-access.md)
- [Standard Web Integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard.md)
- [Errors](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth/errors.md)
