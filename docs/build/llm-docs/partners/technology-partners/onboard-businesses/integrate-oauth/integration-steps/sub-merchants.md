...
Only the person with [Owner](https://razorpay.com/docs/build/llm-docs/payments/dashboard/account-settings/manage-team.md#owner) credentials of the sub-merchant account can authorise the access.
