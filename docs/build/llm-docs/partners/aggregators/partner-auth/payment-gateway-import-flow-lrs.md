...
After the order is created, an `order_id` is generated, for example, `order_NGrgEcmYJsfUyl`. You must pass this `order_id` in the checkout code to associate this order with the payment. Learn more about [Order and Payment states](https://razorpay.com/docs/build/llm-docs/payments/orders.md#order-states).
...
- [Invoice Collection](https://razorpay.com/docs/build/llm-docs/payments/international-payments/outward-remittances/standard-integration/invoice-collection.md)
- [Test Integration](https://razorpay.com/docs/build/llm-docs/payments/international-payments/outward-remittances/standard-integration/test-integration.md)
