...
: `string` The unique identifier of the customer created using [Customers API](https://razorpay.com/docs/build/llm-docs/payments/customers.md).
...
: `string` Order ID generated via [Razorpay Orders API](https://razorpay.com/docs/build/llm-docs/api/orders.md).
...
: `string` Name of the payment method. Possible values are:
    ...
    - `emi` (default)
    - `upi` (default)
    - `bank_transfer` (requires [approval](https://razorpay.com/support/#request) and [integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bank-transfer.md))
    - `cardless_emi` (requires [approval](https://razorpay.com/support/#request) and [integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/cardless-emi.md))
    - `paylater` (requires [approval](https://razorpay.com/support/#request) and [integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/pay-later.md))
...
: `string` Bank code. List of available banks enabled for your account can be fetched via [**methods**](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom.md#step-3-fetch-payment-methods).
...
: `string` Wallet code for the wallet used for the payment. Possible values:
    ...
    - `amazonpay` (requires [approval](https://razorpay.com/support/#request) and [integration](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/wallets/amazon-pay.md))
    - `paypal` (requires [approval](https://razorpay.com/support/#request). [Learn more](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/wallets/paypal.md))
    - `phonepeswitch` (requires [approval](https://razorpay.com/support/#request) and [integration](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/custom/phonepe-switch.md))
...
### Other Token APIs
- [Token IIN API](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards/token-hq/merchant-requestor/iin-validation.md) 
- [PAR API](https://razorpay.com/docs/build/llm-docs/api/payments/cards/fingerprints.md) 
- [Fetch Card IIN Information API](https://razorpay.com/docs/build/llm-docs/api/payments/cards/iin-api.md)
