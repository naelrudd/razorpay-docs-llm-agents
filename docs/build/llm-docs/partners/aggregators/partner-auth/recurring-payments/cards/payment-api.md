...
- Individual [Orders](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/cards/authorization-transaction.md#112-create-an-order) and [Payments](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/s2s-integration/recurring-payments/cards/authorization-transaction.md#113-create-an-authorization-payment) APIs
...
`notes` _optional_
: `json object` Key-value object used for passing tracking info. Refer to [Notes](https://razorpay.com/docs/build/llm-docs/api/understand.md#notes) for more details.
