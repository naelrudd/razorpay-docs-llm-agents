...
Use the Partner credentials as described in the [Dashboard Guide](https://razorpay.com/docs/build/llm-docs/partners/aggregators.md#partner-credentials) as Basic Auth.
...
### Using Razorpay S2S APIs (Cards Only)
         ...
         Following is the integration flow to [collect recurring card payments using Razorpay payment APIs](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth/recurring-payments/cards/payment-api.md):
...
### Using a Registration Link
         ...
         Following is the integration flow to collect recurring payments using a registration link:
            1. Create a registration link and send it to your customer. The customer completes the authorisation payment, which generates a token. This payment can be authorised using one of the following instruments:
                - [Emandate](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth/recurring-payments/emandate/registration.md)
                - [Card](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth/recurring-payments/cards/registration-links/create-authorisation-transaction.md)
                - [UPI](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth/recurring-payments/upi/create-authorisation-transaction.md)
...
- [Emandate](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth/recurring-payments/emandate/registration.md)
- [Cards](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth/recurring-payments/cards/payment-api.md)
- [UPI](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth/recurring-payments/upi/create-authorisation-transaction.md)
- [UPI with TPV](https://razorpay.com/docs/build/llm-docs/partners/aggregators/partner-auth/recurring-payments/upi-tpv/create-authorisation-transaction.md)
