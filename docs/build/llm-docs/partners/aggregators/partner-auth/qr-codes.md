...
Consider these [prerequisites](https://razorpay.com/docs/build/llm-docs/payments/qr-codes.md#prerequisites) before getting started with QR Codes.

## Create a QR Code API

Given below is the sample code for Create a QR Code API. Pass the `account_id` of the sub-merchant using `X-Razorpay-Account` in the header. Refer to the [QR Codes API documentation](https://razorpay.com/docs/build/llm-docs/api/qr-codes.md).
...
: `string` The type of QR code. Possible values:
  ...
  - `bharat_qr`: Create a QR code that accepts UPI and card payments. This is an on-demand feature. Know more about [Bharat QR](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/bharatqr.md).
...
: `string` Unique identifier of the customer the QR code is linked with. Know more about the [Customers API](https://razorpay.com/docs/build/llm-docs/api/customers.md).
...
Descriptions for the response parameters are present in the [QR Codes Entity](https://razorpay.com/docs/build/llm-docs/api/qr-codes.md#qr-code-entity) parameters table.

### Error Response Parameters

Error codes and descriptions are present in the [Error Response Parameters](https://razorpay.com/docs/build/llm-docs/api/qr-codes.md#error-response-parameters) table.
...
Error codes and descriptions are present in the [Error Response Parameters](https://razorpay.com/docs/build/llm-docs/api/qr-codes.md#error-response-parameters-2) table.

### Related Information

- [QR Codes API documentation](https://razorpay.com/docs/build/llm-docs/api/qr-codes.md)
