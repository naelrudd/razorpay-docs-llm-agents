...
Given below is the sample code for Create a Payment Link API. You should send the `account_id` of the sub-merchant using `X-Razorpay-Account` in the header. Refer to the [Payment Links API documentation](https://razorpay.com/docs/build/llm-docs/api/payments/payment-links.md).
...
- [Payment Links API documentation](https://razorpay.com/docs/build/llm-docs/api/payments/payment-links.md).
