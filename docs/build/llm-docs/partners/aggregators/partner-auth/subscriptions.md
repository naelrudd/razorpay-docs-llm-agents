...
You should [create a plan](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions/create-plan.md) before creating a subscription.
...
- [Subscriptions API documentation](https://razorpay.com/docs/build/llm-docs/api/payments/subscriptions.md).
