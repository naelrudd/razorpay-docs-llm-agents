...
- To complete the onboarding process for the sub-merchant, check the [KYC document requirements](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md#kyc-requirements).
...
OAuth uses `Bearer Auth`. Know more about [OAuth](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/integrate-oauth.md).
...
- Access to [sub-merchant account status webhooks](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/status.md).
- [Onboarding UI configurator](https://razorpay.com/docs/build/llm-docs/partners/technology-partners/onboard-businesses/settings.md) on Partner Dashboard.
...
Given below is a sample code for the [Fetch an Account API](https://razorpay.com/docs/build/llm-docs/api/partners/account-onboarding/fetch.md).
...
API | Description
---
[Account APIs](https://razorpay.com/docs/build/llm-docs/api/partners/account-onboarding.md) | Create, view, update and delete sub-merchant accounts.
---
[Stakeholders APIs](https://razorpay.com/docs/build/llm-docs/api/partners/stakeholder.md) | Create, view and update stakeholders.
---
[Product Configuration APIs](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration.md) | Request, view and update a product configuration.
---
[Documents APIs](https://razorpay.com/docs/build/llm-docs/api/partners/upload-document.md) | Upload and view account and stakeholder documents.
---
[Webhooks APIs](https://razorpay.com/docs/build/llm-docs/api/partners/webhooks.md) | Create, view, update and delete webhook events.
---
[Terms and Conditions APIs](https://razorpay.com/docs/build/llm-docs/api/partners/terms-conditions.md) | View and accept terms and conditions.
...
- [Update Settlement Account Details](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration/update-settlement-account-details.md)
- [Update a Stakeholder](https://razorpay.com/docs/build/llm-docs/api/partners/stakeholder/update.md)

- [Upload Documents](https://razorpay.com/docs/build/llm-docs/api/partners/upload-document.md)

Activation Status | Update Permitted
---
`requested` | You can update the details for all the fields.
---
`needs_clarification` | The fields you can update depend on the reason_code mentioned in the requirements object in the [Request a Product Activation API](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration/request.md): - **document_missing** or **field_missing**: You can update all the fields.
...
1. As a partner, it is your responsibility to show respective terms and conditions to the sub-merchants before you start onboarding to a product. The APIs used for it will be [Fetch Terms and Conditions for a Sub-Merchant](https://razorpay.com/docs/build/llm-docs/api/partners/terms-conditions/fetch.md).
2. You should display these web pages to your sub-merchants on your interface.
3. Record the acceptance of terms and transmit that to Razorpay using either [Request a Product Configuration API](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration/request.md) or [Update a Product Configuration API](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration/update-settlement-account-details.md).

### Related Information

- [Sub-Merchant Onboarding APIs Workflow](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/workflow.md)
- [Subscribe to Webhooks](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/webhooks.md)
- [Appendix](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/appendix.md)
