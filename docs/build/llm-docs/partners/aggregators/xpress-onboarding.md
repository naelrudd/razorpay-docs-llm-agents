...
- [Update Account API](https://razorpay.com/docs/build/llm-docs/api/partners/account-onboarding/update.md)
- [Update Stakeholder API](https://razorpay.com/docs/build/llm-docs/api/partners/stakeholder/update.md)
- [Update Product Configuration API](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration-xpress-onboarding.md#update-a-product-configuration)

Please wait for the response of these APIs before making subsequent requests.

### 1. Create an Account

Create an account for the sub-merchant using the [Create an Account API](https://razorpay.com/docs/build/llm-docs/api/partners/account-onboarding/create.md) by passing the `no_doc_onboarding=true` parameter. This triggers the Xpress Onboarding flow.
...
API | Description
---
[Create an account](https://razorpay.com/docs/build/llm-docs/api/partners/account-onboarding/create.md) | API to create a sub-merchant account.
---
[Fetch an account](https://razorpay.com/docs/build/llm-docs/api/partners/account-onboarding/fetch.md) | API to view sub-merchant account details.
---
[Update an account](https://razorpay.com/docs/build/llm-docs/api/partners/account-onboarding/update.md) | API to update the sub-merchant account details.
---
[Delete an account](https://razorpay.com/docs/build/llm-docs/api/partners/account-onboarding/delete.md) | API to delete a sub-merchant account.

    

### 2. Create a Stakeholder

Use the [Create a Stakeholder API](https://razorpay.com/docs/build/llm-docs/api/partners/stakeholder/create.md) to add a stakeholder for an account. Each stakeholder needs to update the KYC. 
...
API | Description
---
[Create a stakeholder](https://razorpay.com/docs/build/llm-docs/api/partners/stakeholder/create.md) | API to create a stakeholder.
---
[Fetch a stakeholder](https://razorpay.com/docs/build/llm-docs/api/partners/stakeholder/fetch-with-id.md) | API to retrieve and view the stakeholder account details.
---
[Fetch all stakeholders](https://razorpay.com/docs/build/llm-docs/api/partners/stakeholder/fetch-all.md) | API to retrieve all stakeholders for a given account.
---
[Update a Stakeholder](https://razorpay.com/docs/build/llm-docs/api/partners/stakeholder/update.md) | API to update the stakeholder account details.
 
    

### 3. View and Accept Terms and Conditions

Before activating the sub-merchant and requesting for relevant product configurations, the sub-merchant needs to view and accept the Terms and Conditions. You can fetch these Terms and Conditions links using the [Fetch Terms and Conditions API](https://razorpay.com/docs/build/llm-docs/api/partners/terms-conditions/fetch.md) to share them with the sub-merchant.

You can also accept Terms and Conditions for the sub-merchant using the [Request a Product Configuration API](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration-xpress-onboarding.md#request-a-product-configuration). 
...
API | Description
---
[Accept Terms and Conditions](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration-xpress-onboarding.md#request-a-product-configuration) | API to accept terms and conditions.
---
[Fetch Terms and Conditions](https://razorpay.com/docs/build/llm-docs/api/partners/terms-conditions/fetch.md) | API to retrieve terms and conditions.

    

### 4. Configure Products to Accept Payments

You can use the [Product Configuration APIs](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration-xpress-onboarding.md) to configure and activate Razorpay products for a sub-merchant account according to their requirements.
...
API | Description
---
[Request a Product Configuration](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration-xpress-onboarding.md#request-a-product-configuration) | API to request a product configuration.   
---
[Update a product configuration](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration-xpress-onboarding.md#update-a-product-configuration) | API to update a configured product.
---
[Fetch a Product](https://razorpay.com/docs/build/llm-docs/api/partners/product-configuration-xpress-onboarding.md#fetch-a-product) | API to fetch a configured product.

    

### 5. Upload Supporting Documents

You can submit the required documents for sub-merchant onboarding using the [Documents APIs](https://razorpay.com/docs/build/llm-docs/api/partners/upload-document.md) listed in the table below.
...
API | Description
---
[Upload account documents](https://razorpay.com/docs/build/llm-docs/api/partners/upload-document/upload-account-documents.md) | API to upload sub-merchant's business documents.
---
[Upload stakeholder documents](https://razorpay.com/docs/build/llm-docs/api/partners/upload-document/upload-stakeholder-documents.md) | API to upload stakeholder's signatory documents.
---
[Fetch account documents](https://razorpay.com/docs/build/llm-docs/api/partners/upload-document/fetch-account-documents.md) | API to fetch account documents.
---
[Fetch stakeholder documents](https://razorpay.com/docs/build/llm-docs/api/partners/upload-document/fetch-stakeholder-documents.md) | API to fetch stakeholder documents.
...
- **Transaction Events**: These are events related to payment transactions performed by the sub-merchants. You can configure these events at a sub-merchant level.  View [webhook events](https://razorpay.com/docs/build/llm-docs/partners/aggregators/onboarding-api/webhooks.md#transaction-events) and [payload details](https://razorpay.com/docs/build/llm-docs/webhooks.md).
...
### Available Webhook Events and Descriptions
  ...
  View [payload details](https://razorpay.com/docs/build/llm-docs/webhooks/partners.md#onboarded-using-apis).
...
You can use the [Webhooks APIs](https://razorpay.com/docs/build/llm-docs/api/partners/webhooks.md) to receive event notifications or subscribe to events happening in a sub-merchant's account, such as payments, orders, invoices and so on.
...
API | Description
---
[Create a Webhook](https://razorpay.com/docs/build/llm-docs/api/partners/webhooks/create.md) | API to create a webhook.
---
[Fetch a Webhook](https://razorpay.com/docs/build/llm-docs/api/partners/webhooks/fetch-with-id.md) | API to retrieve and view the webhook details.
---
[Fetch all Webhooks](https://razorpay.com/docs/build/llm-docs/api/partners/webhooks/fetch-all.md) | API to retrieve all webhooks.
---
[Update a Webhook](https://razorpay.com/docs/build/llm-docs/api/partners/webhooks/update.md) | API to update the webhook details.
---
[Delete a Webhook](https://razorpay.com/docs/build/llm-docs/api/partners/webhooks/delete.md) | API to delete a webhook.
